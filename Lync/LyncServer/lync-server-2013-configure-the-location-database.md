...
1.  Füllen Sie die Datenbank mit einer Zuordnung von Netzwerkelementen zu Standorten auf. Wenn Sie ein Elin-Gateway (Emergency Location Identification Number) verwenden, müssen Sie das Elin in das \<Feld\> CompanyName einschließen.
