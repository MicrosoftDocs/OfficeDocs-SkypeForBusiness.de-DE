...
Ausführliche Informationen zum Arbeiten mit Netzwerk-Subnetzen finden Sie in der lync Server-Verwaltungsshell Dokumentation für die folgenden Cmdlets:
...
## <a name="to-associate-a-subnet-with-a-network-site-by-using-management-shell"></a>So ordnen Sie ein Subnetz mithilfe der Verwaltungsshell einem Netzwerkstandort zu
...
## <a name="to-associate-a-subnet-with-a-network-site-by-using-lync-server-control-panel"></a>So ordnen Sie ein Subnetz mithilfe der Lync Server-Systemsteuerung einem Netzwerkstandort zu
