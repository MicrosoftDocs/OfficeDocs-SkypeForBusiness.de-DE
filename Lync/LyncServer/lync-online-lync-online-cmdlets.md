...
Informationen dazu, wie Sie Ihren Computer für die Verwendung von Windows PowerShell zum Verwalten mit lync Online konfigurieren, finden Sie im Hilfethema [Verwenden von Windows PowerShell zum Verwalten von lync Online](https://technet.microsoft.com/en-us/library/Dn362831(v=OCS.15)).
