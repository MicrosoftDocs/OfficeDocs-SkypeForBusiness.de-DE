...
# <a name="overview-of-monitoring-in-lync-server-2013"></a><span data-ttu-id="f1acc-102">Übersicht über die Überwachung in lync Server 2013</span><span class="sxs-lookup"><span data-stu-id="f1acc-102">Overview of monitoring in Lync Server 2013</span></span>
