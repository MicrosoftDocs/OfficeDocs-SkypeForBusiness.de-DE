...
## <a name="to-use-lync-server-control-panel-delete-a-workflow"></a>So verwenden Sie lync Server-Systemsteuerung Löschen eines Workflows
...
6.  Klicken Sie in der Liste der Dienste auf den gewünschten Dienst, und klicken Sie auf **OK**.
    ...
    > [!NOTE]  
    > Die Seite Konfigurations Tool für Reaktionsgruppen wird geöffnet. Sie können die Webseite für das Reaktionsgruppen-Konfigurations Tool auch direkt über einen Webbrowser öffnen, indem Sie eine Verbindung mit <STRONG>&lt;https://webPoolFqdn&gt;/RgsConfig</STRONG>herstellen.
...
## <a name="to-use-windows-powershell-to-delete-a-workflow"></a>So löschen Sie einen Workflow mithilfe Windows PowerShell
