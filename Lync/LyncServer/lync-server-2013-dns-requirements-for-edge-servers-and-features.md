...
# <a name="dns-requirements-for-edge-servers-and-features-in-lync-server-2013"></a>DNS-Anforderungen für Edge-Server und-Features in lync Server 2013
...
Lync Server 2013 Edgeserver, Edge-Pools und Reverse Proxies haben bestimmte Anforderungen für Domain Name System (DNS) Datensätze. In lync Server 2013, wenn IPv4 und IPv6 verwendet werden, müssen Sie sowohl Host A-als auch AAAA-Einträge planen.
...
## <a name="in-this-section"></a>In diesem Abschnitt
  ...
  - [DNS-Zusammenfassung für einen einzelnen konsolidierten Edgeserver mit privaten IP-Adressen mithilfe von NAT in lync Server 2013](lync-server-2013-dns-summary-single-consolidated-edge-with-private-ip-addresses-using-nat.md)
