...
description: 'Lync Server 2013: Details zur QoE-Tabelle.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48579151"
---
# <a name="qoe-table-details-in-lync-server-2013"></a>Details der QoE-Tabelle in lync Server 2013
...
In diesen Abschnitten werden die Spalten in den einzelnen Datenbankschema Tabellen für QoE (Quality of Experience) detailliert beschrieben.
  ...
  - [Konferenz Tabelle in lync Server 2013](lync-server-2013-conference-table.md)

  - [Gerätetabelle in lync Server 2013](lync-server-2013-device-table.md)

  - [ACPITreiber-Tabelle in lync Server 2013](lync-server-2013-devicedriver-table.md)

  - [Dialog Tabelle in lync Server 2013](lync-server-2013-dialog-table.md)

  - [Endpunkt Tabelle in lync Server 2013](lync-server-2013-endpoint-table.md)
  ...
  - [Medientabelle in lync Server 2013](lync-server-2013-medialine-table.md)
  ...
  - [Server Tabelle in lync Server 2013](lync-server-2013-server-table.md)

  - [Sitzungstabelle in lync Server 2013](lync-server-2013-session-table.md)
  ...
  - [Benutzertabelle in lync Server 2013](lync-server-2013-user-table.md)
  ...
  - [Video Client Event-Tabelle in lync Server 2013](lync-server-2013-videoclientevent-table.md)
