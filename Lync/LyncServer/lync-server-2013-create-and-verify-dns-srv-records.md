...
6.  Geben ** \_Sie sipinternaltls\_ ein. TCP.contoso.com**, und drücken Sie dann die EINGABETASTE. Die für den TLS-Eintrag (Transport Layer Security) angezeigte Ausgabe lautet wie folgt:
    ...
    Poolname.contoso.com Internet Address = \<virtuelle IP-Adresse des Load Balancer\> oder \<IP-Adresse eines einzelnen Enterprise Edition-Servers für Pools mit nur einem\> Enter \<Prise Edition-Server oder einer IP-Adresse des Standard Edition-Servers\>
