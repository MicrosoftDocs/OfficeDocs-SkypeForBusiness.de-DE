...
1.  Binden Sie das Zertifikat, das Sie für den Reverseproxy verwenden werden, an das HTTPS-Protokoll. Klicken Sie im **Startmenü**auf **Programme**, wählen Sie **Verwaltung**aus, und klicken Sie dann auf **Internet Information Services (IIS)-Manager**.
    ...
    > [!NOTE]  
    > Weitere Hilfe, Screenshots und Anleitungen zur Bereitstellung und Konfiguration von IIS arr finden Sie im NextHop-Artikel <A href="http://go.microsoft.com/fwlink/?linkid=293391">using IIS arr as a Reverse Proxy for lync Server 2013</A>.
