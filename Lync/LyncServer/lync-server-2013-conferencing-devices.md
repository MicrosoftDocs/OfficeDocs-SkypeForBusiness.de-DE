...
Konferenzgeräte bringen lync Phone Edition Funktionen in Konferenzräume, sodass Personen im Raum hören können und je nach Gerät Personen an anderen Standorten angezeigt werden.

In den Themen in diesem Abschnitt erfahren Sie, wie Sie Ihre Konferenzgeräte einrichten und verwalten können.
...
## <a name="in-this-section"></a>In diesem Abschnitt
  ...
  - [Erstellen oder Ändern eines Kontaktobjekts für ein Konferenzgerät in lync Server 2013](lync-server-2013-create-or-modify-a-conferencing-device-contact-object.md)
  ...
  - [Migrieren eines Konferenz Geräts in einen neuen registrierungsstellenpool in lync Server 2013](lync-server-2013-move-a-conferencing-device-to-a-new-registrar-pool.md)
