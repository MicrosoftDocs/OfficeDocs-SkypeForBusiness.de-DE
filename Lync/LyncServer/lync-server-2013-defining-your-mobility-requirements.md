...
<span data-ttu-id="4ed9f-105">Hier sind die Entscheidungen, die Sie berücksichtigen müssen:</span><span class="sxs-lookup"><span data-stu-id="4ed9f-105">Here are the decisions that you must consider:</span></span>
