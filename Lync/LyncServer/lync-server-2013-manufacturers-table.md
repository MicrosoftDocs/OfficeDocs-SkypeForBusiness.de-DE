...
# <a name="manufacturers-table-in-lync-server-2013"></a>Herstellertabelle in lync Server 2013
...
Die Tabelle "Hersteller" ist eine unterstützende Tabelle. Jeder Datensatz speichert Informationen zu einem Gerät (Telefonhersteller).
