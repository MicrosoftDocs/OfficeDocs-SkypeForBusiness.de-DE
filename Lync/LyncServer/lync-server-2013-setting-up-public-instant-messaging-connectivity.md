...
1.  Wenn die erforderliche Vorlage für die Zertifizierungsstelle zur Verfügung gestellt wurde, verwenden Sie auf dem Edgeserver das folgende Cmdlet der Windows PowerShell, um das Zertifikat anzufordern:
    ...
    Der standardmäßige Zertifikatname der Vorlage, die für lync Server verwendet wird, ist Webserver. Geben Sie nur die an \<template name\> , wenn Sie eine Vorlage verwenden möchten, die sich von der Standardvorlage unterscheidet.
