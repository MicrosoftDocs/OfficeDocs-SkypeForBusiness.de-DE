...
## <a name="to-modify-response-group-application-level-settings"></a>So ändern Sie Einstellungen auf Reaktionsgruppenanwendung Ebene
...
[Gruppe-CsRgsConfiguration](https://docs.microsoft.com/powershell/module/skype/Set-CsRgsConfiguration)  
