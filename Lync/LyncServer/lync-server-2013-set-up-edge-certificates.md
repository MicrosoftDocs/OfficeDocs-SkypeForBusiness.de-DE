...
ms.locfileid: "48575331"
---
# <a name="set-up-edge-certificates-for-lync-server-2013"></a>Einrichten von Edge-Zertifikaten für lync Server 2013
...
## <a name="in-this-section"></a>In diesem Abschnitt
  ...
  - [Einrichten von Zertifikaten für die interne Edge-Schnittstelle in lync Server 2013](lync-server-2013-set-up-certificates-for-the-internal-edge-interface.md)

  - [Einrichten von Zertifikaten für die externe Edge-Schnittstelle für lync Server 2013](lync-server-2013-set-up-certificates-for-the-external-edge-interface.md)

  - [Einrichten von Zertifikaten für den Reverseproxy in lync Server 2013](lync-server-2013-set-up-certificates-for-the-reverse-proxy.md)
