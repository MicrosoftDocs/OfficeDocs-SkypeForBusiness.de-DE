...
Sie können die PIN eines Benutzers im Abschnitt **Benutzer** der lync Server 2013 Systemsteuerung sperren oder entsperren.

<div>

## <a name="to-lock-a-users-pin-in-lync-server-control-panel"></a>So sperren Sie die PIN eines Benutzers in lync Server-Systemsteuerung
...
## <a name="to-unlock-a-users-pin-in-lync-server-control-panel"></a>So entsperren Sie die PIN eines Benutzers in lync Server-Systemsteuerung
