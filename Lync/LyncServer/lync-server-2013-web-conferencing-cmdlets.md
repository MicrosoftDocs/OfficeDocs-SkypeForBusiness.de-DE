...
Die Cmdlets [New-CsClientPolicy](https://technet.microsoft.com/library/Gg425949(v=OCS.15)) und [Sets-CsClientPolicy](https://technet.microsoft.com/library/Gg398300(v=OCS.15)) bieten zusätzliche Möglichkeiten zum Konfigurieren und Verwalten von lync Server 2013.
