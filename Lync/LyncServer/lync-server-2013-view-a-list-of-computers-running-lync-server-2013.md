...
description: 'Lync Server 2013: zeigt eine Liste der Computer an, auf denen lync Server 2013 läuft.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48567181"
---
# <a name="view-a-list-of-computers-running-lync-server-2013"></a>Anzeigen einer Liste mit Computern, auf denen lync Server 2013
...
Sie können lync Server 2013-Systemsteuerung verwenden, um eine Liste aller Computer anzuzeigen, auf denen lync Server 2013 in Ihrer Topologie läuft, und den jeweiligen Dienststatus anzuzeigen. Sie können die Liste nach Computer, Pool oder Website sortieren.

<div>

## <a name="to-view-a-list-of-computers-running-lync-server"></a>So zeigen Sie eine Liste von Computern an, auf denen Lync Server ausgeführt wird
