...
# <a name="configure-phone-number-extensions-for-parking-calls-in-lync-server-2013"></a>Konfigurieren von Durchwahlnummern für das Parken von Anrufen in lync Server 2013
...
Der Anwendung zum Parken von Anrufen verwendet Durchwahlnummern in der Orbit-Tabelle für das Parken von anrufen, um Anrufe abzustellen. Sie müssen die Orbit-Tabelle für das Parken von Anrufen mit den Bereichen der Durchwahlnummern konfigurieren, die Ihre Organisation für geparkte Anrufe reserviert. Dabei muss es sich um virtuelle Durchwahlnummern handeln (also Nummern, denen kein Benutzer oder Telefon zugeordnet ist). Jeder lync Server Pool, in dem ein Anwendung zum Parken von Anrufen bereitgestellt und konfiguriert ist, kann einen oder mehrere Umlaufbahn Bereiche aufweisen. Umlaufbahn Bereiche müssen in der lync Server-Bereitstellung global eindeutig sein.

<div>


> [!IMPORTANT]  
> Sie müssen das Kontrollkästchen <STRONG>Parken von Anrufen</STRONG> in Ihrer VoIP-Richtlinie aktivieren, bevor Sie das Parken von Anrufen verwenden können. Diese Option ist standardmäßig nicht aktiviert.
