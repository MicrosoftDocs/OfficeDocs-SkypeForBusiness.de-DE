...
## <a name="in-this-section"></a>In diesem Abschnitt
  ...
  - [Einrichten von Edge-Servern in lync Server 2013](lync-server-2013-setting-up-edge-servers.md)
  ...
  - [Überprüfen der Edge-Bereitstellung in lync Server 2013](lync-server-2013-verifying-your-edge-deployment.md)
