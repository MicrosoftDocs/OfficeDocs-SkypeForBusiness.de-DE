...
## <a name="in-this-section"></a>In diesem Abschnitt
  ...
  - [Anrufsteuerung in lync Server 2013 mit einem PSTN-Gateway oder einer Nebenstellenanlage eines Drittanbieters](lync-server-2013-call-admission-control-with-a-third-party-pstn-gateway-or-pbx.md)
