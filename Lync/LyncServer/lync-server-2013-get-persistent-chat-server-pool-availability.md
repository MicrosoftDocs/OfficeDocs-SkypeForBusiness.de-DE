...
# <a name="get-persistent-chat-server-pool-availability-in-lync-server-2013"></a>Herstellen der Verfügbarkeit für den Serverpool für beständigen Chat in Lync Server 2013
...
So erhalten Sie die Verfügbarkeit von persistent Chat Server Pools
