...
## <a name="scaled-consolidated-edge-using-dns-load-balancing-with-public-ip-addresses"></a>Skalierter konsolidierter Edgeserver mit DNS-Lastenausgleich mit öffentlichen IP-Adressen
