...
Microsoft Teams basiert auf Microsoft 365 und Office 365 hyperskalierte Cloud auf Unternehmensniveau, die die erweiterten Sicherheits- und Compliancefunktionen bietet, die unsere Kunden erwarten. Weitere Informationen zur Planung der Sicherheit in Microsoft 365 oder Office 365 finden Sie in [der Sicherheits-Roadmap](/microsoft-365/security/office-365-security/security-roadmap). Weitere Informationen zur Planung der Compliance in Microsoft 365 oder Office 365 erhalten Sie, wenn Sie mit ["Plan for security & compliance"](/microsoft-365/compliance/plan-for-security-and-compliance) beginnen.


Dieser Artikel enthält weitere Informationen zu Teams-spezifischer Sicherheit und Compliance. Verpassen Sie nicht diese Microsoft Mechanics-Videos zu Sicherheit und Compliance:
...
Microsoft Defender for Office 365 ist zusammen mit SharePoint und OneDrive für Microsoft Teams verfügbar, Anwendungen, die in Teams für die Inhaltsverwaltung integriert sind. Defender for Office 365 können Sie ermitteln, ob Inhalte in diesen Anwendungen bösartig sind, und diese Inhalte am Benutzerzugriff hindern.

Wie die betroffenen Inhalte nach der Erkennung verwaltet werden, hängt von den Einstellungen ab, die Sie in Microsoft 365 oder Office 365 ausgewählt haben. Es wird dringend empfohlen, alle Anwendungen beim Konfigurieren von Defender for Office 365 in Betracht zu ziehen. Für weitere Informationen finden Sie [hier eine Übersicht über die Funktionsweise sicherer Links und die Schritte zum Einrichten](/microsoft-365/security/office-365-security/safe-links?view=o365-worldwide). Hier finden Sie ausführliche Informationen zu den ersten Schritten.

### <a name="safe-links-in-microsoft-teams"></a>Sichere Links in Microsoft Teams

Defender for Office 365 sichere Links sind in Microsoft Teams verfügbar. Weitere Informationen dazu, was sichere Links sind und was mit diesem Feature zu tun ist, finden Sie in den [Einstellungen für sichere Links für Teams](/microsoft-365/security/office-365-security/safe-links?view=o365-worldwide). Sichere Links sind sowohl in [Defender for Office 365 Plan 1 als auch in Plan 2](/microsoft-365/security/office-365-security/overview?view=o365-worldwide) verfügbar.

### <a name="safe-attachments"></a>Sichere Anlagen

Sichere Anlagen ist ein Feature zur Verbesserung der Benutzersicherheit, indem bösartige Anlagen gesucht und erkannt werden. Globale oder Sicherheitsadministratoren [aktivieren das Feature](/microsoft-365/security/office-365-security/turn-on-mdo-for-spo-odb-and-teams?view=o365-worldwide) und [erstellen Richtlinien](/microsoft-365/security/office-365-security/set-up-safe-attachments-policies?view=o365-worldwide) für die Behandlung dieser verdächtigen bösartigen Anlagen, um zu verhindern, dass sie an Benutzer gesendet, angeklickt und darauf reagiert werden.

Der Schutz vor sicheren Anlagen ist für SharePoint, OneDrive und Microsoft Teams sowie Microsoft 365 oder Office 365 in [Microsoft Defender for Office 365 Plan 1 und Plan 2](/microsoft-365/security/office-365-security/overview?view=o365-worldwide) verfügbar. Lesen Sie in [diesem Artikel](/microsoft-365/security/office-365-security/set-up-safe-attachments-policies?view=o365-worldwide) mehr über sichere Anlagen und wie sie zum Schutz Ihrer Organisation beitragen können.

### <a name="secure-score"></a>Sicherheitsbewertung

Die Microsoft-Sicherheitsbewertung ist eine Messung des Sicherheitsstatus einer Organisation, wobei eine höhere Zahl auf mehr ergriffene Verbesserungsmaßnahmen hinweist. Sie befindet sich im [Microsoft 365 Security Center](https://security.microsoft.com/securescore). Das Folgen der Empfehlungen für die Sicherheitsbewertung kann Ihre Organisation vor Bedrohungen schützen. Über ein zentrales Dashboard im Microsoft 365 Security Center können Organisationen die Sicherheit ihrer Microsoft 365-Identitäten, -Apps und -Geräte überwachen und daran arbeiten. Microsoft Teams enthält jetzt Empfehlungen zur Sicherheitsbewertung, und Administratoren werden aufgefordert, ihre Sicherheitsposition auf der Plattform zu überwachen.
...
Weitere Informationen finden Sie unter [Übersicht über Customer Key auf Mandantenebene](/microsoft-365/compliance/customer-key-tenant-level) und lesen Sie den Microsoft Teams-Blog, der die [Kundenschlüsselunterstützung für Microsoft Teams jetzt in der öffentlichen Vorschau](https://techcommunity.microsoft.com/t5/microsoft-teams-blog/customer-key-support-for-microsoft-teams-now-in-public-preview/ba-p/1999893) behandelt. Informationen zu der Microsoft Purview Information Protection-Version, die Customer Key auf Mandantenebene enthielt, finden Sie unter [Ankündigung neuer Microsoft Purview Information Protection Funktionen, um Ihre vertraulichen Daten zu kennen und zu schützen](https://techcommunity.microsoft.com/t5/microsoft-security-and/announcing-new-microsoft-information-protection-capabilities-to/ba-p/1999692).
...
Weitere Informationen zur Verwendung von eDiscovery-Tools im Microsoft Purview-Complianceportal zum Suchen nach Teams-Inhalten finden Sie unter den folgenden Links:

- [eDiscovery](/microsoft-365/compliance/manage-legal-investigations)

- [Inhaltssuche](/microsoft-365/compliance/search-for-content)

Wir haben einen Teams-spezifischen Artikel für weitere Informationen unter [Durchführen einer eDiscovery-Untersuchung von Inhalten in Microsoft Teams](eDiscovery-investigation.md).
...
Weitere Informationen zu Erhaltung und Haltebereichen finden Sie in der [Übersicht über Aufbewahrungsrichtlinien](/microsoft-365/compliance/retention-policies) in der Microsoft Purview-Complianceportal. Für weitere Teams-spezifische Informationen zur gesetzlichen Aufbewahrung haben wir auch die Möglichkeit, [einen Microsoft Teams-Benutzer oder ein Microsoft Teams-Team in die gesetzliche Aufbewahrung zu setzen](legal-hold.md) , damit Sie mehr erfahren können.

### <a name="content-search"></a>Inhaltssuche

Die Inhaltssuche kann verwendet werden, um mithilfe umfangreicher Filterfunktionen nach allen Teams-Daten zu suchen. Die resultierenden Daten können zur Unterstützung von Compliance und Rechtsstreitigkeiten in einen bestimmten Container exportiert werden. Dies kann mit oder ohne eDiscovery-Fall geschehen. Auf diese Weise können Complianceadministratoren Microsoft Teams-Daten für alle Benutzer sammeln, überprüfen und zur weiteren Verarbeitung exportieren. Lesen Sie die [Inhaltssuche](/microsoft-365/compliance/content-search), um mehr darüber zu erfahren, wie Sie eine Compliance-Inhaltssuche für Microsoft Teams und andere Microsoft 365- oder Office 365-Inhalte in der Microsoft Purview-Complianceportal durchführen.

> [!TIP]
> Mithilfe der Inhaltssuche können Sie bei Bedarf nur nach Microsoft Teams-Inhalten filtern, z. B. Chat- und Kanalnachrichten, Besprechungen und Anrufe.

Wenn Sie weitere Teams-spezifische Informationen zum Konfigurieren der Inhaltssuche wünschen, lesen Sie die [Inhaltssuche in Microsoft Teams](content-search.md).

### <a name="auditing"></a>Überwachung

Die Überwachungsprotokollsuche wird direkt in die Microsoft Purview-Complianceportal integriert und bietet Ihnen die Möglichkeit, Warnungen festzulegen und über Überwachungsereignisse zu berichten, indem Sie den Export von workloadspezifischen oder generischen Ereignissätzen für die Verwendung und Untersuchung durch Administratoren über eine unbegrenzte Überwachungszeitachse hinweg zulassen. Sie können Warnungen für alle Überwachungsprotokolldaten innerhalb der Microsoft Purview-Complianceportal einrichten und diese Daten filtern und zur weiteren Analyse exportieren. Weitere Informationen zum Suchen nach Microsoft Teams-Ereignissen im Microsoft Purview-Complianceportal finden [Sie unter Durchsuchen des Überwachungsprotokolls nach Ereignissen in Microsoft Teams](audit-log-events.md).
...
> [!NOTE]
> Inhaltssuche, eDiscovery (Standard) und eDiscovery (Premium) müssen in der Microsoft Purview-Complianceportal nicht aktiviert sein, damit sie funktionieren. Weitere Informationen finden Sie unter [Microsoft 365 eDiscovery-Lösungen](/microsoft-365/compliance/ediscovery).
...
Wenn Sie sehen müssen, in welcher Region Daten für Ihren Mandanten enthalten sind, wechseln Sie zum Profil [der Microsoft 365 Admin Center](https://portal.office.com/adminportal/home) >  **Settings-Organisation** > . Blättern Sie nach unten zu **Datenspeicherort**.
