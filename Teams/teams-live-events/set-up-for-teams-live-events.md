...
- enabler-strategic
description: Einrichten von Liveereignissen in Teams, einschließlich Einrichten Ihres Netzwerks, Zuweisen von Lizenzen, Aktivieren von Liveereignisfeatures und Terminplanung sowie Videoverteilungslösungen.
appliesto:
- Microsoft Teams
...
Damit Benutzer Ereignisse planen können, die mit einer externen App oder einem externen Gerät erstellt werden, müssen Sie auch die folgenden Schritte ausführen:
...
**Erwerben und Einrichten Ihrer Lösung außerhalb von Teams** Lassen Sie sich beim Skalieren von Videobereitstellungen durch die vertrauenswürdigen Videobereitstellungspartner von Microsoft helfen. Bevor Sie die Verwendung eines Videobereitstellungsanbieters mit Teams aktivieren können, müssen Sie die SDN/eCDN-Lösung außerhalb und getrennt von Teams erwerben und einrichten.
...
- **Riverbed**, der Branchenstandard bei der Netzwerkoptimierung, erweitert seine Beschleunigungslösungen auf Microsoft Teams und Stream.  Jetzt können Microsoft 365-Kunden den 365-Datenverkehr einschließlich Teams und Stream mit einer Fülle anderer führender SaaS-Dienste im Unternehmen beschleunigen, um die Produktivität der Mitarbeiter von überall aus zu steigern. Teams und stream acceleration can be enabled through a effortless setup that comes with all the assurance of Riverbed es world-class support and ongoing investment.
