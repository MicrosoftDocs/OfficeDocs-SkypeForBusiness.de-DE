...
|**Funktion**   |**Skype-Livekonferenzen** |**Ereignisse, die in Microsoft-Teams, erzeugt** |**Ereignisse, die in externen app oder Gerät erzeugt** |
|---------|---------|---------|---------|
...
- **Lokal wechseln:** Vereinigtes Königreich, Indien, Australien, Japan und andere Microsoft-Teams wechseln Sie lokal werden derzeit nicht unterstützt.
