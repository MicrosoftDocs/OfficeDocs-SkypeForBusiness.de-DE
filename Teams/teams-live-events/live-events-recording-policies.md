...
Die Aufzeichnungsoptionen werden mithilfe des [PowerShell-Befehls Set-CsTeamsMeetingBroadcastPolicy festgelegt](/powershell/module/skype/set-csteamsmeetingbroadcastpolicy).
