---
title: Barrierefreiheitsdeklaration – Frankreich
ms.author: tonysmit
author: tonysmit
manager: serdars
...
### <a name="section-4-dclarations-de-conformit-aux-exigences-fonctionnelles"></a>Section 4 Déclarations de conformité aux exigences fonctionctiones

[Déclarations de conformité aux exigences fonctiontées](http://mandate376.standards.eu/standard/functional-statements) de la norme EN 301 549
...
> 
> [4.2.6 Utilisation sans capacitéitéité](http://mandate376.standards.eu/standard/technical-requirements?functional_statements=40&functional_statements_submitted=true)
> 
...
> 
> [4.2.8 Utilisation avec un](http://mandate376.standards.eu/standard/technical-requirements?functional_statements=44&functional_statements_submitted=true) portée limitée
> 
> [4.2.9- Und-De](http://mandate376.standards.eu/standard/technical-requirements?functional_statements=46&functional_statements_submitted=true)
> 
...
## <a name="exigences-fonctionnelles-daccessibilit"></a>Exigences fonctionfares d'accessibilité

### <a name="section-5-exigences-gnriques"></a>Section 5 Exigences érnériques

<table>
<caption>Abschnitt 5</caption>
<tbody>
<tr class="odd">
...
<tr class="even">
<td><h3 id="mode-de-fonctionnement">5.5.1 Modus de fonctionnement</h3>
...
<p>Dans le cas où la TIC a des éléments actionnables, elle propose un moyen de discerner chaque élément actionnable sans que la vision ne soit nécessaire et sans accomplir le geste associé à élément actionnable.</p></td>
<td>Nicht anwendbar</td>
<td></td>
</tr>
<tr class="even">
...
<p>a) le délai den la répétition automatique est réglable jusqu'à au moins 2 secondes ; et</p>
<p>b) la vitiwa de répétition peut être réduite jusqu'à un caractère par intervalle de 2 secondes.</p></td>
<td>Nicht anwendbar</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où la TIC est dotée de capacités d'envoi et de réception en RTT, l'affichage du texte formaté est visuellement différencié de celui du texte reçu.</p></td>
<td>Pas pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>Dans le cas où la TIC utilise laùsie RTT, cette versie RTT est transmise au réseau TIC compatible RTT dans la seconde qui suit sa versie.</p></td>
<td>Pas pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où la TIC propose la communication voix en temps réel et propose également des fonctions de messagerie mehr, de réception automatique ou de serveur interactif, la TIC doit of einem aux utilisateurs un moyen d'accéder aux informations et d'exécuter les fonctions fournctions par la TIC sans utiliser l'audition ou la parole.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><h3 id="synchronisation-entre-le-signal-audio-et-le-signal-vidéo">6.5.4 Synchronisations noch le signal audio et le signal vidéo</h3>
<p>Lorsqu'une TIC qui permet la communication voix bidirectionnelle est dotée d'une fonctionnalité de vidéo en temps réel, cette TIC doit immerir un écart de temps de 100 ms maximum pré la voix et les images présentées à l'utilisateur.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>b) pour les commandes solees, sans utilisation de la voix ;</p>
...
Cette section ne s'applique pas à Skype Pipette 2016.
...
<p>Test: Si le contenu non textuel est un test ou un exercice qui statusit invalide s'il était présenté sous forme de texte, alors des équivalents textuels donnent au moins une identification descriptive du contenu non textuel.</p>
...
<p>CAPTCHA : Si le contenu non textuel sert à confirmer que c'est une personne et non un ordinateur qui accède au contenu, alors des équivalents textuels qui identifient et décrivent à radierg ce contenu non textuel sont fournis, et des formes alternatives de CAPTCHA utilisant différents modes de sortie pour les différents types de perception sensorielle sont fournies afin de répondre aux besoins des différents modes.</p>
<p>Vererbung, Formatage, unsichtbar: Si le contenu non textuel est purement anatif, s'il n'est utilisé que pour le formatage visuel ou s'il n'est pas présenté aux utilisateurs, alors il est mis en œuvre de manière à être ignoré par la technologie d'assistance.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indisdatums dans le Den 11.6 : Audio-description (préenregistrée) :</p>
<p>L'audio description est fournie pour tout le contenu vidéo préenregistré sous forme de média synchronisé.</p></td>
<td>Nicht anwendbar</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="informations-et-relations">11.2.1.7 Informationen und Beziehungen</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur et qui prend en charge l'accès aux technologies d'assistance pour la lecture d'écran, elle remplit les Critères de Succès indités dans le Interfaces 11.7 : Informations et relations :</p>
<p>Les informations, la structure et les relations trophiculées par la présentation peuvent être déterminés par un programme informatique ou sont disponibles sous forme de texte.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="ordre-séquentiel-logique">11.2.1.8 Ordre séquentiel logique</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur et qui prend en charge l'accès aux technologies d'assistance pour la lecture d'écran, elle remplit les Critères de Succès indités dans leUniS 11.8 : Ordre séquentiel logique :</p>
...
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indisdatums dans le Aktualisierung 11.9 : Caractéristiques sensorielles :</p>
<p>Les instructions fournies pour permettre la compréhension et l'utilisation du contenu ne repositorysent pas uniquement sur les caractéristiques sensorielles des composants telles que la forme, la taille, l'emplacement visuel, l'orientation ou le son.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur et qui permet l'accès aux fonctions d'agrandissement de la plate-forme ou de la technologie d'assistance, elle remplit les Critères de Succès indi er dans le Zude 11.13 : Redimensionner le texte :</p>
...
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur et qui prend en charge l'accès aux technologies d'assistance pour la lecture d'écran, elle remplit les Critères de Succès indités dans le zu 11.14 : Images de texte :</p>
...
<p>Aktualisierunge : Une présentation particulière du texte est zeite aux informations transmises.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
4) Les touches de modification du clavier s'arrêtent parfois de fonctionner lorsque vous donnez ou prenez le contrôle de votre écran partaté.</td>
</tr>
<tr class="odd">
<td><h3 id="pas-de-piège-au-clavier">11.2.1.16 Pas de piège au clavier</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indisdatums dans le Zwischen 11.16 : Pas de piège au clavier :</p>
...
<tr class="odd">
<td><h3 id="parcours-du-focus">11.2.1.22 UntereOurs du focus</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indisdatums dans le Zuy 11.22 : Unterours du focus :</p>
<p>Si un logiciel peut être parcouru de façon séquentielle et que les séquences de navigation affectent la signification ou l'action, les éléments reçoivent le focus dans un ordre qui préserve la signification et l'tébilité.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="fonction-du-lien-selon-le-contexte">11.2.1.23 Fonction du lien (selon le contexte)</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indi eigenes dans le Allein 11.23 : Fonction du lien (selon le contexte) :</p>
...
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indisdatums dans le 11.26 : Visibilité du focus :</p>
...
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur et qui prend en charge l'accès aux technologies d'assistance pour la lecture d'écran, elle remplit les Critères de Succès indités dans le Interfaces 11.27 : Langue du logiciel :</p>
<p>Le langage humain par défaut du logiciel peut être déterminé par un programme informatique.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="au-focus">11.2.1.29 Au - Fokus</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indisdatums dans le Allein 11.29 : Au focus :</p>
<p>Quand un composant reçoit le focus, il ne doit pas initier un changement de contexte.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="à-la-saisie">11.2.1.30 À la chatsie</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur, elle remplit les Critères de Succès indicias dans le Sich 11.30 : À la besie :</p>
<p>Le changement de paramètres d'un <a href="https://www.w3.org/Translations/NOTE-UNDERSTANDING-WCAG20-fr/consistent-behavior-unpredictable-change.html#user-interface-componentdef">composant d'interface utilisateur</a> ne provoque pas automatiquement un changement de contexte à moins que l'utilisateur n'ait été avisé de ce comportement anspruch d'utiliser le composant.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="identification-des-erreurs">11.2.1.33 Identification des erreurs</h3>
<p>Dans le cas où la TIC est un logiciel non-web qui est doté d'une interface utilisateur et qui prend en charge l'accès aux technologies d'assistance pour la lecture d'écran, elle remplit les Critères de Succès indinummerns dans leLicht 11.33 : Identification des erreurs :</p>
<p>Si une erreur deglesie est automatiquement détectée, l'élément porteur de l'erreur est identifié et l'erreur est décrite à l'utilisateur sous forme de texte.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><h3 id="prévention-des-erreurs-juridiques-financières-de-données">11.2.1.36 Préré des erreurs (juridiques, financières, de données)</h3>
...
2)Le contenu des fichiers PowerPoint partauma n'est pas exposé par programmation.<br />
...
<p>Le logiciel de la plate-forme fournit un den services de plate-forme documentés qui permettent à un logiciel qui est doté d'une interface utilisateur fonctionnant sur le logiciel de la plate-forme d'interagir avec la technologie d'assistance.</p>
...
<p>Le logiciel de la plate-forme fournit un services d'accessibilité de la plate-forme documentés qui permettent à la technologie d'assistance d'interagir avec logiciel qui est doté d'une interface utilisateur fonctionnant sur le logiciel de la plate-forme.</p>
...
<p>Dans le cas où le logiciel présente une interface utilisateur, il exposera la relation qu'un élément de l'interface utilisateur a en tant qu'étiquette d'un autre élément, ou en tant qu'élément étiqueté par un autre élément, à l'aide des services décrits dans la clause 11.3.2.3, de er que ces informations soient déterminables par un programme informatique par les technologies d'assistance.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="relations-parent-enfant">11.3.2.9 Beziehungen parent-enfant </h3>
<p>Dans le cas où le logiciel présente une interface utilisateur, il rendra, à l'aide des services décrits dans la clause 11.3.2.3, la relation un élément de l'interface utilisateur et des éléments parent ou enfant déterminables par un programme informatique par les technologies d'assistance.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>Si les exigences de sécurité l'autorisent, un logiciel qui est doté d'une interface utilisateur autorise les technologies d'assistance, en utilisant les services décrits dans la 11.3.2.3, à modifier les valeurs et le texte des éléments de l'interface utilisateur à l'aide des méthodes de désie de la plate-forme, dans le cas où un utilisateur peut les modifier sans utiliser de technologie d'assistance.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>Dans le cas où un logiciel est une plate-forme, il propose des modes d'utilisation suffisants pour permettre un contrôle de l'utilisateur sur les caractéristiques d'accessité de la plate-forme qui sont documentées comme étant destinées aux utilisateurs.</p></td>
<td>Nicht anwendbar</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où le logiciel est doté d'une interface utilisateur, il ne perturbe pas les caractéristiques d'accessibilité documentées qui sont définies dans la documentation relative à la plate-forme sauf si l'utilisateur le demande en zu fonctionnement du logiciel.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p><strong>11.6.2 Barrierefreie Création de contenu</strong></p>
...
<tr class="even">
<td><h3 id="caractéristiques-daccessibilité-et-de-compatibilité">12.1.1 Caractéristiques d'accessibilité et de combilibilité</h3>
<p>La documentation produit fournie avec la TIC, qu'elle soit fournie séparément ou intégrée dans la TIC, dresse la liste des caractéristiques d'accessibilité et de combilibilité de la TIC et explique comment les utiliser.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="documentation-accessible">12.1.2 Barrierefreie Dokumentation </h3>
...
<tr class="even">
<td><h3 id="informations-sur-les-caractéristiques-daccessibilité-et-de-compatibilité">12.2.2 Informations sur les caractéristiques d'accessibilité et de comatibilité</h3>
<p>Les services d'assistance de la TIC communiquent des informations sur les caractéristiques d'accessibilité et de combilibilité qui sont mentionnées dans la documentation produit.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="efficacité-de-la-communication">12.2.3 Efficacité de la communication </h3>
<p>Les services d'assistance de la TIC répondent aux besoins en communication des personnes porteuses de verung directement ou depuis un point de référence.</p></td>
<td>Pris en charge</td>
<td><a href="https://support.microsoft.com/answerdesk/accessibility">Disability Answer Desk</a></td>
</tr>
<tr class="even">
<td><h3 id="documentation-accessible-1">12.2.4 Barrierefreie Dokumentation </h3>
...
Pour en savoir plus sur les spécifications de com ungebilité de produits de technologie d'assistance spécifiques, consultez vos fournisseurs de technologies d'assistance.
...
Le présent document est fourni à titre antif. MICROSOFT NE FOURNIT AUCUNE GARANTIE, EXPRESSE OU TACITE, DANS LE PRÉSENT DOCUMENT.
