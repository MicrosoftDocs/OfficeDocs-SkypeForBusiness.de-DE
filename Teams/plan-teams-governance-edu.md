...
Im Allgemeinen wird empfohlen, nicht zu verhindern, dass jemand Teams erstellt. Wenn jeder Teams erstellen kann, ist Teams wahrscheinlich weit verbreitet. Lehrpersonal, Lehrkräfte oder Schüler/Studenten Teams Lerngruppen oder spezielle Interessengruppen erstellen. Dies hilft Teams innerhalb und außerhalb des Klassenzimmers akzeptiert zu werden.

Nach unserer Erfahrung trägt User Education dazu bei, verantwortet und Teams sicherzustellen. Sobald die Benutzer verstehen, dass das Erstellen von Teams nicht anonym ist, verstehen sie die Implikationen einer unorglosen Erstellung der Teams und scheuen in der Regel die Falsche Nutzung des Tools.
...
-   Sie können die Microsoft Graph-API (derzeit in der Betaversion) verwenden, um Teams zu erstellen, zu konfigurieren, zu klonen und zu archivieren. Weitere Informationen finden Sie Graph Verwenden der [Microsoft Graph-API zum](/graph/api/resources/teams-api-overview) Arbeiten mit Microsoft Teams.
...
Ja. Benutzer können **beim** Erstellen eines neuen Teams die Option Team erstellen aus vorhandenen Vorlagen auswählen, und Teams-Besitzer können auch die [Graph-API (Beta)](/graph/api/resources/teams-api-overview) verwenden, um ein neues Team aus den verfügbaren Vorlagen zu erstellen.
