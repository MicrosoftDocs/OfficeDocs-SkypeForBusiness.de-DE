...
## <a name="how-do-i-control-team-creation-im-worried-students-are-going-to-create-inappropriate-teams"></a>Wie steuere ich die Teamerstellung? Ich bin besorgt, dass Kursteilnehmer unangemessene Teams erstellen werden.
...
> [!IMPORTANT]
> Für die Microsoft 365-Benennungsrichtlinie für Gruppen sind Azure Active Directory Premium P1- oder Azure AD Basic EDU-Lizenzen für jeden einzelnen Benutzer erforderlich, der Mitglied einer oder Microsoft 365 ist.
...
> [!Note]
> Wenn Teams anhand der Eingaben aus einem anderen System (z. B. School Data Sync) automatisch erstellt werden, überprüfen Sie, ob die Eingabedaten der von Ihnen konfigurierten Benennungsrichtlinie entsprechen. Andern falls nicht, kann die Teamerstellung nicht fehlschlagen.
...
Im Allgemeinen wird empfohlen, niemanden am Erstellen von Teams zu verhindern. Wenn jeder Teams erstellen kann, Teams wahrscheinlich weit verbreitet sein. Lehrkräfte, Lehrkräfte oder Schüler/Studenten können Teams zum Erstellen von Lerngruppen oder speziellen Interessengruppen verwenden. Dies hilft Teams innerhalb und außerhalb des Klassenzimmers akzeptiert zu werden.

Nach unserer Erfahrung trägt User Education dazu bei, verantwortlich für die nutzungsbewusste Teams sicherzustellen. Sobald die Benutzer verstehen, dass das Erstellen von Teams nicht anonym ist, verstehen sie die Implikationen einer unorglosen Erstellung der Teams und scheuen in der Regel die Falsche Nutzung des Tools.
...
-   Sie können die Microsoft Graph-API (derzeit in der Betaversion) verwenden, um Teams zu erstellen, zu konfigurieren, zu klonen und zu archivieren. Weitere Informationen finden Sie Graph Verwenden der [Microsoft Graph-API für](/graph/api/resources/teams-api-overview) die Microsoft Teams von Microsoft.

> [!TIP]
> School Data Sync erstellt eine Microsoft 365-Gruppe für jeden synchronisierten [](https://techcommunity.microsoft.com/t5/School-Data-Sync/HiddenGroupMembershipEnabled-SDS-setting/td-p/159945) Kurs und aktiviert ausgeblendete Gruppenmitgliedschaften, sodass nur Lehrer und Schüler innerhalb des Kurss die Mitglieder dieses Kurs sehen können. Wenn Sie einen anderen Prozess zum Erstellen von Klassengruppen verwenden, verwenden Sie den Parameter HiddenGroupMembershipEnabled des New-UnifiedGroup-Cmdlets, um die gleichen Datenschutzanforderungen zu erfüllen.
...
Es wird empfohlen, zunächst zu überlegen, wie Sie Teams-Daten nach Abschluss des Schuljahrs oder Quartals behandeln möchten: ob sie gelöscht oder für Die Studierenden verfügbar bleiben sollen, auch nachdem sie den Kurs abgeschlossen haben. Sie sollten den Schulkalender im Auge behalten, damit alle von Ihnen festgelegten Richtlinien nicht mit Feiertagen in Konflikt stehen. Sie können die folgenden Tools verwenden, um Ihre Strategie zu implementieren:
...
-   **Archivteam:** Diese Einstellung versetzt Teams in den schreibgeschützten Modus. Sie können weiterhin durchsucht und durchsucht werden, aber niemand kann neue Beiträge hinzufügen. [Das Archivieren oder Wiederherstellen eines Teams beschreibt,](https://support.office.com/article/archive-or-restore-a-team-dc161cfd-b328-440f-974b-5da5bd98b5a7) wie Teambesitzer ein Team archivieren können. Teambesitzer können auch die [Graph-API (Beta)](/graph/api/resources/teams-api-overview) zum Archivieren oder Wiederherstellen eines Teams verwenden.
...
-   Apps hinzufügen.
-   Tasten sie diese Schritte, indem Sie ein vorhandenes Team klonen und auch die Registerkarten anzeigen.
...
## <a name="can-i-control-what-teams-features-my-faculty-and-students-have-access-to"></a>Kann ich steuern, Teams Funktionen für Lehrpersonal und Studierende zugänglich sind?
