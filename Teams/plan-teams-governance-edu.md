...
> [!Tip]
> Schauen Sie sich die folgende Sitzung an, um mehr über das Management in Microsoft Teams zu erfahren: [Governance, Verwaltung](https://aka.ms/teams-governance) und Lebenszyklus in Microsoft Teams
...
## <a name="can-i-control-what-teams-features-my-faculty-and-students-have-access-to"></a>Kann ich steuern, Teams Funktionen, auf die mein Lehrpersonal und meine Schüler/Studenten zugreifen können?
