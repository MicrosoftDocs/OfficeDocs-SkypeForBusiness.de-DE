...
2. Suchen Sie nach der gewünschten app. Um apps mit einem kostenpflichtigen Saas-Abonnement zu identifizieren, schauen Sie in der Spalte **Lizenzen** nach. Jede APP verfügt über einen der folgenden Werte:
...
3. Wenn Sie die APP gefunden haben, klicken Sie auf **Jetzt kaufen** , um zur Registerkarte **Pläne und Preise** auf der Seite App-Details zu wechseln. Überprüfen Sie die Pläne und Preisinformationen für das SaaS-Angebot für die app. Wenn Sie weitere Informationen benötigen, klicken Sie auf **den Link Weitere Informationen,** um zu der APP-Seite auf [AppSource](https://appsource.microsoft.com/)zu wechseln.  
4. Wenn Sie einen Plan kaufen möchten, klicken Sie auf **Jetzt kaufen**. Sie werden zur Kauf Erfahrung für das Angebot umgeleitet, das mit der Teams-App verknüpft ist. Hier können Sie den Kauf des Service-oder SaaS-Angebots abschließen.
5. Wählen Sie den gewünschten Plan aus. Wenn das SaaS-Angebot mehr als einen Plan enthält, klicken Sie auf **ändern** , um die Liste der verfügbaren Pläne anzuzeigen.
6. Wählen Sie Ihren Abrechnungszeitraum aus (entweder **monatlich** oder **jährlich**), und geben Sie dann die Anzahl der Benutzerlizenzen ein, die Sie kaufen möchten.
...
Globale Administratoren können die Käufe anzeigen, die von anderen Personen in der Organisation getätigt wurden, während Teams-Dienstadministratoren nur die von Ihnen selbst vorgenommenen Käufe anzeigen können.  
