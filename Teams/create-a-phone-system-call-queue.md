...
Wenn jemand eine Telefonnummer anruft, die mit einer Anrufwarteschlange über ein [Ressourcenkonto](manage-resource-accounts.md)verknüpft ist: 
1. Sie hören eine Begrüßung (sofern vorhanden) 
2. Der Anruf wird in die Warteschlange gestellt, um auf den nächsten verfügbaren Anruf Agenten zu warten. 
