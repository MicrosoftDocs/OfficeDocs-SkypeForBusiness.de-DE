...
Karrierecoach in den folgenden Sprachen lokalisiert:
...
Eine standardmäßige, für 90 Tage verfügbare Testversion ist für 25 Lizenzen für Studierende und 25 Lehrkräfte/Mitarbeiter verfügbar. Testlizenzen können auf der Microsoft 365 Admin Center von Mandanten aktiviert werden, die qualifiziert sind, Ihre Karrierecoach.
...
2. Wählen Sie im linken Navigationsbereich Apps **Teams** >  **[Verwalten von Apps aus](https://admin.teams.microsoft.com/policies/manage-apps)**.  

3. Suchen oder suchen Sie **nach Karrierecoach**.  

4. Wählen **Karrierecoach** und dann **Einstellungen.**  
...
![im Karrierecoach Abschnitt "Branding" des Admin Centers.](media/career-coach-brand.png)

1. Melden Sie sich beim **[Teams Admin Center an](https://admin.teams.microsoft.com)**.

2. Wählen **Teams AppsManage** >  **[apps](https://admin.teams.microsoft.com/policies/manage-apps)** >  **Karrierecoach** >  **Brand and preferences aus**.

3. Hochladen Sie das **Symbol für die Bildungseinrichtung**. Das Symbol wird überall Karrierecoach zum Identifizieren von Inhalten verwendet, die für Ihre Bildungseinrichtung eindeutig sind, Kurskatalogressourcen in der gesamten App sowie im Abschnitt "Reale Erfahrungen" des Dashboards. Das Symbol ist am besten wie folgt formatiert:

    - Eine transparente PNG-Datei
    - Seitenverhältnis von 1:1
    - Maximale Größe von 64 px x 64 px

4. Hochladen Miniaturansicht **der Bildungseinrichtung.** Die Miniaturansicht wird für Kurskatalogressourcen in der gesamten App verwendet, wenn kein bestimmtes Bild für einen Kurs verfügbar ist. Die Miniaturansicht ist am besten wie folgt formatiert:

    - PNG-Datei
    - Seitenverhältnis von 16:9
    - Maximale Größe von 360 px x 200 px

5. Fügen Sie **die URL der Datenschutzrichtlinien der Bildungseinrichtung hinzu**. Wenn diese Richtlinie hinzugefügt wird, können Schüler/Studierende die Datenschutzrichtlinie in der App Karrierecoach überprüfen.

6. Wählen Sie **Absenden aus**.

### <a name="linkedin-connection"></a>LinkedIn-Verbindung

Die LinkedIn-Konfiguration stellt eine Karrierecoach Verbindung zu öffentlichen Absolventendaten von LinkedIn ein.
...
2. Wählen **Teams AppsVer** >  **[dient zum Verwalten Karrierecoach](https://admin.teams.microsoft.com/policies/manage-apps)** >  >  **LinkedIn-Verbindung**.
...
4. Fügen Sie die LINKEDIn-Schulseiten-URL hinzu. Die URL muss eine Schulseite und keine Unternehmensseite sein und ist normalerweise als formatiert `https://www.linkedin.com/school/willow-university/`.
...
1. Wählen **Teams Apps Verwalten von** &gt; **[Apps Karrierecoach](https://admin.teams.microsoft.com/policies/manage-apps)** &gt; **Einstellungen** &gt;  &gt;**Kurskatalog aus**.  
...
Das Dokument muss im CSV-Format mit einer maximalen Größe von 18 MB vorliegen. Das Dokument muss den Kurstitel, die **Kurs-ID** und die **Kurs-URL** der erforderlichen **Felder enthalten**. 
...
1. Melden Sie sich beim **[Teams Admin Center an](https://admin.teams.microsoft.com)**.
1. Wählen **Teams Apps Verwalten** &gt; **[von Apps](https://admin.teams.microsoft.com/policies/manage-apps)** &gt; **Karrierecoach Einstellungen** &gt;  &gt;**Studienfelder aus**.  
...
Nachdem Sie die Konfiguration abgeschlossen haben, aktivieren Sie die App für Schüler/Studierende und lizenzierte Benutzer, damit sie auf ihre Karrierecoach.  
...
1. Wählen Teams **Apps Apps** &gt; **[](https://admin.teams.microsoft.com/policies/manage-apps)** &gt; **verwalten Karrierecoach**.
...
Wenn Sie nicht sicher sind, welche Richtlinie Sie verwenden sollen, finden Sie [in der Microsoft Teams-Dokumentation](/microsoftteams/policy-packages-edu) zur Richtlinienverwaltung weitere [](/microsoftteams/easy-policy-setup-edu?tabs=students%2Cstudent-settings) Informationen oder verwenden den Education-Richtlinien-Assistenten zum Konfigurieren einer Richtlinie für Microsoft Teams.
...
- Wenn in der Karrierecoach-App die Karrierecoach wird zurzeit für Sie eingerichtet und verwendet werden angezeigt wird, wurden die erforderlichen Abschnitte __nicht abgeschlossen__. Die folgenden __Abschnitte müssen__ abgeschlossen sein, bevor Karrierecoach verwendet werden kann: [Marke](#brand-and-preferences) und Einstellungen, [LinkedIn-Verbindung](#linkedin-connection)[,](#course-catalog) Kurskatalog und [Studienfelder](#fields-of-study).

- CSVs für Kurskatalog und Studienbereich haben erforderliche Formate und eine maximale Größe von 18 MB. Verweisen Sie Karrierecoach auf das [Schema des Kurskatalogdokuments](#course-catalog-document-format-and-schema) und Karrierecoach [studiendokumentschemas](#fields-of-study-document-format-and-schema), um eine ordnungsgemäße Konfiguration zu gewährleisten.
...
- Ein Supportticket muss von einem globalen Mandantenadministrator eingereicht werden und deutlich angeben, dass die Daten Ihres Mandanten dauerhaft gelöscht werden sollen. **Es gibt keine Möglichkeit, die Datensets oder das Zeitfenster für den Löschvorgang zu beschränken**.
