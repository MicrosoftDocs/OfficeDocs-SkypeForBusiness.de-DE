...
-   [Vorbereiten Ihrer Umgebung](https://aka.ms/SkypeToTeams-TechnicalReadiness)
-   [Vorbereiten Ihrer Organisation](https://aka.ms/SkypeToTeams-UserReadiness)
-   [Pilot durchgeführt](https://aka.ms/SkypeToTeams-Pilot)

Wenn Sie Skype for Business Server oder Microsoft Lync lokal bereitgestellt haben und Ihre Organisation ein Upgrade auf Teams durchführen möchte, folgen Sie den Anweisungen in diesem Artikel. Sie müssen hybride Verbindungen mit Ihrer Microsoft 365- oder Office 365-Organisation einrichten und Anforderungen an die Koexistenz festlegen, wenn Sie Ihre Benutzer phasenweise nach Teams verschieben.
...
Weitere Informationen finden Sie unter Verschieben von Benutzern zwischen lokal und der [Cloud](https://docs.microsoft.com/SkypeForBusiness/hybrid/move-users-between-on-premises-and-cloud) und Verschieben von Benutzern von lokal nach [Teams.](https://docs.microsoft.com/SkypeForBusiness/hybrid/move-users-from-on-premises-to-teams) 
...
- Das Einrichten von Skype for Business Hybrid ist eine Voraussetzung für die Migration in den TeamsOnly-Modus. Obwohl teams im Inselmodus ohne Hybridmodus verwendet werden kann, kann der Übergang zum TeamsOnly-Modus erst vorgenommen werden, wenn der Benutzer von Skype for Business lokal zu Skype for Business Online (mithilfe von [Move-CsUser)](https://docs.microsoft.com/SkypeForBusiness/hybrid/move-users-between-on-premises-and-cloud)verschoben wird. Weitere Informationen finden Sie unter [Konfigurieren von Hybridkonnektivität.](https://docs.microsoft.com/skypeforbusiness/hybrid/configure-hybrid-connectivity)

- Wenn Ihre Organisation über Skype for Business Server verfügt und Sie keine Hybridkonnektivität konfiguriert haben, Aber Sie Teams trotzdem verwenden möchten, um die Funktionen von Teams zu verwalten, müssen Sie ein Administratorkonto verwenden, das über eine .onmicrosoft.com-Domäne verfügt. 
