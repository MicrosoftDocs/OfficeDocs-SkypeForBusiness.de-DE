...
Dank Microsoft Teams können Sie in Besprechungen, die Audio, Video und Inhaltsfreigabe umfassen, umfangreiche Onlineinhalte zusammenarbeiten. Dies kann über den Desktop- und Webclient sowie über viele Partnergeräte, die nativ in die App integriert Microsoft Teams. Viele Kunden haben jedoch bereits in Videokonferenz- und persönliche Videokommunikationsgeräte investiert, was ein Upgrade kosten kann. Cloud Video Interop bietet eine einfache Lösung, die es Ihnen ermöglicht, Ihre vorhandenen Lösungen weiter zu verwenden, bis Sie bereit für ein Upgrade sind.
...
- Eine große Bereitstellung von Besprechungsraumgeräten und Bereitstellung von persönlichen Videogeräten (mehr als 50 Geräte), die nicht für die direkte Integration in Die Microsoft Teams
...
|![Das Logo für Cisco CVI](media/cisco.png)|<a href="https://aka.ms/CiscoCVI" target="_blank">Cisco Webex Video Integration for Microsoft Teams</a>|
...
![Diagramm zur Beschreibung einer Teams-Partnerlösung für Cloud Video Interop](media/teams-cloud-video-interop-partner-solution.png)
...
Außerdem ist es wichtig zu verstehen, dass Sie eine Lizenz für jeden Benutzer benötigen, der Besprechungen plant, an denen ein mit Cloud Video Interop aktiviertes Gerät teilnehmen soll. Beachten Sie, dass die genauen Lizenzierungsanforderungen beim Cloud Video Interop-Partner eingeholt werden können. Stellen Sie sicher, dass dies eindeutig ist, bevor Sie mit der Bereitstellung beginnen.
...
Während der Bereitstellungsphase weisen Sie den entsprechenden Benutzern lizenzen entsprechend dem Konfigurationshandbuch für Partner zu. Sie müssen auch den Azure-Zustimmungsprozess durchgehen, um dem Partner Zugriff auf Ihre Teams zu ermöglichen. Weitere [Informationen zum Azure-Zustimmungsprozess finden Sie unter Microsoft Identity Platform und Zustimmung](/azure/active-directory/develop/v2-permissions-and-consent) des Azure-Endpunkts.
...
Die Berichterstellung ist auch direkt über die administrative Oberfläche des Partners verfügbar. Wenn Sie weitere Informationen zu Berichtsfunktionen benötigen, wenden Sie sich an den Partner Ihrer Wahl. 
