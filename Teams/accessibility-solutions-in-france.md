...
Skype Entreprise dans Office 365 prend également en charge Diversity fonctionnalités d'accessibilité. Pour les personnes qui utilisent des lecteurs d ' écran, l'interface utilisateur de Skype Entreprise peut être parcourue à aide du Keyboard, et des pages d ' aide sont fournies pour expliquer:
