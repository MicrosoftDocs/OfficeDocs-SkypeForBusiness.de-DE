...
|**4**   |Sie können filtern, was im Diagramm angezeigt wird, indem Sie in der Legende auf ein Element klicken. Klicken Sie beispielsweise auf **Total Active Users**, **Teams & Channels Active Users**, **Active Channels**oder **Messages** , um nur die Informationen anzuzeigen, die sich auf die einzelnen Personen beziehen. Durch das Ändern dieser Auswahl werden die Informationen in der Tabelle nicht geändert. |
