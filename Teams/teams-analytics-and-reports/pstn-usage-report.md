...
Die freigegebene Korrelations-ID ist nur in der exportierten Excel datei vorhanden, die Sie herunterladen, und gibt an, dass zwei oder mehr Aufrufe in Beziehung stehen. Im Folgenden werden die verschiedenen Szenarien sowie der Fall erläutert, wann die freigegebene Korrelations-ID vorhanden ist.
...
> | 12 | Rufnummer des Anrufer | `nvarchar(32)` | Die Nummer des Benutzers oder Bots, der den Anruf empfangen hat. Bei eingehendem Anruf eines Teambenutzers ist dies der Teams-Benutzer, bei einem ausgehenden Anruf Teams der PSTN-Benutzer. |
