...
|**2**   |Jeder Bericht weist das Datum auf, an dem er generiert wurde. In den Berichten wird normalerweise eine Wartezeit von 24 Stunden aus der Zeit der Aktivität widergespiegelt. |
