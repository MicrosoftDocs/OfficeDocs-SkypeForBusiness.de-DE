...
Besprechungsorganisatoren können einen Besprechungsteilnehmer Bericht anzeigen und herunterladen. Suchen Sie diesen Bericht im Bereich **Teilnehmer** der Besprechung, indem Sie auf den Pfeil Download klicken, wie unten dargestellt. Sie können den Bericht als. CSV-Datei (Text Format).
