...
- **Menüband:** Für SBC Hostingszenarios wird nur die Serie Core unterstützt. Bitte finden Sie im [Menüband SBC Core Microsoft-Teams Konfigurationshandbuch](https://support.sonus.net/display/IOT/PBXs+-+SBC+5k7kSWe).
