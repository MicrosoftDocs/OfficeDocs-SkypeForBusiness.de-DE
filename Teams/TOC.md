...
## [Verwalten großer Teams](best-practices-large-groups.md)
...
## [Anzeigen von Analysen in Teams](teams-analytics-and-reports/view-analytics.md)
...
#### [Interoperabilität von Microsoft Teams und Skype](teams-skype-interop.md)
...
#### [Gast-Erfahrung](guest-experience.md)
#### [Autorisieren des Gastzugriffs](teams-dependencies.md)
#### [Aktivieren und Deaktivieren des Gastzugriffs](set-up-guests.md)
...
### [Anzeigen Ihrer Richtlinienzuweisungen im Aktivitätsprotokoll](activity-log.md)
...
#### [Teams-App-Nutzungsbericht](teams-analytics-and-reports/app-usage-report.md)
...
## [Anzeigen von App-Berechtigungen und erteilen der Administrator-Zustimmung im Microsoft Teams Admin Center](app-permissions-admin-center.md)
...
### [Übersicht](rooms/index.md)
### Plan
#### [Übersicht über die Planung von Microsoft Teams-Räumen](rooms/rooms-plan.md)
#### [Versionsunterstützung](rooms/rooms-lifecycle-support.md)
#### [Anmerkungen zu dieser Version](rooms/rooms-release-note.md)
#### [Vorbereiten der Umgebung](rooms/rooms-prep.md)
...
#### [Mit lokaler Exchange-Bereitstellung (hybrid)](rooms/with-exchange-on-premises.md)
#### [Konfigurieren einer Konsole](rooms/console.md)
#### [Konfigurieren einer Authentifizierung](rooms/rooms-authentication.md)
#### [Teilnehmen an Besprechungen von Drittanbietern](rooms/third-party-join.md)
#### [Mithilfe des Microsoft Endpoint Configuration Manager](rooms/rooms-scale.md)
#### [Verwaltung mit Azure Monitor](rooms/azure-monitor-deploy.md)
#### [Migrieren von SRS v1 oder LRS](rooms/lrs-migration.md)
#### [Inhalts-Kameras](rooms/content-camera.md)
### Verwalten
#### [Verwaltung (Übersicht)](rooms/rooms-manage.md)
#### [Wartung und Betrieb](rooms/rooms-operations.md)
#### [Unterstützen von Teams in Ihrer Organisation](rooms/known-issues.md)
#### [Geräte mit Azure Monitor](rooms/azure-monitor-manage.md)
#### [Einstellungen mit einer XML-Datei](rooms/xml-config-file.md)
#### [Überprüfen der Wiederherstellung](rooms/recovery-tool.md)
...
## [Verwenden von NDI® Technologie in Teams](use-NDI-in-meetings.md)
## [Option zum Aufheben der Hand in Teams-Besprechungen](raise-hand-meetings.md)
...
### [Einrichten von Audiokonferenzen](set-up-audio-conferencing-in-teams.md)
### [Einrichten von Audiokonferenzen – Schnellstart für kleine und mittelständische Unternehmen](audio-conferencing-smb.md)
...
### [Verfügbarkeit nach Land und Region für Audiokonferenzen](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
...
#### [Telefonnummernverwaltung für Österreich](manage-phone-numbers-for-your-organization/phone-number-management-for-austria.md)
...
#### [Telefonnummernverwaltung für Dänemark](manage-phone-numbers-for-your-organization/phone-number-management-for-denmark.md)
...
#### [Telefonnummernverwaltung für Italien](manage-phone-numbers-for-your-organization/phone-number-management-for-italy.md)
#### [Telefonnummernverwaltung für Japan](manage-phone-numbers-for-your-organization/phone-number-management-for-japan.md)
#### [Telefonnummernverwaltung für Portugal](manage-phone-numbers-for-your-organization/phone-number-management-for-portugal.md)
...
#### [Telefonnummernverwaltung für Schweden](manage-phone-numbers-for-your-organization/phone-number-management-for-sweden.md)
#### [Telefonnummernverwaltung für Schweiz](manage-phone-numbers-for-your-organization/phone-number-management-for-switzerland.md)
...
#### [Telefonnummernverwaltung für die Vereinigten Staaten](manage-phone-numbers-for-your-organization/phone-number-management-for-the-u-s.md)
...
### Verwalten von Guthaben für Kommunikationen
...
## [Regionale Verfügbarkeit](business-voice/country-region-availability.md)
## Wichtige Informationen vor dem Kauf
### [So erhalten Sie Business Voice](business-voice/what-to-buy.md)
### [Hilfe von einem Wiederverkäufer oder Partner erhalten](business-voice/reseller-partner-support.md)
...
### [Optionale verbundene Erfahrung](teams-privacy-oce-overview.md)
...
### [Abrufen von Teams für Android in China](get-teams-android-in-china.md)
...
### [Microsoft 365 und Office 365-URLs und IP-Adressbereiche](office-365-urls-ip-address-ranges.md).
...
### [Lizenzierungsoptionen für Teams-Add-Ons](teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
...
### [Erweiterte Kommunikation](teams-add-on-licensing/advanced-communications.md)
...
### [Erstellen eines Microsoft 365-Ressourcenkontos mithilfe des Microsoft 365 Admin Centers](devices/resource-account-ui.md)
...
### [Wechseln vom Skype for Business Online-Connector zum PowerShell-Modul von Teams](teams-powershell-move-from-sfbo.md)
...
## [So finden Sie Ihre Support-PIN](support-pin.md)
...
### [Jamaika](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-jamaica.md)
...
### [St. Kitts und Nevis](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-saint-kitts-and-nevis.md)
### [St. Lucia](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-saint-lucia.md)
