...
4. Aktivieren Sie **auf der Seite** Produktlizenzen die Schaltfläche Audio **conferencing (Audiokonferenz),** und klicken Sie dann auf **Speichern.** Weitere Informationen zur Lizenzierung finden Sie [Microsoft Teams Add-On-Lizenzierung.](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
...
### <a name="enable-or-disable-using-the-microsoft-teams-admin-center"></a>Aktivieren oder Deaktivieren des Microsoft Teams Admin Centers
...
### <a name="enable-or-disable-using-windows-powershell"></a>Aktivieren oder Deaktivieren von Windows PowerShell
...
### <a name="reset-the-meeting-conference-id-using-the-microsoft-teams-admin-center"></a>Zurücksetzen der Konferenz-ID der Besprechung mithilfe Microsoft Teams Admin Center
...
### <a name="reset-a-conference-organizers-pin-using-the-microsoft-teams-admin-center"></a>Zurücksetzen der PIN eines Konferenzorganisators mithilfe Microsoft Teams Admin Center
...
### <a name="send-an-email-using-the-microsoft-teams-admin-center"></a>Senden einer E-Mail über Microsoft Teams Admin Center
...
### <a name="set-invite-phone-numbers-using-the-microsoft-teams-admin-center"></a>Festlegen von Telefonnummern für Einladungen über Microsoft Teams Admin Center
...
### <a name="set-the-meeting-experience-when-callers-join-a-meeting-using-the-microsoft-teams-admin-center"></a>Festlegen der Besprechungserfahrung, wenn Anrufer an einer Besprechung mithilfe des Microsoft Teams Admin Centers teilnehmen
...
### <a name="see-primary-and-secondary-languages-using-the-microsoft-teams-admin-center"></a>Primäre und sekundäre Sprachen im Microsoft Teams Admin Center
...
## <a name="see-audio-conferencing-dial-in-numbers-using-the-microsoft-teams-admin-center"></a>Einwahlnummern für Audiokonferenzen im Microsoft Teams Admin Center
