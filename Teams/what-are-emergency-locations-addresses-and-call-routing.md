...
In diesem Artikel werden Konzepte beschrieben, die Sie kennen müssen, um Notrufe&mdash; zu verwalten. Er enthält Informationen zu Notfalladressen, dynamischen Notfalladressen und Zum Weiterleiten von Notrufen. In diesem Artikel wird die folgende Terminologie verwendet:

- **Notfalladresse** – Eine Anschriftdie&mdash; physische oder Straßenadresse eines Geschäftsorts für Ihre Organisation.
...
- **Notfallstandort** - Ein Standort ist eine adressemit&mdash; einem optionalen Ort. Wenn Ihr Unternehmen über mehrere physische Standorte verfügt, benötigen Sie wahrscheinlich mehrere Notfallstandorte. 

  Wenn Sie eine Notfalladresse erstellen, wird automatisch eine eindeutige Standort-ID für diese Adresse erstellt. Wenn Sie z. B. einer Notfalladresse&mdash; einen Ort hinzufügen, wird eine Standort-ID für die Kombination aus Notfalladresse und Ort erstellt, wenn Sie einer Gebäudeadresse&mdash; einen Boden hinzufügen.  In diesem Beispiel gibt es zwei Standort-IDs: eine für die Anschrift; eine für die beigetretene Adresse und den zugehörigen Ort.
