...
ms.locfileid: "23855797"
---
# <a name="manage-meeting-policies-in-teams"></a>Verwalten von Besprechungsrichtlinien in Teams

Besprechungsrichtlinien werden verwendet, um die Steuerung der Features, die an die Teilnehmer für die Besprechung, die von Benutzern in Ihrer Organisation geplant sind verfügbar sind. Nachdem Sie eine Richtlinie erstellen und Ihre Änderungen vornehmen, können Sie und Zuweisen der Richtlinie verwendet. 

## <a name="here-are-the-settings-you-can-change-to-fit-your-organization"></a>Hier sind die Einstellungen, die Sie ändern können, um Ihre Organisation passen
<a name="bkgeneral"> </a>

## <a name="general"></a>Allgemein
   - **Name** Dies ist der Name der Richtlinie, die auf der Seite für den Richtlinien angezeigt wird. Sie können keine spezielle Chararcters enthalten oder als 64 Zeichen lang sein.
   - **Beschreibung** Sie können in eine benutzerfreundliche Beschreibung für Ihre Richtlinie hinzufügen, die Sie erstellen. Das ist hilfreich, wenn Sie eine Richtlinie für eine Gruppe von Benutzern zuweisen möchten.
...
## <a name="participants--guests"></a>Teilnehmer & Gäste
   - **Dial-Out - anonyme Benutzer zulassen** Wenn Sie Teilnehmer Anwahl, um eine andere Person hinzufügen möchten, können Sie diese aktivieren. Wenn Sie sie deaktivieren, können keine der Teilnehmer der Besprechung aus der Besprechung anwählen.
   - **Anonyme Benutzer können Besprechungen starten** Wenn diese Einstellung deaktiviert ist, kann nur von einer Person, die für die Besprechung mit einer app Teams authentifiziert wurde die Besprechung beginnen. Falls er aktiviert ist, kann alle Benutzer die Besprechung starten.
   - **Benutzer automatisch zulassen** Wenn Sie diese Option deaktiviert wird, klicken Sie dann Teilnehmer in der Lobby bleibt, bis eine Person die Besprechung wird gestartet. Falls er aktiviert ist, die Teilnehmer automatisch die Besprechung beitreten zulässig.
