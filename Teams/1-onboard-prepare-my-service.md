...
Die folgenden Prüflisten führen Sie durch die Schritte für die Implementierung von Audiokonferenzen und Telefonsystem mit Aufrufen plant-Funktionen in Microsoft-Teams.

*  [Vorbereiten der Office 365 für Teams](https://docs.microsoft.com/MicrosoftTeams/onboarding-checklist-enable-office-365)

*  [Konfigurieren von Teams Kernfunktionen](https://docs.microsoft.com/MicrosoftTeams/onboarding-checklist-configure-microsoft-teams-core-capabilities)

*  [Netzwerk konfigurieren](https://docs.microsoft.com/MicrosoftTeams/onboarding-checklist-configure-networking)

*  [Konfigurieren von VoIP-Arbeitslasten Cloud in Teams](https://docs.microsoft.com/MicrosoftTeams/onboarding-checklist-configure-cloud-voice-workloads-in-Microsoft-Teams)
...
>[!NOTE]
>Diese Anleitung konzentriert sich ausschließlich auf Telefonsystem mit Aufrufen plant und Audiokonferenzen. Wenn Sie neue Teams sind, überprüfen Sie die [Übersicht der Microsoft-Teams](https://docs.microsoft.com/MicrosoftTeams/teams-overview). Allgemeine Richtlinien zum Planen der Bereitstellung von Teams finden Sie im [Planungshandbuch für Microsoft Teams](https://docs.microsoft.com/MicrosoftTeams/quick-start-enable-teams).
...
In der einfachsten Form basiert Ihren testing Ansatz auf Ihre überprüfen, die die Feature-Funktionen der Audiokonferenzen oder Telefonsystem mit dem Dienst aufrufen plant und entwickeln einem Plan zum Testen zu überprüfen, ob Standarddateispeicherort Funktionalität für Benutzer im Gültigkeitsbereich erfüllt sind. Es folgt ein Beispiel Testplan für die integrierte Phase einer Audiokonferenz Implementierung.
...
| Telefonsystem mit Aufrufen plant Feature zum Testen | Zusammenfassung der Ergebnisse | Zusätzliche Hinweise |
|----------------------------------------------------|-----------------|------------------|
| Machen Sie einen PSTN-Anruf an, indem Sie eine PSTN-Nummer zu wählen       | Bestanden wurden oder       | TBD |
...
**Telefonsystem mit Aufrufen plant Voraussetzungen und Annahmen für Benutzer und Standorte im Bereich testen:**

-   Business Verwendung Groß-/Kleinschreibung Definition für das Telefonsystem mit Aufrufen plant-Dienst wurde abgeschlossen.

-   Lizenzierung für Telefonsystem mit Aufrufen Pläne erforderlich ist verfügbar und zugewiesen wurde.
...
-   Mandanten für Benutzerrichtlinien und Wählplan-Einstellungen für die Telefonsystem mit Aufrufen plant Szenarien unterstützen identifiziert, angewendet und konfiguriert wurden.

-   Telefonsystem mit Compliance-Bestimmungen plant aufrufen identifiziert und konfiguriert wurden.

<table>
<tr><td>![](media/audio_conferencing_image7.png) <br/>Entscheidungspunkte</td><td><ul><li>Entscheiden, welche Funktionen der Audiokonferenz Feature bereitgestellt werden soll (service Entscheidung).</li><li>Identifizieren der Anforderungen an den Funktionen für Audiokonferenzen.</li><li>Identifizieren Sie die Konfiguration der dienstanforderungen für Audiokonferenzen.</li><li>Entscheiden Sie, welche Telefonsystem mit Aufrufen plant-Funktionen werden (Service Entscheidung) bereitgestellt.</li><li>Identifizieren der Anforderungen für Benutzer-Funktionalität für Telefonsystem mit plant aufrufen.</li><li>Identifizieren Sie Service Konfigurationsaufwand für Telefonsystem mit plant aufrufen.</li></ul></td></tr>
<tr><td>![](media/audio_conferencing_image9.png)<br/>Nächste Schritte</td><td><ul><li>Entwickeln Sie und Dokumentieren Sie Ihren Test Plan Ansatz.</li><li>Vorbereiten der Service-Umgebung und Benutzer für Audiokonferenzen Features im Bereich.</li><li>Vorbereiten der Service-Umgebung und Benutzer im Gültigkeitsbereich für Telefonsystem mit Features plant aufrufen.</li><li>Führen Sie Test-Überprüfung für die Audiokonferenz-Features, die Sie aktivieren möchten.</li><li>Führen Sie Test-Überprüfung für das Telefonsystem mit Aufrufen plant Features, die Sie aktivieren möchten.</li><li>Testen Sie für alle Fehler, bestätigen Sie, dass Ihre Konfiguration korrekt ist, Community-Artikel zu lesen und – falls erforderlich – auslösen eine Supportanfrage.</li></ul></td></tr>
</table>


Weitere ausführliche Anleitungen zur Durchführung von Tests für Audiokonferenzen in Teams, finden Sie im [detaillierte testing Guide für Audiokonferenzen] (https://docs.microsoft.com/MicrosoftTeams/onboarding-test-plan-for-enterprises-Audio-Conferencing).

Weitere ausführliche Anleitungen zur Durchführung von Tests für Telefonsystem mit Aufrufen in Teams plant finden Sie unter der- [ausführliche Anleitung für Telefonsystem testen](https://docs.microsoft.com/MicrosoftTeams/onboarding-test-plan-for-enterprises-Phone-System).
