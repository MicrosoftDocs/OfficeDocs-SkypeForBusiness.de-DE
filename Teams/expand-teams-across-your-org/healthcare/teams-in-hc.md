...
- Integration virtueller Termine und elektronischer Gesundheitsdatensatz (EHR)
- Teams-Richtlinienpakete
- Sicheres Messaging
- Teams-Vorlagen
- Pflegekoordination und Zusammenarbeit

Diese Funktionalität ist Teil Microsoft Cloud for Healthcare. Erfahren Sie mehr über die Verwendung dieser Lösung, die Funktionen von Azure, Dynamics 365 und Microsoft 365 bei[Microsoft Cloud für das Gesundheitswesen](/industry/healthcare) zusammenbringt.

Schauen Sie sich das folgende Video an, um mehr über die Verwendung der Gesundheitssammlung zur Verbesserung der Zusammenarbeit im Gesundheitsteam in Teams zu erfahren.
...
| -------- | -------- | -------- |
| [Virtuelle Termine mit Integration von Elektronischen Gesundheitsdatensatz (EHR)](#virtual-appointments-and-electronic-healthcare-record-ehr-integration) | Planen, Verwalten und Durchführen virtueller Termine mit Patienten. In diesem Szenario werden Teams und die Cerner- oder Epic-Plattform verbunden, um virtuelle Termine zu unterstützen. | Aktives Abonnement für Microsoft Cloud for Healthcare oder Abonnement Microsoft Teams eigenständigen EHR-Connectorangebots. <br> Benutzer müssen über eine entsprechende Microsoft 365- oder Office 365-Lizenz verfügen, die Teams Besprechungen* umfasst. <br> Organisationen müssen cerner-Version November 2018 oder höher oder Epic Version November 2018 oder höher haben. <br>Details zu [den Anforderungen der Cerner EHR](ehr-admin-cerner.md#before-you-begin) und [Epic EHR](ehr-admin.md#before-you-begin) |
| [Virtuelle Termine mit Microsoft Bookings und der Bookings-App](#virtual-appointments-and-electronic-healthcare-record-ehr-integration) | Planen, Verwalten und Durchführen virtueller Termine mit Patienten. Dieses Szenario basiert auf Microsoft Bookings, um virtuelle Termine zu unterstützen. | Microsoft Bookings muss für die Organisation aktiviert sein. <br> Alle Benutzer der Bookings-App und alle an Besprechungen teilnehmenden Mitarbeiter müssen über eine Lizenz verfügen, die die Planung von Teams-Besprechungen unterstützt*. <br>[Details zu den Anforderungen für Bookings](../../bookings-app-admin.md#prerequisites-to-use-the-bookings-app-in-teams)|
...
## <a name="virtual-appointments-and-electronic-healthcare-record-ehr-integration"></a>Integration virtueller Termine und elektronischer Gesundheitsdatensatz (EHR)

Verwenden Sie die vollständige Besprechungsplattform in Teams, um virtuelle Termine mit Patienten zu planen, zu verwalten und durchzuführen.

- Wenn Ihre Organisation bereits elektronische Gesundheitsdatensätze oder AA verwendet, können Sie Teams integrieren, um eine nahtlosere Erfahrung zu erzielen. Teams Connector für elektronische Gesundheitsakte (EHR) erleichtert Es Klinikern, einen virtuellen Patiententermin oder eine Konsultation mit einem anderen Anbieter in Teams direkt aus dem EEHR-System zu starten. Weitere Informationen finden Sie unter [Virtuelle Termine mit Teams - Integration in Cerner EHR](ehr-admin-cerner.md) und [virtuelle Termine mit Teams - Integration in Epic EHR](ehr-admin.md).
- Wenn Sie keine unterstützte EGA verwenden, können Sie Microsoft Bookings und die Bookings-App in Teams verwenden. Weitere Informationen finden Sie unter [Virtuelle Termine mit Teams und der Bookings-App](../bookings-virtual-visits.md).

![Virtuelle Termine mit Microsoft Teams.](../../media/virtual-visits-teams.png)
...
Bringen Sie Ihr Gesundheitsteam zusammen, um die Pflege zu koordinieren und mit Teams zusammenzuarbeiten.

![Gesundheitswesen: Zusammenarbeiten mit Ihrem Gesundheitsteam in Teams.](../../media/teams-healthcare-collaborate-in-teams.png)

Teams ermöglicht Es Ärzten, Klinikern, Krankenschwestern und anderen Mitarbeitern, effizient mit den integrierten Zusammenarbeitsfunktionen in Teams zusammenzuarbeiten, z. B.:
