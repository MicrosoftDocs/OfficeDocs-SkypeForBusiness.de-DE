...
## <a name="virtual-visits-and-electronic-healthcare-record-ehr-integration"></a>Integration virtueller Besuche und elektronischer Datensatz im Gesundheitswesen (Electronic Healthcare Record, EHR)

Verwenden Sie die vollständige Besprechungsplattform in Teams zum Planen, Verwalten und Durchführen virtueller Termine mit Patienten.
...
Bringen Sie Ihr Gesundheitsteam zusammen, um die Pflege zu koordinieren und mit Teams.

![Gesundheitswesen: Arbeiten Sie mit Ihrem Gesundheitsteam in Teams.](../../media/teams-healthcare-collaborate-in-teams.png)

Teams ermöglicht es Ärzten, Klinikikern, Krankenschwesteren und anderen Mitarbeitern, effizient zusammenzuarbeiten und die Funktionen für die Zusammenarbeit in Teams, z. B.:
