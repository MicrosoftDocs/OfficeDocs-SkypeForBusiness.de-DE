...
ms.locfileid: "42008127"
---
# <a name="teams-for-government"></a>Teams für Behörden

Verwenden Sie diese Ressourcen, um Informationen zu bestimmten Überlegungen für die Bereitstellung von Teams in Microsoft 365 Government-Umgebungen zu erhalten. Wenn Sie fertig sind, folgen Sie dem empfohlenen Bereitstellungspfad für Teams, wie in so [wird es gemacht, Microsoft Teams zu Rollout](../How-to-roll-out-teams.md).
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Plan für Microsoft 365 Government-gcc-Bereitstellungen</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Planen von Microsoft 365 Government – GCC High</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Plan für Microsoft 365 Government-DoD-Bereitstellungen</h3>
                    </div>
                </div>
            </div>
        </div>
