...
Diese Änderungen sind Teil unserer fortgesetzten Bemühungen, jeden Mitarbeiter in die Lage zu Microsoft 365. Mit Den Funktionen für Frontline-Mitarbeiter in Teams kann jeder Mitarbeiter in Ihrer Organisation Teams verwenden, um ihren Arbeitstag zu optimieren, mit Kollegen zusammenzuarbeiten und auf Informationen und Kompetenzen zu zugreifen, damit sie ihre Arbeit optimal optimieren können.
...
StaffHub wurde am 30. Juni 2020 für alle Benutzer eingestellt. Jeder Benutzer, der versucht, die App zu öffnen, wird eine Meldung angezeigt, die ihn zum Herunterladen Teams.
...
Die Schichten-App in Teams ist ein Zeitplanverwaltungstool, das Frontline Workers verbunden und synchronisiert. Vorgesetzte erstellen, aktualisieren und verwalten Schichtzeitpläne für Teams, und Teammitglieder können ihre Zeitpläne anzeigen, sehen, wer sonst noch für den Tag geplant ist, anfragen, eine Schicht tauschen oder anbieten und auf ihren mobilen Geräten freizeit anfragen.  
...
Schichten stehen im Teams-Client, Teams-Desktopclient und Teams mobilen Clients (iOS und Android) zur Verfügung.
...
Für Teammitglieder ist die mobile App so optimiert, dass sie ihren Zeitplan anzeigen, sehen, mit wem sie an einem Tag arbeiten, ein- und aussuhrt, die Verfügbarkeit festlegen, arbeits freie Zeit anfordern, Schichten tauschen oder anbieten und Offene Schichten anbieten. Es gibt Unterschiede in der Frage, was Benutzer in Desktop- und Web-Apps tun können, im Vergleich zu den mobilen Apps. Wir arbeiten an der Parität der Features.
...
Schichten funktioniert in allen Browsern, die Teams unterstützt, einschließlich der neuesten Microsoft Edge-, Internet Explorer-, Google Chrome- und Mozilla Firefox-Versionen. Weitere Informationen finden Sie unter [Kunden für Teams.](../../get-clients.md)
...
Verschiebt Daten werden in Azure in Rechenzentren in Nordamerika und Westeuropa gespeichert. SharePoint von Inhalten Microsoft 365 Gruppen und verwendet denselben Speicher und Support.

Weitere Informationen finden Sie unter [Speicherort von Schichten-Daten.](manage-the-shifts-app-for-your-organization-in-teams.md#location-of-shifts-data)
...
Hilfe für Endbenutzer können Sie unter Hilfe zu Schichten [für Mitarbeiter an der Vorderlinie .](https://support.office.com/article/apps-and-services-cc1fba57-9900-4634-8306-2360a40c665b)

#### <a name="what-licenses-do-i-need-for-teams"></a>Welche Lizenzen brauche ich für Teams?

Jeder Benutzer muss über eine aktive Lizenz Microsoft 365 oder Office 365 berechtigten Plan verfügen und über eine Lizenz Teams verfügen. 

#### <a name="how-do-i-enable-teams-in-my-organization"></a>Wie kann ich Teams in meiner Organisation aktivieren?

Standardmäßig ist Teams für alle Organisationen aktiviert. Sie weisen Teams Lizenzen zu, um den individuellen Zugriff auf ihre Teams. Weitere Informationen finden Sie unter [Aktivieren Teams In](../../Office-365-set-up.md) Ihrer Organisation und Verwalten des [Benutzerzugriffs auf Teams.](../../user-access.md)
...
Teams unterstützt die Koexistenz mit Skype for Business. Weitere Informationen finden Sie unter Teams [und Skype for Business Koexistenz](../../teams-and-skypeforbusiness-coexistence-and-interoperability.md) und Interoperabilität sowie Anleitungen für Migration und Interoperabilität für Organisationen, die [Teams](../../migration-interop-guidance-for-teams-with-skype.md)zusammen mit Skype for Business.

#### <a name="does-each-user-need-to-have-a-microsoft-365-or-office-365-account-or-azure-active-directory-azure-ad-account"></a>Muss jeder Benutzer über ein Microsoft 365 Oder Office 365 Konto oder Azure Active Directory (Azure AD)-Konto verfügen?
...
Wenn Sie an diesem Thema interessiert sind, senden Sie uns eine Anfrage über Teams [Feedbackportal auf UserVoice.](https://microsoftteams.uservoice.com/forums/555103-public-preview/category/182881-developer-platform)
