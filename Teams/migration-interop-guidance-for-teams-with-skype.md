...
- *Veröffentlichung von* Anwesenheitsinformationen: Werden die Anwesenheitsinformationen des Benutzers für andere Benutzer basierend auf ihrer Aktivität in Teams oder Skype for Business? 
...
- *Clienterfahrung:* Welche Funktionen sind in Teams und/oder im Skype for Business verfügbar? Können Benutzer Initiierung von Anrufen und Chats in Teams, Skype for Business chatten? Steht Teams & Kanäle zur Verfügung?  
...
<sup>1</sup> Die Möglichkeit zur Teilnahme an einer vorhandenen Besprechung (Teams oder in Skype for Business geplant) unterliegt nicht dem Modus. Standardmäßig können Benutzer immer an jeder Besprechung teilnehmen, zu der sie eingeladen wurden.
...
- Wenn Sie einen Benutzer ($SipAddress) auf eine Teams aktualisieren möchten, erteilen Sie die Instanz "UpgradeToTeams":</br>
...
## <a name="the-teams-client-user-experience-when-using-skype-for-business-modes"></a>Die Teams der Clientbenutzererfahrung bei Verwendung Skype for Business Modi
