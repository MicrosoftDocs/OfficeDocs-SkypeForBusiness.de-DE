...
Stellen Sie vor der Microsoft Teams-Räume mit Exchange Online sicher, dass Sie die Anforderungen erfüllt haben. Weitere Informationen finden Sie unter [Microsoft Teams-Räume Anforderungen.](requirements.md)
...
> [!NOTE]
> Wenn Sie ihr Konto so Teams-Räume, dass Sie nur an Microsoft Teams teilnehmen, müssen Sie nicht die folgenden Schritte ausführen. Die folgenden Schritte sind nur erforderlich, wenn Sie die Unterstützung für Skype for Business.
