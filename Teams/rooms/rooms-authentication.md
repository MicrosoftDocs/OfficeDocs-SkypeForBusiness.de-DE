...
Legen Sie SkypeSettings.xml XML-Element für die moderne Authentifizierung wie folgt auf **True** (wahr) in Der Datei "SkypeSettings.xml" dar.
...
Bevor Sie beginnen, stellen Sie sicher, dass Sie die Identitätsmodelle kennen, die für die Verwendung mit Office 365 und Azure AD. Weitere Informationen finden Sie unter [Office 365](/Office365/Enterprise/about-office-365-identity) Identitätsmodellen und Azure Active Directory hybride Identität und Verzeichnissynchronisierung für Microsoft 365 [oder Office 365](/Office365/Enterprise/plan-for-directory-synchronization).
...
Es wird empfohlen, grundlegende Authentifizierungsrichtlinien für Exchange Online nicht zu entfernen oder die Standardauthentifizierung für Ihren Mandanten zu deaktivieren, bis Sie überprüft haben, dass Microsoft Teams-Räume-Geräte sich erfolgreich mit Exchange Online und Teams.
...
Die Voraussetzungen für die Aktivierung der modernen Authentifizierung in Ihrer [Hybridtopologie](/office365/enterprise/hybrid-modern-auth-overview) werden unter Übersicht über die moderne Hybridauthentifizierung und die Voraussetzungen für die Verwendung mit lokalen Skype for Business und Exchange behandelt. Es gelten alle Voraussetzungen, die in diesem Artikel erläutert werden.
...
- Wenn Sie einen Drittanbieter für die Authentifizierung verwenden, der von Azure AD unterstützt wird, muss er einen aktiven Authentifizierungsfluss über WS-Trust unterstützen.
...
Sie können ein ressourcenbasiertes Konto konfigurieren, das Microsoft Teams-Räume für IP-/standortbasierter Zugriff verwendet wird. Weitere Informationen finden Sie unter [Bedingter Zugriff: Zugriff nach Standort blockieren](/azure/active-directory/conditional-access/howto-conditional-access-policy-location).
