...
| `<CoordinatedMeetings>` | `<TrustedAccounts>`                       |           | Dies ist eine durch Trennzeichen getrennte Liste von UPNs für jedes Teams Room-Gerät oder Surface Hub, von dem das Gerät Besprechungsteilnahmeanfragen annehmen soll oder an die Besprechungsteilnahmeanfragen gesendet werden sollten.<br>Akzeptierte Werte: string                                                                                                                                                                                                                                                                                                                         |
