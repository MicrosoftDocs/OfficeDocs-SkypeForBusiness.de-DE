...
| Einwahlkonferenzen            | Aktivieren von *Besprechungen, die direkt* über die Microsoft Teams-Räume mit Einwahlkonferenzkoordinaten gestartet werden | Aktiviert für Audiokonferenzen                                          |
...
**Pro Tipp:** Sorgen Sie dafür, dass die Anzeigenamen für diese Konten aussagekräftig und leicht verständlich sind. Dies sind die Namen, die Benutzern angezeigt werden, wenn sie nach anderen Microsoft Teams-Räume zu Besprechungen hinzufügen. Einige Organisationen verwenden die Veranstaltung Websiteraumname ( Max. Raumkapazität )-RS, daher könnte - Curie, ein 12-Personen-Konferenzraum in London, beispielsweise den Anzeigenamen LON-CURIE(12)-RS haben. 

|  &nbsp;  | &nbsp;    |
|-----------|------------|
| ![die Benennungskonvention festlegen.](../media/audio_conferencing_image7.png) <br/>Entscheidungspunkte|<ul><li>Entscheiden Sie die Namenskonvention für Ihre Microsoft Teams-Räume Konten.</li><li>Entscheiden Sie, ob Sie einzelne Konten erstellen oder Massenbereitstellungsskripts verwenden möchten.</li></ul>| 
...
| **Szenario**            | **Ansatz**         |
|-------------------------|-----------------------|   
|Bereitstellen von einigen Microsoft Teams-Räume (<10). | Wenn Sie Surface Pro-basierte Microsoft Teams-Räume verwenden, befolgen Sie die Installationsanweisungen für eine [gerätebezogene Installation.](console.md) [Dieses praktische Video führt Sie durch den Prozess.](https://content.cloudguides.com/guides/Configure%20the%20Skype%20Room%20Systems%20console) Wenn Sie eine integrierte Lösung verwenden, stellen Sie die Bereitstellung mithilfe des Anbieterbilds vor, und konfigurieren Sie die Einstellungen nach Bedarf. |
...
Im Rahmen der Bereitstellung müssen Sie auch Ihre Strategie für die [](/skypeforbusiness/plan-your-deployment/clients-and-devices/skype-room-systems-v2-0#local-accounts) Verwaltung und Konfiguration der lokalen Konten berücksichtigen, die vom Installationsprogramm für Microsoft Teams-Räume werden.
...
Eine zusätzliche Überlegung ist, ob die Microsoft Teams-Räume mitglied der Domäne werden soll. Informationen zu den Vorteilen der Teilnahme an Domänen finden Sie in den [Skype zur Teilnahme an Domänen im Raumsystem.](domain-joining-considerations.md) 

| &nbsp;   |  &nbsp;   |
|-----------|------------|
| ![Entscheidungspunkte für die Gerätebenennung.](../media/audio_conferencing_image7.png) <br/>Entscheidungspunkte|<ul><li>Entscheiden Sie Microsoft Teams-Räume, welche Gerätebenennungskonvention während der Bereitstellung verwendet werden soll.</li><li>Entscheiden Sie, ob Sie Ihrer Domäne Microsoft Teams-Räume und wie Sie lokale Konten verwalten und konfigurieren möchten. </li><li>Entscheiden Sie, ob Sie die Operations Management Suite verwenden möchten, um die Bereitstellung Microsoft Teams-Räume überwachen.</li><li>Entscheiden Sie, mit welcher Methode Sie die Software und Agents auf dem Microsoft Teams-Räume für die Gerätebereitstellung bereitstellen möchten. </li></ul>| 
