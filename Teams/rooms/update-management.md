---
title: Microsoft Teams-Räume update management
author: donnah007
...
|Software |Anleitung |
| :- | :- |
|Logitech Sync Services  |Sollte auf den Geräten des Logitech-Besprechungsraums installiert und ausgeführt werden. Erforderliche Synchronisierungsdienste werden automatisch über Updates installiert, Windows blockiert wird. Das vollständige Synchronisierungspaket kann ebenfalls installiert werden. |
...
|Microsoft Store Updates   |Sollte deaktiviert sein. Verwaltete Dienste deaktivieren alle Store, falls diese zu finden sind. |
...
![Screenshot aller Mandantenringe und der Räume](../media/update-management-002.jpg)
...
1. Navigieren Sie zur **Registerkarte Ringe.**
1. Klicken Sie auf den Ring, um ihn zu löschen.  
