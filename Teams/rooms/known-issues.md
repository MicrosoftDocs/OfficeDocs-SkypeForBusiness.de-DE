...
Wenn Ihr Microsoft Teams-Räume-Gerät nicht mehr mit der Domäne vertraut, können Sie sich nicht mehr beim Gerät authentifizieren und keine Einstellungen. Wenn Sie beispielsweise die Domäne Microsoft Teams-Räume, nachdem die Domäne beigetreten ist, geht die Vertrauensstellung verloren. Die Lösung ist, sich mit dem lokalen Administratorkonto anzumelden. 
***
