...
- seo-marvel-apr2020
description: Erfahren Sie, wie Audiokonferenzen in Microsoft 365 oder Office 365 Benutzern ermöglichen, sich von ihren Telefonen aus an Besprechungen zu senden.
...
Audiokonferenzen in Microsoft 365 und Office 365 ermöglichen Es Benutzern, sich von ihren Telefonen aus an Besprechungen zu machen. Audiokonferenzen ermöglichen bis zu 250 Telefonteilnehmer.
...
Nachdem Teilnehmer der Besprechung beigetreten sind, können diese auch eine Auswahlverbindung herstellen und andere Anrufer zu einer Skype for Business- oder Microsoft Teams-Besprechung einladen. Informationen hierzu finden Sie unter [Herstellen einer Auswahlverbindung in einer Teams-Besprechung, um andere Personen dazu einzuladen](dialing-out-from-a-teams-meeting-so-other-people-can-join-it.md) oder [Herstellen einer Auswahlverbindung in einer Skype for Business-Besprechung, um andere Personen dazu einzuladen](/SkypeForBusiness/audio-conferencing-in-office-365/dialing-out-from-a-meeting-so-other-people-can-join-it).
