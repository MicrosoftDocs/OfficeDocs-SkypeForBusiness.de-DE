...
> | Frage | Antwort | Kommentare |
> |---|---|---|
> | Wie (oder wie werden) die Benutzer im Bereich für die Migration <br/>Access Teams, wenn Sie im Büro sind? <br/>Wählen Sie alle zutreffenden aus. | <input type="checkbox"> Weitergeleitete NAT-Verbindung <br/> <input type="checkbox"> Proxy Server <br/> <input type="checkbox"> Öffentliche Wi-Fi <br/> <input type="checkbox"> Verwaltet (nicht öffentlich) Wi-Fi <br/> <input type="checkbox"> Express Route <br/>&nbsp;&nbsp; &nbsp; (Microsoft Peering) ||
