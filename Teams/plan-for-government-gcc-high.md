...
- Microsoft 365 Government – gcc-Höchstleistung entspricht Zertifizierungen und Akkreditierungen, die für Kunden im öffentlichen Dienst in den USA erforderlich sind.
...
|    |     |
|-----------|------------|
| ![Ein Symbol, das Entscheidungspunkte darstellt](media/audio_conferencing_image7.png) <br/>Entscheidungspunkte|<ul><li>Entscheiden Sie, ob Microsoft 365 Government-gcc-höchst für Ihre Organisation geeignet ist.</li><li>Vergewissern Sie sich, dass Ihre Organisation die Berechtigungsanforderungen erfüllt.</li></ul> |
...
| | Intra-Cloud (GCCH to GCCH)-Verbund Besprechungen | Verfügbar |
...
Nachdem Sie die Microsoft 365 Government – gcc-hoch installiert haben, können Sie den Standard Bereitstellungsansatz der Verwendung von " [](https://www.microsoft.com/fasttrack) schnell" und des von Ihnen ausgewählten Partners für die Onboard-Nutzung des Diensts befolgen.
