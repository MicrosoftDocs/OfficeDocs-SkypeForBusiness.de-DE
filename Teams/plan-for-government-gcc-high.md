...
---
# <a name="plan-for-office-365-government---gcc-high-deployments"></a>Planen von Office 365 Government-gcc-Installationen mit hoher Qualität
...
> [!NOTE]
> Wenn Ihre Organisation bereits die Anforderungen von Office 365 Government – gcc für höchste Ansprüche erfüllt und in das Programm übernommen und akzeptiert wurde, können Sie die Schritte 1 und 2 überspringen und direkt zu Schritt 3 wechseln.

## <a name="step-1-determine-whether-your-organization-needs-office-365-government---gcc-high-and-meets-eligibility-requirements"></a>Schritt 1: Ermitteln Sie, ob Ihre Organisation Office 365 Government-gcc-höchst Bedarf erfüllt und die Anspruchsvoraussetzungen erfüllt. 

Die Office 365 Government-gcc-Umgebung bietet die Einhaltung der Anforderungen der US-Regierung für Cloud-Services. Neben der Nutzung der Features und Funktionen von Office 365 profitieren Organisationen von den folgenden Features, die für Office 365 Government – gcc-Hochleistungs Unternehmen einzigartig sind:
...
|    |     |
|-----------|------------|
| ![Ein Symbol mit Entscheidungspunkten](media/audio_conferencing_image7.png) <br/>Entscheidungspunkte|<ul><li>Entscheiden Sie, ob Office 365 Government-gcc höchst für Ihre Organisation geeignet ist.</li><li>Vergewissern Sie sich, dass Ihre Organisation die Berechtigungsanforderungen erfüllt.</li></ul> |

> [!Note]
> Office 365 Government-gcc-höchst steht nur in den USA zur Verfügung. Kunden außerhalb der US-Regierung können aus einer Reihe von [Office 365 Government-Plänen](https://products.office.com/en/government/compare-office-365-government-plans)wählen.

## <a name="step-2-apply-for-office-365-government---gcc-high"></a>Schritt 2: Bewerben für Office 365 Government-gcc-höchst
...
## <a name="step-3-understand-office-365-government---gcc-high-default-security-settings"></a>Schritt 3: Grundlegendes zu Office 365 Government-gcc-Standardsicherheitseinstellungen.
...
|    |     |
|-----------|------------|
| ![Symbol, das einen Entscheidungspunkt darstellt](media/audio_conferencing_image7.png) <br/>Entscheidungspunkt|<ul><li>Entscheiden Sie, ob Sie die standardmäßigen Office 365 Government-gcc-Hochsicherheits Einstellungen ändern müssen, um zunächst die Auswirkungen von Änderungen zu verstehen, die Sie möglicherweise vornehmen.</li></ul> |


## <a name="step-4-understand-which-teams-capabilities-are-currently-available-in-office-365-government---gcc-high"></a>Schritt 4: Grundlegendes zu den verfügbaren Teamfunktionen in Office 365 Government – gcc-groß

Um den Anforderungen unserer Government Cloud-Kunden gerecht zu werden, gibt es einige Unterschiede zwischen den Teams in Office 365 Government-gcc-höchst-und Teams in den Enterprise-Plänen. Informationen zu den verfügbaren Features finden Sie in der folgenden Tabelle.
