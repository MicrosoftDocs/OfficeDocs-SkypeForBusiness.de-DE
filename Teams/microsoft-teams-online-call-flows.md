...
- **Hintergrund** – bietet Hintergrundinformationen, beispielsweise Netzwerke, die von Office 365 Flows durchlaufen werden, Art des Datenverkehrs, Verbindungs Anleitungen vom Kundennetzwerk zu Office 365-Dienstendpunkten, Interoperabilität mit Komponenten von Drittanbietern und Grundsätze, die von Teams zur Auswahl von Medienströmen verwendet werden.
...
**VPN-Netzwerk**: Es wird nicht für Mediendatenverkehr (also Flow 2 ') empfohlen. Der VPN-Client sollte Split-VPN verwenden und Mediendatenverkehr wie alle externen nicht-VPN-Benutzer weiterleiten, wie in [Aktivieren von lync Media zur Umgehung eines VPN-Tunnels](https://techcommunity.microsoft.com/t5/Skype-for-Business-Blog/Enabling-Lync-Media-to-Bypass-a-VPN-Tunnel/ba-p/620210)angegeben.

> [!NOTE]
> Obwohl der Titel lync ist, gilt er auch für Teams.
...
1. Teams-Benutzer a ordnet einen Media Relay-Port im Teams-Transport-Relay über Flow 4 zu
1. Teams Benutzer A sendet "einladen" mit ICE-Kandidaten über Flow 4 an Office 365
1. Office 365 sendet eine Benachrichtigung an Teams Benutzer B über Flow 4
1. Teams Benutzer B ordnet einen Media Relay-Port im Teams-Transport-Relay über Flow 4 zu
1. Teams Benutzer B sendet "Antwort" mit ICE-Kandidaten über Flow 4, der über Flow 4 wieder an Teams-Benutzer weitergeleitet wird.
...
1. Benutzer von Teams senden Telemetrie an Office 365 über Flow 4
...
1. Teams-Benutzer im Kundennetzwerk ordnet einen Media Relay-Port auf Teams-Transport-Relay über Flow 1 zu
1. Teams-Nutzer im Kundennetzwerk senden "einladen" mit ICE-Kandidaten über Flow 1 an Office 365
1. Office 365 sendet Benachrichtigungen an externe Teams über Flow 3
1. Teams externer Benutzer ordnet einen Media Relay-Port im Teams-Transport-Relay über Flow 3 zu
1. Teams externer Benutzer sendet "Antwort" mit ICE-Kandidaten über Flow 3, der wieder an Teams-Benutzer A über Flow 1 weitergeleitet wird.
...
1. Benutzer von Teams senden Telemetrie an Office 365 über Flows 1 und 3
