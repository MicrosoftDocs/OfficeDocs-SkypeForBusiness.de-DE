...
audience: admin
description: Erfahren Sie, wie Sie die Leistung von Echtzeitmedien in Microsoft Teams mithilfe des Anrufqualitätsdashboards (CQD) analysieren und verwalten.
...
Anrufdaten geben Ihnen Nutzungsmetriken, führen aber nicht zwangsläufig zur Ursache für eine schlechte Anrufqualität. Wenn Sie sich die Datenstromrichtung anschauen, können Sie Faktoren identifizieren, z. B. einen Anruf, der sich nicht in einem verwalteten Netzwerk oder einen Anruf von einem Nichtmitarbeiter (z. B. einem Lieferanten oder einer Person in einem anderen Netzwerk) befinden. Wenn die Netzwerkverbindung der anderen Person in diesen Fällen schlecht war, wird der gesamte Anruf als "schlecht" gekennzeichnet. Sie können keine externen Faktoren berücksichtigen, daher sind diese Daten nicht hilfreich.
...
Die Fehlerrate bei der Einrichtung, auch als Messung "Total _Call Setup Failure Percentage"_ (Prozentsatz der Gesamtanrufeinrichtungsfehler) im AQD bezeichnet, ist die Anzahl der Datenströme, für die der Medienpfad zwischen den Endpunkten am Anfang des Anrufs nicht eingerichtet werden konnte.
...
Diese Aufgaben reichen von der Sicherstellung, dass ausreichend Bandbreite zum Erreichen des Diensts verfügbar ist, ohne Internetlinks zu verwenden, das Überprüfen der Dienstqualität (Quality of Service, QoS) in allen Bereichen verwalteter Netzwerke und das Auf dem Rang von [Office 365-IP-Bereichen in Firewalls.](/microsoft-365/enterprise/urls-and-ip-address-ranges)
...
Obwohl das CQD zum Analysieren von Trends und Subnetzen nützlich ist, bietet es nicht immer eine bestimmte Ursache für ein bestimmtes Szenario. Es ist wichtig, dies zu verstehen und die richtige Erwartung zu setzen, wenn Sie das AQD verwenden:
...
![Bericht mit dem Volumen der Datenströme, die TCP oder UDP verwenden.](media/qerguide-image-tcpvsudp.png)
