...
Wir empfehlen dringend, dass Sie den Netzwerk Planner nutzen, wenn Sie Medien Arbeitslasten in Ihrem Netzwerk bereitstellen, um die Gesamtauswirkung zu bewerten. Weitere Informationen zum Netzwerk Planner finden Sie unter [myadvisor](https://myadvisor.fasttrack.microsoft.com/CloudVoice/NetworkPlanner).
...
| **Benutzerverhalten**                            | Wenn Sie feststellen, dass kein Netzwerk, keine Geräte oder keine Clients das Problem sind, sollten Sie sich an [meinen Berater](https://aka.ms/myadvisor) wenden, um Hilfe bei der Entwicklung einer Strategie für die Benutzereinführung zu finden, um die Benutzer zu informieren, wie Sie Besprechungen am besten teilnehmen und beenden Eine intelligentere Teams und ein Skype for Business-Benutzer werden für alle Teilnehmer der Besprechung eine bessere Benutzererfahrung bieten. Ein Benutzer, der seinen Laptop in den Standbymodus versetzt (durch Schließen des Deckels), ohne die Besprechung zu beenden, wird als unerwarteter Anruf Rückgang eingestuft.   |
...
| **VPN**  | VPN-Appliances sind traditionell nicht für die Behandlung von Medien Auslastungen in Echtzeit konzipiert. Einige VPN-Konfigurationen untersagen die Verwendung von UDP (das bevorzugte Protokoll für Medien) und beruhen nur auf TCP. Sie sollten eine [VPN-Split-Tunnel-Lösung](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Downloads?SelectedIDs=5_1_0_9) implementieren, um VPN als Quelle schlechter Qualität zu reduzieren. |
| **Clients** <br>(Nur Skype for Business Online) | Ältere Clients haben bekanntermaßen Probleme mit Medien verursacht. Stellen Sie sicher, dass die Clients innerhalb von sechs Monaten nach der Veröffentlichung gepatcht werden. Verwenden [](https://aka.ms/myadvisor) Sie myadvisor, um Anleitungen zur Entwicklung einer Client Readiness-Strategie und zur Bereitstellung von [Klick-und-Los](https://docs.microsoft.com/DeployOffice/deployment-guide-for-office-365-proplus)zu erhalten. |
| **Geräte** | Durch die Verwendung [optimierter Geräte](https://partnersolutions.skypeforbusiness.com/solutionscatalog) kann die Benutzererfahrung deutlich verbessert werden. Da alle Dinge gleich sind, wurden optimierte Geräte entwickelt, um die Benutzererfahrung mit Teams und Skype for Business zu maximieren und hervorragende Qualität zu erzielen. Verwenden [](https://aka.ms/myadvisor) Sie myadvisor, um Anleitungen zur Entwicklung einer Geräte Bereitschafts Strategie zu erhalten. |
...
Die Geräte Berichte werden verwendet, um die Geräteverwendung nach Volumen und MOS Score (nur Audio) zu bewerten, und Sie finden Sie in den zugehörigen Vorlagen unter Clients &-Geräte. 
...
-   [Skype for Business-Lösungskatalog, Personal Peripherals & PCs](http://partnersolutions.skypeforbusiness.com/solutionscatalog/personal-peripherals-pcs)
