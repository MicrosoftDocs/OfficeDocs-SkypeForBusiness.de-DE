...
---
# <a name="plan-for-service-management-and-quality"></a>Planen von dienstverwaltung und Qualität

Dieses Dokument ist über die Phase Ermitteln übergeordneter Faktoren für Microsoft-Teams.
...
## <a name="key-components-that-affect-user-experience"></a>Erleben Sie die wichtige Komponenten, die Einfluss auf Benutzer

In diesem Abschnitt werden die wichtigsten Komponenten, die Benutzerinteraktion betreffen überprüft. Bevor die wichtigsten Komponenten überprüfen, ist es wichtig, dass Sie die benutzerfreundlichkeit und ihre Bedeutung in Ihrer Organisation Unternehmensziele realisieren verstehen. Sehen wir uns an, wie wir zunächst die Benutzeroberfläche definieren.

### <a name="user-experience-defined"></a>Benutzeroberfläche definiert

Geschäftlicher Ziele können realisiert werden, wenn Microsoft-Teams, Bereitstellung und integrieren Sie Communications in Ihre Geschäftsprozesse, um ihre Workflows zu verbessern. Qualität Laufwerke Annahme und Nutzung: Wenn Ihre Organisation bietet einen hohe Qualität-Dienst, der Personen Delights, Einzelpersonen und Teams Confidence erhalten und finden Sie neue und innovative Wege zur Verwendung des Diensts, die Geschäftsvorteile steuern können.

Erfahrung mit Teams des Benutzers besteht im Wesentlichen dieses – Ihre Gefühle auszudrücken und überlegen in Richtung des Diensts. Was trägt dies auf die Benutzeroberfläche? Es reicht von Benutzer wissen, wie Teams verwenden, und integrieren es in ihrer täglichen Workflow außergewöhnliche Anrufqualität auftritt und zuverlässig, unabhängig davon, wo sie sind Verbindung hergestellt wird. Benutzerinteraktion ist sehr große Natur. Dieses Dokument konzentriert sich nur auf die Elemente, die von Ihrer Organisation gesteuert werden können.
...
Eine Organisation oder unterstützenden Partner zu Beginn der Planung für die drei wichtigsten Komponenten der Phase Ermitteln übergeordneter Faktoren einer Bereitstellung Teams: service-Management, Netzwerk und Endpunkte. Die Kombination aus allen drei Bereichen ist unerlässlich für die Qualität des Benutzererlebnisses.
...
Ausführliche Anleitungen für Servicemanagement-Planung finden Sie unter [Planen für Service-Management](https://docs.microsoft.com/MicrosoftTeams/envision-planning-for-service-management-and-quality-complete-guide#Plan-for-service-management).
...
Ausführliche Hilfestellungen zur Netzwerk planen finden Sie unter [Planen für die Qualität des Netzwerks](https://docs.microsoft.com/MicrosoftTeams/envision-planning-for-service-management-and-quality-complete-guide#Plan-for-network-quality).
...
Um Ihre Benutzer die beste Leistung zu bieten möglich ist, müssen Sie diese wichtige Aspekte der Phase Ermitteln übergeordneter Faktoren berücksichtigen: Führen Sie die Endpunkte erfüllen die Teams Hardware und Software? Haben Sie Konfiguration und Optimierung der Endpunkte um Wi-Fi-Netzwerke zu unterstützen? Verwenden auf welchen Geräten Sie das tätigen und annehmen von Anrufen? Werden diese Geräte sind für Teams optimiert?

Ausführliche Hilfestellungen zur Planung der Endpunkt finden Sie unter [Planen für die Qualität des Endpunkts](https://docs.microsoft.com/MicrosoftTeams/envision-planning-for-service-management-and-quality-complete-guide#Plan-for-endpoint-quality).
...
![Diagramm zur Beschreibung der 3 Komponenten der Qualilty und wie Service-Management alle 3 Komponenten überlappt. Mit Schwerpunkt auf Service-Management.](media/envision-planning-for-service-management-and-quality-complete-guide-image2.png)
...
Zuordnen von Rollen einem frühen Zeitpunkt in der Phase Ermitteln übergeordneter Faktoren kann alle Teams Starten ihrer betriebsbezogenen Aufgaben während der Pilotphase, und lernen Sie Vorgänge, und stellen Sie sicher, dass Sie nach dem Starten der bereitstellungs abgeschlossen ist.
...
Im Handbuch für die Überprüfung von Quality Erfahrung finden Sie [hier](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/quality-of-experience-review-guide.docx?raw=true).
...
![Diagramm zur Beschreibung der 3 Komponenten der Qualität und wie Service-Management alle 3 Komponenten überlappt. Mit Schwerpunkt auf Netzwerk.](media/envision-planning-for-service-management-and-quality-complete-guide-image4.png)

Wie bereits erwähnt, Planung für Netzwerkqualität vor Onboarding zu Microsoft-Teams, wichtig ist. Weitere Hinweise für Bereitschaft des Netzwerks finden Sie unter [Vorbereiten des Netzwerks Ihrer Organisation für Microsoft-Teams](https://docs.microsoft.com/MicrosoftTeams/prepare-network).
...
Für die Implementierung von QoS in Ihrem Netzwerk, unterstützen die folgende Hinweise [Quality of Service in Microsoft-Teams](https://docs.microsoft.com/MicrosoftTeams/qos-in-teams)
...
[Proxyserver für Skype für Unternehmen Online und Teams](https://docs.microsoft.com/SkypeForBusiness/optimizing-your-network/proxy-servers-for-skype-for-business-online)
...
Nachdem die Firewall geöffnet ist, können Sie das [Tool zur Bewertung der Microsoft Network](https://www.microsoft.com/en-us/download/details.aspx?id=53885) zum Überprüfen der Konnektivität für Cloud-Voice-Funktionen verwenden.
...
Die Netzwerk-Bewertung kann mithilfe von Microsoft-Partner, Tools von Drittanbietern oder das [Tool zur Bewertung Microsoft-Netzwerk](https://www.microsoft.com/en-us/download/details.aspx?id=53885)ausgeführt werden. Wir auch bieten weitere Anweisungen zum Ausführen der Bewertung, verwenden das Microsoft-Netzwerk-Assessment-Tool als Teil des Bereitschaft der Anleitung [hier](https://myadvisor.fasttrack.microsoft.com/CloudVoice/Downloads?SelectedIDs=4_3_0_2,4_3_0_3,4_3_0_5,4_3_0_6,4_3_0_7,4_3_0_8,4_3_0_10,4_3_0_11)...

## <a name="plan-for-endpoint-quality"></a>Plan für die Qualität der Endpunkt

Wie Sie aus der folgenden Abbildung sehen können, sind Endpunkte als wichtiger Baustein in einer Quality of Experience für Endbenutzer bereitstellen.

![Diagramm zur Beschreibung der 3 Komponenten der Qualität und wie Service-Management alle 3 Komponenten überlappt. Mit Schwerpunkt auf Endpunkte.](media/envision-planning-for-service-management-and-quality-complete-guide-image5.png)
...
Microsoft-Teams, hat Clients verfügbaren Web, desktop (Windows und Mac) und Mobil (Android-, IOS- und Windows Mobile). Informationen zu den softwareanforderungen für jede Plattform finden Sie unter [Get-Clients für Microsoft-Teams](https://docs.microsoft.com/microsoftteams/get-clients).
...
|-----------------------------|----------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Planen der Service-management | Eine betriebsbereite Rolle Zuordnung Übung durchführen <br/> Genehmigung von verantwortlich teams <br/> Rolle Bereitschaft | [Betriebshandbuch](https://docs.microsoft.com/MicrosoftTeams/1-drive-value-operate-my-service) |
...
| | Installieren von Vorlagen Qualität Erfahrung überprüfen <br/> Hochladen einer Datei zum Erstellen von | [QERLite Vorlagen](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/quality-of-experience-review-lite-templates-v-1-2.zip?raw=true) <br/> [Informationen zum Erstellen von hochladen](https://docs.microsoft.com/en-us/SkypeForBusiness/using-call-quality-in-your-organization/turning-on-and-using-call-quality-dashboard?ui=en-US&rs=en-US&ad=US#upload-building-information)|
...
| | Implementieren von QoS | [Quality of Service in Microsoft-Teams](https://docs.microsoft.com/MicrosoftTeams/qos-in-teams) |
...
| | Optimieren der Leistung von Wi-Fi-Netzwerken für Real-Time media  | Wenden Sie sich an 3. Teilnehmern Lieferanten |
...
| | | [Tool zur Bewertung der Netzwerk](https://www.microsoft.com/en-us/download/details.aspx?id=53885) |
...
| | Überprüfen Sie die erforderliche software | [Abrufen von Clients für Microsoft-Teams](https://docs.microsoft.com/microsoftteams/get-clients) |
| | Implementieren der Endpunkt Wi-Fi-Empfehlungen | Wenden Sie sich an 3. Teilnehmern Lieferanten |
