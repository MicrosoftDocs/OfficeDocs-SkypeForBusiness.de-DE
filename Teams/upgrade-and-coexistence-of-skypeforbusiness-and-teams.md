...
Wenn einige Ihrer Benutzer bereit sind, muss nur Teams für ihre über die alltägliche Kommunikation und Zusammenarbeit verwenden, können Sie beginnen, aktualisieren diese Benutzer auf Teams werden, da für diese **Teams** nur Kopfzeilen herunterladen.

Wenn es nicht möglich, für die gesamte Organisation verschieben, Teams ist, können Sie von Teams zusammen mit Skype für Unternehmen im **Inseln** Koexistenzmodus Pilotphase starten. Sobald die zusätzliche Koexistenz-Modi (d. h. **Skype für Unternehmen mit Teams für die Zusammenarbeit** und **Skype für Unternehmen mit Teams für die Zusammenarbeit und Besprechungen**), werden in den nächsten Monaten stetig vollständig verfügbar sind, können Sie auch vollständig starten entscheiden Teams als Lösung für die Zusammenarbeit Gruppe zuerst Beibehaltung Skype für Unternehmen als unified Communications-Lösung für Ihre Organisation. Das ist von Microsoft empfohlenen Pfad für Kunden Skype für Business Server (lokale oder Hybrid) und Kunden mit erhebliche Komplexität, deren Leitkurve Teams einen Zeitraum lang Koexistenz enthalten sein sollen.
...
Teams in der Organisation im Modus für die Auswertung **Inseln** bereitgestellt wird und anschließend in verschiedenen Koexistenz verschieben und Modi für verschiedene Benutzergruppen zu aktualisieren. Beispielsweise kann eine Gruppe von Benutzern für **Inseln** -Modus aktiviert werden, eine andere für **Skype für Unternehmen mit Teams für die Zusammenarbeit und Besprechungen** -Modus aktiviert, während eine dritte Gruppe von Benutzern für **Skype für Unternehmen mit Teams zunächst aktiviert werden kann nur für die Zusammenarbeit** Modus.
