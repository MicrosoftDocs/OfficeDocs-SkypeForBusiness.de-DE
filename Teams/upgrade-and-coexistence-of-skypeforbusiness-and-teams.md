...
Wenn einige Ihrer Benutzer bereit sind benötigt, um nur Teams für ihre über die alltägliche Kommunikation und Zusammenarbeit verwenden, können Sie beginnen, aktualisieren diese Benutzer auf Teams **Teams nur** im Modus für diese aktivieren.

Wenn es nicht möglich, für die gesamte Organisation verschieben, Teams ist, können Sie von Teams zusammen mit Skype für Unternehmen im **Inseln** Koexistenzmodus Pilotphase starten. Wenn die Modi zusätzliche Koexistenz wie **Skype für Unternehmen mit Teams für die Zusammenarbeit** und **Skype für Unternehmen mit Teams für die Zusammenarbeit und Besprechungen**, verfügbar sind, können Sie auch beginnen mit der Einführung vollständig Teams als eine für die Gruppenzusammenarbeit Lösung zuerst Beibehaltung Skype für Unternehmen wie Ihre Organisation Communications-Lösung Unified. Eine weitere Option werden gestartet soll Besprechungen Teams zusätzlich zur Einführung in Teams Gruppe Zusammenarbeitsfunktionen, wobei den Rest der unified Communications-Funktionen in Skype für Business verschieben.
...
> [!NOTE]
> **Nur Teams** Modus erfordert, dass die Benutzer, die Teil der Kohorten sind in Skype für Business Online verwaltet werden, und eine hybride Beziehung zwischen Ihrer Skype für die lokale Bereitstellung Business und Ihre Skype für Business Online Mandanten ist erforderlich, um zu vereinfachen die Interoperabilität zwischen Skype für Unternehmen und Teams. Für Benutzer, die Teil der Kohorten sind, bevor sie in den Modus **nur Teams** aktualisiert haben, muss der Wechsel zu Skype für Business Online abgeschlossen werden. Planen der Skype für Business Server 2019 sowie einem zukünftigen kumulativen Update für Skype für Business Server 2015 vereinfachen die Abläufe bei der Aktualisierung von lokalen Benutzern auf Teams durch die Migration zu Skype für Business Online verwalten und Aktualisieren der Benutzer auf **-Teams nur** Modus in einem Schritt.
...
Teams für alle Benutzer in der Organisation bereitgestellt und im **Inseln** -Modus konfiguriert ist. Wenn Ihre Organisation bestimmt, dass Teams bereit ist benötigt, um alle Ihre Kommunikation und Zusammenarbeit zu erfüllen, alle Benutzer in den Modus **nur Teams** aktualisiert werden. An dieser Stelle kann Skype für Unternehmen aus der Umgebung zurückgezogen werden.
...
Teams in der Organisation im Modus für Evaluierung **Inseln** bereitgestellt wird und anschließend in verschiedenen Koexistenz verschieben und Modi für verschiedene Benutzergruppen zu aktualisieren. Beispielsweise kann eine Gruppe von Benutzern für **Inseln** -Modus aktiviert werden, eine andere für **Skype für Unternehmen mit Teams für die Zusammenarbeit und Besprechungen** -Modus aktiviert, während eine dritte Gruppe von Benutzern für **Skype für Unternehmen mit Teams zunächst aktiviert werden kann nur für die Zusammenarbeit** Modus.
...
<table>
<tr><td>![](media/audio_conferencing_image7.png) <br/>Entscheidungspunkt</td><td><ul> Welche Upgrade Weg ist geeignet ist, geschäftlichen Anforderungen Ihrer Organisation?<br><br></ul></td></tr>
<tr><td>![](media/audio_conferencing_image9.png)<br/>Als Nächstes</td><td><ul> Identifizieren Ihrer aktuellen Bereitstellungsmodell, verwenden Sie Groß-/Kleinschreibung Szenarien und wichtige Überlegungen für Ihre Organisation informieren der Reise Teams, die für Ihre Organisation am besten geeignet ist.<br><br></ul></td></tr>
</table>
