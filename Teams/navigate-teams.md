...
audience: admin
ms.reviewer: ''
description: In diesem Artikel wird beschrieben, wie Sie in Teams navigieren.
f1.keywords: ''
...
Sie können die Sicherheit und Compliance Ihrer Organisation in Microsoft 365 mit dem Microsoft 365 [Compliance Center](/microsoft-365/compliance/microsoft-365-compliance-center) und [Security Center überwachen.](/microsoft-365/security/defender/overview-security-center)

Schützen Sie Ihr Unternehmen, und befähigen Sie Ihre Benutzer im [Azure Active Directory Admin Center,](https://aad.portal.azure.com/#@microsoft.onmicrosoft.com/dashboard/private/c7736064-7b28-4f3d-b366-2740a8d48020) wo Sie Gruppen, Identitäten, Lizenzen und Zugriff über Microsoft 365 überprüfen können.

### <a name="end-users"></a>Endbenutzer

Benutzer können Teams über die Desktop- oder mobile App erstellen. Wenn Sie Benutzer als Massen-E-Mai zu einem Team hinzufügen, sollten Sie ein Team über Office 365-Gruppen, Office 365-Verteilerlisten oder Sicherheitsgruppen erstellen.
...
Um Nutzungs-, Aktivitäts- und Gesamtberichte zur Einführung anzuzeigen, können Teambesitzer auf Berichte für ihre Teams zugreifen, indem sie über das Menü (...) navigieren, um Team-> verwalten.

## <a name="kaizala-group-dissolution"></a>Kaizala- Gruppen-Veran nung

Während Sie zu Teams-Kanälen und -Chats überwechseln, sollten Sie die Kaizala-Gruppe als Empfangen betrachten, um sicherzustellen, dass Ihre Organisation über einen zentralen Ort für die Kommunikation verfügt.  Beim Löschen einer Kaizala-Gruppe wird die Gruppe aus der Liste Chats entfernt. Wenn Sie der einzige Administrator in der Gruppe sind, müssen Sie die Administratorrolle mindestens einer Person in der Gruppe zuweisen, bevor Sie das Konto löschen.
...
## <a name="kaizala-tenant-data-export"></a>Kaizala Tenant Data export
...
Die Zusammenarbeit mit Lieferanten, Lieferanten, Partnern und anderen externen Benutzern ist in Microsoft Teams einfacher denn je. Beginnen Sie mit der externen Kommunikation mit Microsoft Teams über externen Zugriff und Gastzugriff. Bestimmen Sie, welche Art von Zugriff den Anforderungen Ihrer Organisation an die Zusammenarbeit mit externen Benutzern entspricht.
...
Jeder, der nicht zu Ihrer Organisation gehört, kann [in Teams als Gast hinzugefügt werden.](/MicrosoftTeams/guest-access#how-a-guest-becomes-a-member-of-a-team) Dies bedeutet, dass jeder Benutzer mit einem Geschäftskonto (d. h. einem Azure Active Directory-Konto) oder einem Consumer-E-Mail-Konto (z. B. outlook.com, gmail.com) als Gast in Teams mit Zugriff auf Teams und Kanalerfahrungen teilnehmen kann.

>[!NOTE]
> Bevor Gäste einem Team beitreten können, muss der Gastzugriff von einem Administrator in Teams aktiviert werden.
