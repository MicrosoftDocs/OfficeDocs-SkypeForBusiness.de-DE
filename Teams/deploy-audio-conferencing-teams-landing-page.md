...
|Frage|Aktion |
|------------|-------|
|Muss ich neue Konferenzbrückennummern hinzufügen?| Informationen zum Hinzufügen neuer Nummern finden Sie unter [Abrufen von Service-Telefonnummern](https://docs.microsoft.com/SkypeForBusiness/what-is-phone-system-in-office-365/getting-service-phone-numbers?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json).|
...
|Frage|Aktion |
|------------|-------|
| Soll ich den Typ der erlaubten ausgehenden Anrufe einschränken? | Informationen zum Einschränken ausgehender Anrufe finden Sie unter [Einschränkungsrichtlinien für ausgehende Anrufe für Audiokonferenzen und PSTN-Anrufe](https://docs.microsoft.com/SkypeForBusiness/audio-conferencing-in-office-365/outbound-calling-restriction-policies?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json).|
|||
