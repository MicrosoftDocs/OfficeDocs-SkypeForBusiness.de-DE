...
|---------|---------|
|**Grundlegendes zur Teams**<br>[Laden Sie die ZIP-Datei](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/getting-started.zip?raw=true)<br> ![Screenshot des der hier finden Sie die Grundlagen Teams e-Mail-Vorlage.](media/outlook-template-teams-basics.png)   |**Anpassen der Learning-Umgebung**<br>[Laden Sie die ZIP-Datei](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/customize-learning.zip?raw=true)<br>![Screenshot des Anpassen Ihrer Umgebung Learning e-Mail-Vorlage.](media/outlook-template-teams-learn.png)       |
|**Informationen Sie zum Optimieren des Workflows in Teams**<br>[Laden Sie die ZIP-Datei](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/workflows.zip?raw=true)<br>![Screenshot des Siehe Gewusst wie: Optimieren des Workflows in teams e-Mail-Vorlage.](media/outlook-template-teams-workflow.png)     |**Hier erfahren Sie, wie Sie professionelle chat**<br>[Laden Sie die ZIP-Datei](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/chat.zip?raw=true)<br>![Screenshot des der hier finden Sie Informationen wie chat wie eine pro e-Mail-Vorlage.](media/outlook-template-teams-chat.png)        |
|**Teams unterwegs übernehmen**<br>[Laden Sie die ZIP-Datei](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/edu-resources/get-teams.zip?raw=true)<br>![Screenshot der Teams übernehmen auf der wechseln Sie e-Mail-Vorlage.](media/outlook-template-teams-connect.png)    |          |

|Anpassbare und kann jetzt zu druckenden Handzettel und Poster  |        |
|---------|---------|
