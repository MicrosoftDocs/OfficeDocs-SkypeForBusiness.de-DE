...
> [!NOTE]
> Microsoft Teams steht auch für gemeinnützige Organisationen zur Verfügung. Microsoft Teams wird mit dem Rollout der US Government Cloud Community (GCC) am 17. Juli beginnen und steht bis Ende August 2018 allen berechtigten Kunden zur Verfügung. Wir arbeiten daran, Microsoft Teams in Kürze auch anderen US-Regierungsbehörden (GCC High und DoD) zur Verfügung zu stellen. Mehr erfahren Sie [hier](https://techcommunity.microsoft.com/t5/Microsoft-Teams-Blog/Microsoft-Teams-will-be-available-July-17-for-the-US-Government/ba-p/209976)im Microsoft Teams-Blog.
...
**Cloud-Sprachfunktionen**: Für Audiokonferenzen muss Ihre Organisation eine Audiokonferenz-Lizenz erwerben und jedem Benutzer, der Einwahl-Besprechungen einrichten wird, eine zuweisen. Für Anrufpläne benötigt jeder Benutzer eine Telefonanlage sowie einen nationalen oder nationalen und internationalen Anrufplan. Weitere Informationen finden Sie unter [Lizenzierung für Microsoft Teams-Add-On](teams-add-on-licensing/microsoft-teams-add-on-licensing.md).
