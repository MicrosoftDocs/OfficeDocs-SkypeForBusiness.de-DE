...
- **Öffnen Sie Ihre Firewall, um Microsoft 365 und Teams.** Öffnen Sie die Firewall Ihres Netzwerks, um Microsoft 365 und Teams zu vernetzen, wie in den Office 365 [URLs und IP-Adressbereichen beschrieben](/microsoft-365/enterprise/urls-and-ip-address-ranges).
...
Der bedingte Zugriff ist ein Azure Active Directory (Azure AD), mit dem sichergestellt wird, dass Geräte, die auf Ihre Microsoft 365-Ressourcen zugreifen, ordnungsgemäß verwaltet und sicher sind. SIP Gateway authentifiziert SIP-Geräte bei Azure AD. Wenn Ihre Organisation daher bedingten Zugriff für Geräte im Unternehmensnetzwerk verwendet, sollten die folgenden IP-Adressen ausgeschlossen werden:
...
2. Wählen Teams **GeräteSIP-Geräte** >  aus.
...
3. Wählen Sie oben rechts **ActionsProvision-Geräte**  >  aus, und führen Sie einen der folgenden Schritte aus:
  ...
  - **So bereitstellungen Sie ein Gerät:**
     ...
     c. Wählen **Sie unter Beim Aktivieren warten** das Gerät aus, das Sie gerade hinzugefügt haben, und wählen Sie dann **Überprüfungscode generieren aus**.
   ...
   - **So können Sie viele Geräte bereitstellen:**
     ...
     a. Wählen **Sie rechts unter** Warten auf die Aktivierung die Option **Exportieren** (das Symbol Microsoft Excel aus.
     
     b. Wählen Sie **im Bereich Geräte** bereitstellen **unter mehrere Hochladen MAC-Adressen** die Option **Vorlage herunterladen aus**.
     ...
     e. Wählen Sie rechts im Bereich **Hochladen Mac-Adressen** die Option Datei auswählen und dann dieTemplate_Provisioning.csv **aus, die** Ihre **** Daten enthält.
...
7. Wechseln Sie zu [https://microsoft.com/devicelogin](https://microsoft.com/devicelogin), geben Sie **unter Code eingeben** den Kopplungscode des SIP-Geräts ein, und wählen Sie dann Weiter **aus**.
...
9. Geben Sie **auf der Seite Kennwort** das Kennwort für die E-Mail-Adresse des SIP-Geräts ein, und wählen Sie **Anmelden aus**.

10. Wählen Sie **auf der Seite Versuchen Sie, sich bei einem SIP Teams Gerät-Gateway** anmelden die Option **Weiter aus**.
...
4. Wählen Sie im Bereich Details des **Geräts** die Registerkarte **Details** und dann oben rechts im Menü Aktionen die Option **Abmelden aus**. 
...
2. Wählen Teams **GeräteSIP-Geräte** >  aus. Auf der rechten Seite sind alle angemeldeten SIP-Geräte aufgeführt.
