...
> [!Important]
> Cloud Connector Edition wird am 31. Juli 2021 sowie Skype for Business Online abziehen. Nachdem Ihr Unternehmen ein Upgrade auf Teams hat, erfahren Sie hier, wie Sie Ihr lokales Telefonienetzwerk mit Teams [Mit Direct Routing verbinden.](direct-routing-landing-page.md) 
...
Ein Teams Benutzer kann eine 1:1-Telefonkonferenz Teams PSTN starten oder Teams, Teams und einen PSTN-Teilnehmer hinzufügen kann. Dieses Szenario wird als Ad-hoc-Konferenz bezeichnet. Der Weg, den der Anruf einnimmt, hängt davon ab, ob dem Benutzer, der den Anruf eskaliert, eine Microsoft Audio Conferencing-Lizenz zugewiesen wurde:
...
Weitere Informationen zur Lizenzierung Telefonsystem Sie unter Holen Sie sich das Beste [aus](https://products.office.com/compare-all-microsoft-office-products?tab=2) Ihrer Office und [Planoptionen](/office365/servicedescriptions/office-365-platform-service-description/office-365-plan-options). 
