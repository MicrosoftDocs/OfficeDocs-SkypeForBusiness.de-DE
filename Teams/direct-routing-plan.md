...
Ein Teams Benutzer kann einen 1:1-Anruf Teams PSTN starten oder Teams, Teams anruf zu starten und einen PSTN-Teilnehmer hinzuzufügen. Dieses Szenario wird als Ad-hoc-Konferenz bezeichnet. Der Weg, den der Anruf einnimmt, hängt davon ab, ob dem Benutzer, der den Anruf eskaliert, eine Microsoft Audio Conferencing-Lizenz zugewiesen wurde:
...
Es ist möglich, dass ein Unternehmen mehrere SIP-Adressbereiche in einem Mandanten hat. Beispielsweise kann ein Unternehmen einen contoso.com als SIP-Adressraum und fabrikam.com als zweiten SIP-Adressraum verwenden. Einige Benutzer verfügen über Adressadressen user@contoso.com einige Benutzer über Adressadressen user@fabrikam.com. 
...
Alternativ unterstützt Direct-Routing einen Platzhalter im CN und/oder SAN, und der Platzhalter muss RFC [HTTP Over TLS](https://tools.ietf.org/html/rfc2818#section-3.1)-Standard entsprechen. Ein Beispiel wäre die Verwendung von contoso.com, die der SBC-FQDN-sbc.contoso.com, aber nicht mit der \* sbc.test.contoso.com.
...
- **sip2.pstnhub.microsoft.com** – Sekundärer FQDN – ist der region mit der zweiten Priorität geografisch karten.
...
**sip.pstnhub.dod.teams.microsoft.us** – Globaler FQDN. Da die Office 365 DoD-Umgebung nur in den US-Rechenzentren vorhanden ist, gibt es keine sekundären und drittrangig vorhandenen FQDNs.
