...
In einigen Ländern und Regionen ist es ungesetzlich, den Anbieter des öffentlichen Telefonnetz (PUBLIC Switched Telephone Network, PSTN) zu umgehen, um die Kosten für Anrufe im Ferngespräch zu senken. In diesem Artikel wird beschrieben, wie Sie Location-Based Routing verwenden, um die gebührenpflichtige Umgehung für Microsoft Teams basierend auf ihrem geografischen Standort einzuschränken. Dieser Artikel bezieht sich nur auf Direct-Routing.

Hier erhalten Sie einen Überblick über Location-Based Routing und Anleitungen, die Sie bei der Planung unterstützen. Wenn Sie bereit sind, ihr Routing anzuwenden und zu aktivierenLocation-Based lesen Sie:
...
- Um einen ausgehenden PSTN-Anruf zu erstellen, muss eine der folgenden Bedingungen zutreffen:
    ...
    - Der Endpunkt des Benutzers befindet sich auf einer Netzwerkwebsite, die für das Routing aktiviert istLocation-Based Das Routing und die Anrufe werden über das entsprechende Gateway geleitet, das für das Routing aktiviert Location-Based ist. 

    - Der Endpunkt des Benutzers befindet sich auf einer Netzwerkwebsite, die für das Routing und Anrufe über ein Gateway, das nicht für das Routing aktiviert ist, Location-Based das Routing und Anrufe über ein Gateway aktiviert ist, das nicht für das Routing Location-Based ist.
...
Gateways sind Websites zugeordnet, um zu bestimmen, wo sich ein benutzer, der für die Location-Based-Routing befindet, wenn er einen PSTN-Anruf anruft oder erhält. Gateways müssen für Location-Based-Routing aktiviert sein, um sicherzustellen, dass es unter Einschränkungen der gebührenfreien Umgehung steht und nicht von Benutzern verwendet werden kann, die nicht für das Routing Location-Based können. Dasselbe Gateway kann mehreren Websites zugeordnet sein, und es kann so konfiguriert werden, dass es je nach Website für Location-Based-Routing aktiviert oder nicht für Location-Based-Routing aktiviert ist.
...
Das folgende Diagramm zeigt die Durch das Routing Location-Based Szenarios aktivierten Einschränkungen. Benutzer, Netzwerkwebsites und Gateways, die für Location-Based Routing aktiviert sind, sind von einem Rahmen umrandt. Verwenden Sie das Diagramm als Leitfaden, um zu verstehen, wie Location-Based Routing in den einzelnen Szenarien funktioniert.  
...
|---------|---------|
|Dieselbe Website, der die DID-Adresse des Benutzers zugewiesen ist, website enabled for Location-Based Routing (Site1)      |Anruf, der basierend auf der Sprachroutingrichtlinie des Benutzers über das Gateway für Location-Based-Routing (GW1) an Standort1 aktiviert ist         |
...
|Eine andere Website als die, der die DID-Adresse des Benutzers zugewiesen ist, die Website ist nicht für Location-Based (Site3) aktiviert  |Anruf, der über ein Gateway geroutet wird, das für Location-Based-Routing an einem Standort nicht aktiviert ist, der nicht für Location-Based-Routing (GW3) aktiviert ist, basierend auf der Sprachroutingrichtlinie des Benutzers       |
...
- Durch Durch übertragen und Weiterleiten eines PSTN-Anrufs an eine andere PSTN-Nummer muss dasselbe Location-Based Routingfähiges Gateway, bei dem der eingehende Anruf eintroffen ist, weitergeleitet werden.
...
|Verschiedene Netzwerkwebsite, Standort aktiviert für Location-Based Routing (Benutzer3)    |Die Anrufübertragung kann basierend auf der Voice routing policy von User3 nur über Location-Based Routing aktiviertes Gateway1 an Standort1 geroutet werden.         |Die Anruf weiterleiten kann nur über Location-Based Routing aktiviertes Gateway1 an Standort1, basierend auf der Voice Routing-Richtlinie von Benutzer3         |
...
|Unbekanntes externes Netzwerk (Benutzer6)   |Die Anrufübertragung kann basierend auf der Voice Routing-Richtlinie von Benutzer6 nur über Location-Based Routing aktiviertes Gateway1 an Standort1 geroutet werden.        |Die Weiterleitung kann basierend auf der Voice Routing-Richtlinie von Benutzer6 nur über Location-Based Routing aktiviertes Gateway1 an Standort1 weitergeleitet werden.         |
...
|Unbekanntes externes Netzwerk (Benutzer6)   |Anruf kann nur über das Routinggateway1 Location-Based Standort1 routing, basierend auf der Voice Routing-Richtlinie von Benutzer6         |
