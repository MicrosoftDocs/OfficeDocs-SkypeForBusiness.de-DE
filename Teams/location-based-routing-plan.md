...
Hier erhalten Sie einen Überblick über Location-Based Routing und Anleitungen, die Sie bei der Planung des Routings unterstützen. Wenn Sie bereit sind, Ihr Routing anzuwenden und zu aktivierenLocation-Based lesen Sie:
...
- Um einen ausgehenden PSTN-Anruf zu erstellen, muss eine der folgenden Bedingungen zutreffen:
    ...
    - Der Endpunkt des Benutzers befindet sich auf einer Netzwerkwebsite, die für das Routing und Anrufe Location-Based das Routing und Anrufe über ein Gateway geleitet werden, das nicht für das Routing aktiviert Location-Based ist.
...
Sie müssen das Routing Location-Based Benutzer, Netzwerkwebsites und PSTN-Gateways anwenden.  

### <a name="apply-location-based-routing-at-the-user-location"></a>Anwenden Location-Based Routings an den Benutzerstandort

Wie bereits erwähnt, Location-Based Routing nur für Benutzer gilt, die für Direct-Routing eingerichtet sind. Location-Based Routing gilt nicht für Benutzer, die für den Anrufplan eingerichtet sind. Benutzer müssen für Location-Based-Routing aktiviert sein, wenn sie die Einschränkung zur Umgehung der gebührenpflichtigen Umgehung erfüllen. Dies steuert die Bedingungen, unter denen sie PSTN-Anrufe und das PSTN-Gateway, das verwendet werden kann, anrufen und empfangen kann. Wenn sich ein Benutzer, der für Location-Based-Routing aktiviert ist, auf einer Website befindet, die für Location-Based-Routing aktiviert ist, muss der Benutzer Anrufe über ein mit der Website verbundenes Location-Based Routing-aktiviertes Gateway in Verbindung mit der Website erstellen. 

Location-Based Das Routing ermittelt anhand der IP-Adresse des Endpunkts des Benutzers vom Teams den aktuellen Standort des Benutzers und wendet die Regeln entsprechend an. Die Position eines Benutzers, der für das Routing aktiviert Location-Based, kann wie folgt kategorisiert werden: 
- **Der Benutzer befindet sich an derselben Location-Based Routing aktivierten Website, die dem PSTN-Gateway zugeordnet ist, dem die DID-Adresse zugewiesen ist.**<br>In diesem Szenario befindet sich der Benutzer auf einer bekannten Netzwerkwebsite, die für Location-Based-Routing aktiviert ist, und die Did-Nummer des Benutzers mit Direktwahl (Direct Inward Dial, DID) wird auf einem PSTN-Gateway beendet, das sich an demselben Netzwerkstandort befindet. Beispielsweise befindet sich der Benutzer im Büro des Benutzers. 
...
Das folgende Diagramm zeigt die Einschränkungen, die das Routing in Location-Based Szenario ermöglicht. Benutzer, Netzwerkwebsites und Gateways, die für das Routing Location-Based, sind von einem Rahmen umrandt. Verwenden Sie das Diagramm als Leitfaden, um zu verstehen, wie Location-Based Routing in den einzelnen Szenarien funktioniert.  
...
Ein Benutzer, der für Location-Based-Routing nicht aktiviert ist, kann ausgehende Anrufe über ein beliebiges Gateway an einem beliebigen Ort, der nicht für Location-Based-Routing über die zugewiesene Voice routing-Richtlinie aktiviert ist, erstellen. Wenn ein Gateway jedoch für das Routing Location-Based aktiviert ist, kann der Benutzer über das Gateway keine ausgehenden Anrufe mehr erstellen, auch nicht, wenn es seiner Voiceroutingrichtlinie zugewiesen ist. Wenn der Benutzer das Roaming zu einer Website verwendet, die für das Location-Based-Routing aktiviert ist, kann er Anrufe nur über ihre normalen Routinggateways, die nicht für das Routing aktiviert Location-Based sind, in Location-Based verwenden.
...
|---------|---------|
|Dieselbe Website, der die DID-Adresse des Benutzers zugewiesen ist, die Website ist für Location-Based (Site1) aktiviert      |Anruf, der über ein Gateway umgeschaltet wurde, das für Location-Based-Routing (GW1) an Standort1 aktiviert ist, basierend auf der Sprachroutingrichtlinie des Benutzers         |
...
Ein Benutzer, der nicht für Location-Based-Routing aktiviert ist, kann einen eingehenden Anruf vom Gateway empfangen, der nicht für Location-Based Routing aktiviert ist, von dem aus die zugewiesenen DID-Nummernresse empfangen werden. Wenn der Benutzer ein Server-Roaming zu einer Website verwendet, die nicht für Location-Based-Routing aktiviert ist, kann er weiterhin Anrufe über seine normalen PSTN-Gateways empfangen.
...
Ein Benutzer, der nicht für die Location-Based-Routing aktiviert ist, kann PSTN-Anrufe an andere Benutzer weiterleiten, die nicht für das Routing Location-Based sind. Benutzer dürfen einen PSTN-Anruf normalerweise nicht an einen Benutzer weiterleiten, der für Location-Based-Routing aktiviert ist, da Location-Based-Routing aktivierte Benutzer in der Regel nur an Location-Based-fähigen Gateways für PSTN-Anrufe gleichzeitig standortfähig sein dürfen. Eine Ausnahme ist, wenn Location-Based Routing aktivierter Benutzer zu einer Website weiterleitt, die nicht für das Routing Location-Based ist. In diesem Szenario ist der übertragene Anruf zulässig.  
...
Im Allgemeinen sind eingehende PSTN-Anrufe von einem Gateway, das für Location-Based-Routing aktiviert ist, nur zulässig, wenn der Zielbenutzer für das Location-Based-Routing aktiviert ist und sich an derselben Website befindet. Andernfalls sind Durch- und Weiterleitung von Anrufen nicht zulässig. 
...
- Bei der Übertragung und Weiterleitung eines eingehenden VOIP-Anrufs an das PSTN müssen die gebührenpflichtigen Umgehungseinschränkungen des Anrufers berücksichtigt werden. 
    - Wenn der Anrufer nicht für das Location-Based-Routing aktiviert ist, können sie an ein beliebiges PSTN-Gateway übertragen werden, das nicht für das Routing Location-Based ist.
...
- Durch Durch übertragen und Weiterleiten eines PSTN-Anrufs an eine andere PSTN-Nummer muss das gleiche Location-Based Routingfähiges Gateway, bei dem der eingehende Anruf eintroffen ist, weitergeleitet werden. 
...
|---------|---------|---------|
|Gleiche Netzwerkwebsite, Website für Location-Based Routing aktiviert (Benutzer2)   |Die Anrufübertragung kann nur über das routingfähige Location-Based Gateway1 an Standort1, basierend auf der Voice Routingrichtlinie von Benutzer2, geroutet werden.         |Die Anruf weiterleitung kann basierend auf der Voice Routing-Richtlinie von Benutzer2 nur über Location-Based Routing aktiviertes Gateway1 an Standort1 weitergeleitet werden.         |
...
|Unbekanntes externes Netzwerk (Benutzer6)   |Die Anrufübertragung kann nur über das routingfähige Location-Based Gateway1 an Standort1 basierend auf der Voice routing-Richtlinie von Benutzer6        |Die Anruf weiterleiten kann nur über Location-Based Routing aktiviertes Gateway1 an Standort1, basierend auf der Voice Routing-Richtlinie von Benutzer6         |
...
Die folgende Tabelle zeigt, Location-Based Routing das gleichzeitige Anrufen bei verschiedenen Benutzern für einen eingehenden PSTN-Anruf für Benutzer1 zulässt.
...
|Zielbenutzer ist eine PSTN-Nummer.    |Der Anruf kann nur basierend auf der Voice Routingrichtlinie von Benutzer1 Location-Based Routing aktiviertes Gateway1 an Standort1 geroutet werden.      |
...
|Verschiedene Netzwerkwebsites, die für Location-Based Routing aktiviert sind (Benutzer3)    |Der Anruf kann basierend auf der Voice Routing-Richtlinie von Benutzer3 nur über Location-Based Routinggateway1 an Standort1 geroutet werden.        |
|Unterschiedliche Netzwerkwebsite, die nicht für die Location-Based aktiviert ist (Benutzer4)    |Anruf kann basierend auf der Voice Routing-Richtlinie von Benutzer4 nur über Location-Based Routinggateway1 an Ort1 geroutet werden         |
|Unbekanntes internes Netzwerk (Benutzer5)    |Der Anruf kann nur basierend auf der Voice Routing-Richtlinie von Benutzer5 über Location-Based Routinggateway1 an Standort1 geroutet werden.         |
|Unbekanntes externes Netzwerk (Benutzer6)   |Anrufe können nur über das Routinggateway1 Location-Based Standort1, basierend auf der Voice Routing-Richtlinie von Benutzer6, geroutet werden.         |
