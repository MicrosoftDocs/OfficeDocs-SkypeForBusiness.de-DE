...
Hier erhalten Sie einen Überblick über das Routing Location-Based und Anleitungen, die Sie bei der Planung des Routings unterstützen. Wenn Sie bereit sind, Ihr Routing anzuwenden und zu aktivieren, Location-Based Sie:
...
|---------|---------|
|Dieselbe Website, der die DID-Adresse des Benutzers zugewiesen ist, website enabled for Location-Based Routing (Site1)      |Anruf, der über das Gateway umgeschaltet wurde, das für Location-Based-Routing (GW1) an Standort1 aktiviert ist, basierend auf der Sprachroutingrichtlinie des Benutzers         |
...
Ein Benutzer, der nicht für die Location-Based-Routing aktiviert ist, kann PSTN-Anrufe an andere Benutzer weiterleiten, die nicht für Location-Based sind. Benutzer dürfen normalerweise keinen PSTN-Anruf an einen Benutzer weiterleiten, der für Location-Based-Routing aktiviert ist, da benutzer mit aktivierter Location-Based-Routing-Funktion im Allgemeinen nur an Location-Based-fähigen Gateways für PSTN-Anrufe gleichzeitig standortfähig sein dürfen. Die Ausnahme ist, wenn Location-Based Routing aktivierter Benutzer zu einer Website weiterleitt, die nicht für das Routing Location-Based ist. In diesem Szenario ist der übertragene Anruf zulässig.  
...
|Verschiedene Netzwerkwebsite, Website nicht für Routing aktiviertLocation-Based (Benutzer4)|Nicht zulässig|Nicht zulässig|
...
### <a name="teams-user-transfers-or-forwards-call-to-pstn-endpoint"></a>Teams Der Anruf wird an den PSTN-Endpunkt weitergeleitet oder durch Benutzerübertragungen weitergeleitet.
...
- Durch Durch übertragen und Weiterleiten eines PSTN-Anrufs an eine andere PSTN-Nummer muss dasselbe Location-Based-fähiges Gateway weitergeleitet werden, bei dem der eingehende Anruf eintroffen ist. 
...
|---------|---------|---------|
|Dieselbe Netzwerkwebsite, Website für Location-Based Routing aktiviert (Benutzer2)   |Die Anrufübertragung kann basierend auf der Voice-Routingrichtlinie von Benutzer2 nur über Location-Based Routing aktiviertes Gateway1 an Standort1 geroutet werden.         |Die Anruf weiterleiten kann nur über Location-Based Routing aktiviertes Gateway1 an Standort1, basierend auf der Voice Routing-Richtlinie von Benutzer2         |
|Verschiedene Netzwerkwebsite, Standort aktiviert für Location-Based Routing (Benutzer3)    |Die Anrufübertragung kann basierend auf der Voice routing policy von Benutzer3 nur über Location-Based Routing aktiviertes Gateway1 an Standort1 geroutet werden.         |Die Anruf weiterleiten kann nur über Location-Based Routing aktiviertes Gateway1 an Standort1, basierend auf der Voice Routing-Richtlinie von Benutzer3         |
|Verschiedene Netzwerkwebsite, Website nicht für Routing aktiviertLocation-Based (Benutzer4)    |Die Anrufübertragung kann basierend auf der Voice Routing-Richtlinie von Benutzer4 nur über Location-Based Routing aktiviertes Gateway1 an Standort1 geroutet werden.         |Die Anruf weiterleiten kann nur über Location-Based Routing aktiviertes Gateway1 an Standort1, basierend auf der Voice Routing-Richtlinie von Benutzer4         |
...
|Roaming-Netzwerkwebsites, die für das Routing Location-Based nicht aktiviert sind (Benutzer4)   |Nicht zulässig        |
...
|---------|---------|
|Dieselbe Netzwerkwebsite, Website für Location-Based Routing aktiviert (Benutzer2)    |Anrufe können nur über das Routinggateway1 Location-Based Standort1, basierend auf der Voiceroutingrichtlinie von Benutzer2, geroutet werden.       |
|Unterschiedliche Netzwerkwebsite, die für Location-Based Routing aktiviert ist (Benutzer3)    |Anrufe können nur über das Routinggateway1 Location-Based Standort1, basierend auf der Voiceroutingrichtlinie von Benutzer3, geroutet werden.        |
|Unterschiedliche Netzwerkwebsite, die nicht für die Location-Based aktiviert ist (Benutzer4)    |Anrufe können basierend auf der Voice Routing-Richtlinie von Benutzer4 nur über Location-Based Routinggateway1 an Ort1 geroutet werden.         |
|Unbekanntes internes Netzwerk (Benutzer5)    |Anruf kann nur über das Routinggateway1 Location-Based Standort1, basierend auf der Voice Routingrichtlinie von Benutzer5, geroutet werden         |
...
### <a name="changes-from-an-on-premises-location-based-routing-deployment"></a>Änderungen eines lokalen Bereitstellungs- Location-Based Routingbereitstellung
