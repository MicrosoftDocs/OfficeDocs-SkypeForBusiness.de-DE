...
Microsoft unterstützt alle Decoder und Encoder mit Ausnahme der in diesem Artikel aufgelisteten.

## <a name="hardware-decoder-driver-recommendations---intel"></a>Empfehlungen für Hardware-Decoder-Treiber – Intel

Die folgenden Kombinationen aus Betriebssystem, Modell und Treiber sind aufgrund verschiedener Treiber Probleme nicht für die Hardwarebeschleunigung aktiviert.
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [0.0.0.0]-[8.15.10.2753] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [9.17.10.2867] - [9.17.10.4459] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 |0x1616 | [9.18.7.9] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [10.18.10.3431] - [10.18.10.4425] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [10.18.14.4280] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle |[10.18.15.4281] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle |[20.19.15.4390] - [20.19.15.4444] |
|Windows 10 | Alle | [21.20.16.4541] |
|Windows 10 | Alle | [22.20.16.4811] |
|Windows 10 | Alle | [24.20.100.6293] |

## <a name="hardware-decoder-driver-recommendations---nvidia"></a>Empfehlungen für Hardware-Decoder-Treiber – nvidia
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [8.17.11.9745], [8.17.12.5738] |
...
## <a name="hardware-decoder-driver-recommendations---amd"></a>Empfehlungen für Hardware-Decoder-Treiber-AMD

Bei älteren Betriebssystemen sind nur die folgenden Device_ids für die Hardwarebeschleunigung aktiviert.
...
|Betriebssystem           | Modell (Device_id) | Treiber/Bereich |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [0.0.0.0] – [25.20.15017.1009] |

## <a name="hardware-encoder-driver-recommendations---intel"></a>Empfehlungen für Hardware-Encoder-Treiber – Intel
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [8.15.10.2653] - [8.15.10.2827] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [9.14.3.1176] - [9.14.3.1177] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [9.17.10.2800] - [9.17.10.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [9.18.10.3222] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [10.18.14.4153] - [10.18.14.4161] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [10.18.14.4264] |
|Windows 7 | Alle | [10.18.14.4578] |
|Windows 7 | Alle | [10.18.14.4889] |
|Windows 7 | Alle | [10.18.14.5057] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [20.19.15.4300] - [20.19.15.4444] |
|Windows 7 | Alle | [20.19.15.4474] |

## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Empfehlungen für Hardware-Encoder-Treiber – nvidia

Die folgenden Kombinationen aus Betriebssystem, Modell und Treiber sind aufgrund verschiedener Treiber Probleme nicht für die Hardwarebeschleunigung aktiviert.

|Betriebssystem           | Modell (Device_id) | Treiber/Bereich |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [0.0.0.0]-[21.21.13.7848] |

## <a name="hardware-encoder-driver-recommendations---amd"></a>Empfehlungen für Hardware-Encoder-Treiber-AMD
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [15.21.0.0] - [16.199.9999.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [15.201.1101.0] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | Alle | [21.19.137.1] |
