...
- seo-marvel-apr2020
ms.reviewer: islubin
description: Erfahren Sie, wie Sie mithilfe der Administratorrollen Administratoren bestimmen, die unterschiedliche Zugriffsebenen zum Verwalten Ihrer Teams.
appliesto:
- Microsoft Teams
...
Es sind mehrere Teams-Administratorrollen verfügbar: Teams-Administrator, Teams-Kommunikationsadministrator, Teams-Experte für Kommunikationsunterstützung, Teams-Kommunikationssupporttechniker und Teams Geräteadministrator. Sehen Sie sich die folgende Tabelle an, um zu verstehen, was jede Rolle ausführen kann und welche Tools der Administrator im Microsoft Teams Admin Center und in PowerShell verwenden kann.

> [!NOTE]
> Skype for Business Onlineadministratoren können Richtlinien für online **Teams** und **Skype for Business Online-App** über PowerShell verwalten.
...
| Teams des Geräteadministrators              | Verwalten Sie Geräte, die für die Verwendung mit dem Dienst Teams sind.                    | Verwalten Sie Gerätekonfiguration und -updates, überprüfen Sie den Gerätestatus und -status von verbundenen Peripheriegeräten, richten Sie Konfigurationsprofile ein, und wenden Sie diese an, und starten Sie Geräte neu.<p>Die Teams"Geräteadministrator" bietet keinen Zugriff auf Daten zur Anrufqualität oder Anrufanalyse. Um Daten zur Anrufqualität oder die Anrufanalyse anzeigen zu können, muss Ihnen die Rolle Teams Kommunikationsadministrator zugewiesen sein. |

<sup>1</sup> [PowerShell – Microsoft Teams](https://www.powershellgallery.com/packages/MicrosoftTeams/) Modul (Die Public Release 1.1.6 oder höher ist in Skype for Business Online Connector integriert.)<br>
<sup>2</sup> [Microsoft Teams Admin Center3](./manage-teams-skypeforbusiness-admin-center.md)
 Teams administrator account must have a valid Teams license.<sup></sup>
