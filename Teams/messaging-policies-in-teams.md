...
- **Lesebestätigungen** Lesebestätigungen ermöglichen es dem Absender einer Chatnachricht, benachrichtigt zu werden, wenn seine Nachricht vom Empfänger in 1:1 gelesen wurde, und gruppenchatt 20 Personen oder weniger. Lesebestätigungen für Nachrichten nehmen die Ungewissheit, ob eine Nachricht gelesen wurde und verbessern so die Kommunikation im Team. Lesebestätigungen werden in der eDiscovery-Berichterstellung nicht erfasst.  
    ...
    - **Für alle aktiviert**: Das bedeutet, dass das Feature für jeden im Mandanten aktiviert ist und nicht deaktiviert werden kann. Wenn Sie die Einstellung **Ein** für jeden verwenden, besteht die einzige Möglichkeit zum Festlegen von Quittungen für den gesamten Mandanten entweder in der Verwendung einer einzigen Nachrichtenrichtlinie für den gesamten Mandanten (die Standardrichtlinie mit dem Namen "Global (Organisationsweite Standard)") oder wenn alle Messagingrichtlinien im Mandanten dieselben Einstellungen für Quittungen verwenden. Das Feature „Lesebestätigungen“ ist am effektivsten, wenn das Feature **für alle aktiviert** ist.
...
- **Verwenden von Memes in Unterhaltungen** Wenn Sie Memes aktivieren, können Benutzer Memes in Chatunterhaltungen mit anderen Personen einmischen.
...
- **Chatberechtigungsrolle** Verwenden Sie diese Einstellung, um die Überwachte Chatrolle des Benutzers zu definieren.  Erfahren Sie mehr über [überwachte Chats.](supervise-chats-edu.md)
