...
* Wenn Sie weitere Informationen zu einer App benötigen, lesen Sie die Details zu einer bestimmten App unter dem entsprechenden Link unter [Sicherheit und Compliance von Microsoft Teams-Apps](/microsoft-365-app-certification/teams/teams-apps). Klicken Sie alternativ auf den Herausgebernachweis-Link im Microsoft Teams Admin Center.
