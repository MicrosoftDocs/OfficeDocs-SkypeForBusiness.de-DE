...
<li><span data-ttu-id="ebfef-160">Verfasst monatliche Geschäftsberichte als Grundlage für vierteljährliche Geschäftsberichte</span><span class="sxs-lookup"><span data-stu-id="ebfef-160">Leading Monthly Business and Operational Reviews (MBR), contributing to Quarterly Business Reviews</span></span></li></ul></td>
...
<td align="left"><span data-ttu-id="ebfef-180">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-180">TBA</span></span></td>
</tr>
<tr class="even">
...
<li><span data-ttu-id="ebfef-201">Nimmt an der Planung während des Ausblick-Workshops teil</span><span class="sxs-lookup"><span data-stu-id="ebfef-201">Participating in planning during envisioning workshop</span></span></li>
...
<li><span data-ttu-id="ebfef-221">Leitet Kundenressourcen an, sich an der Vorbereitung und Bereitstellung von Aktivitäten in den einzelnen Phasen zu beteiligen</span><span class="sxs-lookup"><span data-stu-id="ebfef-221">Engage customer resources to engage on prepare and deploy stage activities</span></span></li>
...
<span data-ttu-id="ebfef-237">_Tabelle 2: Matrixvorlage für Projektbeteiligte – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-237">_Table 2 Stakeholder matrix template example_</span></span>
...
<td align="left"><span data-ttu-id="ebfef-289">Täglich</span><span class="sxs-lookup"><span data-stu-id="ebfef-289">Daily</span></span></td>
...
<td align="left"><span data-ttu-id="ebfef-313">Basierend auf Rendite</span><span class="sxs-lookup"><span data-stu-id="ebfef-313">Based on ROI</span></span></td>
...
<td align="left"><span data-ttu-id="ebfef-387">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-387">TBA</span></span></td>
...
### <a name="service-readiness"></a><span data-ttu-id="ebfef-418">Bereitschaft für den Dienst</span><span class="sxs-lookup"><span data-stu-id="ebfef-418">Service readiness</span></span>
...
<td align="left"><p><span data-ttu-id="ebfef-439">Dokumentieren Sie die Benutzerstandorte oder Niederlassungen, die für den Audiokonferenzdienst aktiviert werden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-439">Document the user locations or offices to be enabled for the Audio Conferencing service.</span></span></p></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-440">Niederlassung</span><span class="sxs-lookup"><span data-stu-id="ebfef-440">Office</span></span></th>
<th align="left"><span data-ttu-id="ebfef-441">Standort</span><span class="sxs-lookup"><span data-stu-id="ebfef-441">Location</span></span></th>
<th align="left"><span data-ttu-id="ebfef-442">PSTN-Konferenzdienst</span><span class="sxs-lookup"><span data-stu-id="ebfef-442">PSTN Conference Service</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-443">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-443">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-444">Australien</span><span class="sxs-lookup"><span data-stu-id="ebfef-444">Australia</span></span></td>
<td align="left"><span data-ttu-id="ebfef-445">Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-445">Audio Conferencing</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-446">100 Cyberport Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-446">100 Cyberport Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-447">Hong Kong SAR (香港特別行政區)</span><span class="sxs-lookup"><span data-stu-id="ebfef-447">Hong Kong SAR</span></span></td>
<td align="left"><span data-ttu-id="ebfef-448">Legacy-PSTN-Konferenz</span><span class="sxs-lookup"><span data-stu-id="ebfef-448">Legacy PSTN Conferencing</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-449">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-449">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-450">Singapur</span><span class="sxs-lookup"><span data-stu-id="ebfef-450">Singapore</span></span></td>
<td align="left"><span data-ttu-id="ebfef-451">Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-451">Audio Conferencing</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-452">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-452">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-453">Vereinigtes Königreich</span><span class="sxs-lookup"><span data-stu-id="ebfef-453">United Kingdom</span></span></td>
<td align="left"><span data-ttu-id="ebfef-454">Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-454">Audio Conferencing</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-455">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-455">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-456">Frankreich</span><span class="sxs-lookup"><span data-stu-id="ebfef-456">France</span></span></td>
<td align="left"><span data-ttu-id="ebfef-457">Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-457">Audio Conferencing</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-458">_Tabelle 7: Aktivierungsliste für Audiokonferenzdienst-Standorte – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-458">_Table 7 Example of Audio Conferencing service site enablement list_</span></span>


## <a name="licensing-for-audio-conferencing"></a><span data-ttu-id="ebfef-459">Lizenzierung für Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-459">Licensing for Audio Conferencing</span></span>

<span data-ttu-id="ebfef-460">[Audiokonferenzlizenz](https://support.office.com/article/Skype-for-Business-add-on-licensing-3ed752b1-5983-43f9-bcfd-760619ab40a7?ui=en-US&rs=en-US&ad=US) (vormals Skype for Business PSTN-Konferenzlizenz) ist als Teil der Office 365 E5-Abonnementpläne oder als Add-On für 365 E1- oder Office 365 E3-Abonnementpläne verfügbar.</span><span class="sxs-lookup"><span data-stu-id="ebfef-460">[Audio Conferencing license](https://support.office.com/article/Skype-for-Business-add-on-licensing-3ed752b1-5983-43f9-bcfd-760619ab40a7?ui=en-US&rs=en-US&ad=US), formerly known as Skype for Business PSTN Conferencing license, is available as part of Office 365 E5 subscription plans, or as an add-on to Office 365 E1 or Office 365 E3 subscription plans.</span></span>

> [!NOTE]
> <span data-ttu-id="ebfef-p120">PSTN- oder Einwahlkonferenzen in Teams bieten keine Unterstützung für <sup>Drittanbieter</sup> von Audiokonferenzanbieter-Partnern (Audio Conferencing Provider, ACP). </span><span class="sxs-lookup"><span data-stu-id="ebfef-p120">PSTN or dial-in conferencing in Teams does not support 3<sup>rd</sup>-party Audio Conferencing Providers (ACPs). </span></span><br><span data-ttu-id="ebfef-462">Wenn Sie den PSTN-Konferenzdienst für Skype for Business bereits verwenden, können Sie unmittelbar die Vorteile des Audiokonferenzdiensts in Teams nutzen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-462">If you already use Skype for Business Online PSTN Conferencing today, you can immediately take advantage of Audio Conferencing in Teams.</span></span>

<span data-ttu-id="ebfef-463">Um gebührenfreie Telefonnummern für Konferenzbrücken zur Verfügung zu stellen und ausgehende Konferenzanrufe für internationale Telefonnummern zu unterstützen, müssen Sie [Kommunikationsguthaben](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) für Ihre Organisation einrichten.</span><span class="sxs-lookup"><span data-stu-id="ebfef-463">To provide toll-free conference bridge phone numbers and to support conferencing dial-out to International phone numbers, you need to setup [Communications Credits](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) for your organization.</span></span>


> [!IMPORTANT]
> <span data-ttu-id="ebfef-464">Für einige Länder/Regionen gibt es nur gebührenfreie Telefonnummern für Konferenzbrücken. In diesem Fall ist die Verwendung von Kommunikationsguthaben verpflichtend, um die Einwahl für diese Länder/Regionen zu unterstützen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-464">Some countries are serviced by toll-free conference bridge phone numbers only, and in this case the use of Communications Credits is a mandatory requirement to support dial in for such countries.</span></span>

<span data-ttu-id="ebfef-465">Bei der Implementierung von Kommunikationsguthaben müssen Sie zunächst überlegen, wie hoch der anfängliche Betrag für das Guthaben sein soll.</span><span class="sxs-lookup"><span data-stu-id="ebfef-465">The first consideration to make when implementing Communications Credits is to decide the initial amount of funds to be purchased.</span></span> <span data-ttu-id="ebfef-466">In der Dokumentation [Communications Credits](https://support.office.com/en-us/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) finden Sie eine Auflistung der empfohlenen Beträge.</span><span class="sxs-lookup"><span data-stu-id="ebfef-466">Recommended funding amounts can be referenced from the [Communications Credits](https://support.office.com/en-us/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) documentation.</span></span>

<span data-ttu-id="ebfef-467">Wenn sich Ihre Organisation für das automatische Auffüllen des Betrags entscheidet, finden Sie in der Dokumentation [Communications Credits](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) ebenfalls eine Empfehlung dafür, wie hoch der niedrigste Betrag sein sollte, ab dem die automatische Auffüllung ausgelöst wird.</span><span class="sxs-lookup"><span data-stu-id="ebfef-467">If your organization chooses to use auto-recharge, a recommendation on the trigger (lowest amount of funds) is also included in the [Communications Credits](https://support.office.com/article/What-is-PSTN-Consumption-billing-524dbea7-117f-493d-8005-6461f7f10059) documentation.</span></span> <span data-ttu-id="ebfef-468">Der Betrag für die automatische Auffüllung richtet sich nach der tatsächlichen Verwendung.</span><span class="sxs-lookup"><span data-stu-id="ebfef-468">Auto-recharge amount needs to be determined by the actual usage.</span></span> <span data-ttu-id="ebfef-469">Die Verwendung von Kommunikationsguthaben sollte immer überwacht werden, und der Auffüllungsbetrag muss dynamisch angepasst werden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-469">Communications Credits usage should be monitored over time and the recharge amount needs to be adjusted as required.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="ebfef-470">Entscheidungspunkte</span><span class="sxs-lookup"><span data-stu-id="ebfef-470">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-471">Wenn Ihre Organisation die erforderliche Lizenzen für Audiokonferenzen noch nicht erworben hat, können Sie überlegen, ob Sie vorhandene Office 365-Abonnements erweitern oder Add-Ons für Audiokonferenzen anschaffen möchten.</span><span class="sxs-lookup"><span data-stu-id="ebfef-471">If your organization has not already purchased the required Audio Conferencing licensing, decide whether Audio Conferencing licenses will be acquired by stepping up existing Office 365 subscriptions or by acquiring Audio Conferencing add-ons.</span></span></li>
<li><span data-ttu-id="ebfef-472">Entscheiden Sie, ob Kommunikationsguthaben für die Implementierung von Audiokonferenzen erforderlich sind.</span><span class="sxs-lookup"><span data-stu-id="ebfef-472">Decide if Communications Credits is required for Audio Conferencing implementation.</span></span> <span data-ttu-id="ebfef-473">Wenn ja, legen Sie den anfänglichen Auffüllungsbetrag fest.</span><span class="sxs-lookup"><span data-stu-id="ebfef-473">If so, decide the initial amount of funds to be purchased.</span></span> <span data-ttu-id="ebfef-474">Legen Sie zudem fest, wie hoch der niedrigste Betrag sein sollte, bei dem die automatische Auffüllung ausgelöst wird.</span><span class="sxs-lookup"><span data-stu-id="ebfef-474">Where applicable, decide the trigger amount and auto-recharge amount.</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="ebfef-475">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="ebfef-475">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-476">Listen Sie die Benutzer auf, denen eine Lizenz für Audiokonferenzen zugewiesen wird.</span><span class="sxs-lookup"><span data-stu-id="ebfef-476">Document the users that will be assigned Audio Conferencing license.</span></span></li>
<li><span data-ttu-id="ebfef-477">Dokumentieren Sie den Plan für Kommunikationsguthaben (anfänglicher Betrag und Betrag für die Auslösung der Auffüllung, Höhe des Betrags für die automatische Auffüllung).</span><span class="sxs-lookup"><span data-stu-id="ebfef-477">Document the Communications Credits plan (initial amount, trigger amount, auto-recharge amount).</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-478">Benutzer</span><span class="sxs-lookup"><span data-stu-id="ebfef-478">User</span></span></th>
<th align="left"><span data-ttu-id="ebfef-479">Niederlassung</span><span class="sxs-lookup"><span data-stu-id="ebfef-479">Office</span></span></th>
<th align="left"><span data-ttu-id="ebfef-480">Office 365-Lizenz</span><span class="sxs-lookup"><span data-stu-id="ebfef-480">Office 365 License</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-481">Adele Vance</span><span class="sxs-lookup"><span data-stu-id="ebfef-481">Adele Vance</span></span></td>
<td align="left"><span data-ttu-id="ebfef-482">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-482">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-483">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="ebfef-483">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-484">Alex Wilber</span><span class="sxs-lookup"><span data-stu-id="ebfef-484">Alex Wilber</span></span></td>
<td align="left"><span data-ttu-id="ebfef-485">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-485">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-486">Office 365 E3, Add-On für Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-486">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-487">Ben Walters</span><span class="sxs-lookup"><span data-stu-id="ebfef-487">Ben Walters</span></span></td>
<td align="left"><span data-ttu-id="ebfef-488">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-488">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-489">Office 365 E3, Add-On für Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-489">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-490">Christie Cline</span><span class="sxs-lookup"><span data-stu-id="ebfef-490">Christie Cline</span></span></td>
<td align="left"><span data-ttu-id="ebfef-491">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-491">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-492">Office 365 E3, Add-On für Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-492">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-493">Debra Berger</span><span class="sxs-lookup"><span data-stu-id="ebfef-493">Debra Berger</span></span></td>
<td align="left"><span data-ttu-id="ebfef-494">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-494">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-495">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="ebfef-495">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-496">Lee Gu</span><span class="sxs-lookup"><span data-stu-id="ebfef-496">Lee Gu</span></span></td>
<td align="left"><span data-ttu-id="ebfef-497">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-497">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-498">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="ebfef-498">Office 365 E5</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-499">Emily Braun</span><span class="sxs-lookup"><span data-stu-id="ebfef-499">Emily Braun</span></span></td>
<td align="left"><span data-ttu-id="ebfef-500">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-500">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-501">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="ebfef-501">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-502">Lidia Holloway</span><span class="sxs-lookup"><span data-stu-id="ebfef-502">Lidia Holloway</span></span></td>
<td align="left"><span data-ttu-id="ebfef-503">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-503">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-504">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="ebfef-504">Office 365 E5</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-505">Pradeep Gupta</span><span class="sxs-lookup"><span data-stu-id="ebfef-505">Pradeep Gupta</span></span></td>
<td align="left"><span data-ttu-id="ebfef-506">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-506">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-507">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="ebfef-507">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-508">Marcel Beauchamp</span><span class="sxs-lookup"><span data-stu-id="ebfef-508">Marcel Beauchamp</span></span></td>
<td align="left"><span data-ttu-id="ebfef-509">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-509">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-510">Office 365 E3, Add-On für Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-510">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-511">Rachelle Cormier</span><span class="sxs-lookup"><span data-stu-id="ebfef-511">Rachelle Cormier</span></span></td>
<td align="left"><span data-ttu-id="ebfef-512">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-512">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-513">Office 365 E5</span><span class="sxs-lookup"><span data-stu-id="ebfef-513">Office 365 E5</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-514">Isabell Potvin</span><span class="sxs-lookup"><span data-stu-id="ebfef-514">Isabell Potvin</span></span></td>
<td align="left"><span data-ttu-id="ebfef-515">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-515">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-516">Office 365 E3, Add-On für Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-516">Office 365 E3, Audio Conferencing add-on</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-517">_Tabelle 8: Lizenzzuweisungsliste für Besprechungsorganisatoren von Audiokonferenzen – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-517">_Table 8 Example of license assignment list for Audio Conferencing meeting organizers_</span></span>

<table>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-518">Anfangsbetrag</span><span class="sxs-lookup"><span data-stu-id="ebfef-518">Initial amount</span></span></th>
<td align="left"><span data-ttu-id="ebfef-519">1.000 US-Dollar</span><span class="sxs-lookup"><span data-stu-id="ebfef-519">$ 1,000</span></span></td>
</tr>
</thead>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-520">Betrag für die Auslösung der Auffüllung</span><span class="sxs-lookup"><span data-stu-id="ebfef-520">Trigger amount</span></span></th>
<td align="left"><span data-ttu-id="ebfef-521">400 US-Dollar</span><span class="sxs-lookup"><span data-stu-id="ebfef-521">$ 400</span></span></td>
</tr>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-522">Höhe des Betrags für die automatische Auffüllung</span><span class="sxs-lookup"><span data-stu-id="ebfef-522">Auto-recharge amount</span></span></th>
<td align="left"><span data-ttu-id="ebfef-523">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-523">TBA</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-524">_Tabelle 9: Zahlen für die Planung von Kommunikationsguthaben – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-524">_Table 9 Example of Communications Credits planning numbers_</span></span>


## <a name="conference-bridge-phone-numbers"></a><span data-ttu-id="ebfef-525">Telefonnummern für Konferenzbrücken</span><span class="sxs-lookup"><span data-stu-id="ebfef-525">Conference bridge phone numbers</span></span>

<span data-ttu-id="ebfef-526">Der Audiokonferenzdienst in Office 365 umfasst:</span><span class="sxs-lookup"><span data-stu-id="ebfef-526">The Audio Conferencing service in Office 365 includes:</span></span>

-   <span data-ttu-id="ebfef-527">Mehrere Typen von Telefonnummern für Konferenzbrücken (gebührenpflichtig und gebührenfrei)</span><span class="sxs-lookup"><span data-stu-id="ebfef-527">Multiple types of conference bridge phone numbers (Toll and Toll-Free)</span></span>

-   <span data-ttu-id="ebfef-528">Mehrere Kategorien der Telefonnummer (dediziert oder freigegeben)</span><span class="sxs-lookup"><span data-stu-id="ebfef-528">Multiple categories of the phone number (dedicated and shared)</span></span>

-   <span data-ttu-id="ebfef-529">Unterstützung für mehrere Sprachen für die Konferenzbrücke (primär oder sekundär)</span><span class="sxs-lookup"><span data-stu-id="ebfef-529">Support for multiple languages for the conference bridge (primary and secondary)</span></span>

-   <span data-ttu-id="ebfef-530">Eine Standardtelefonnummer für den Mandanten.</span><span class="sxs-lookup"><span data-stu-id="ebfef-530">A default phone number for the tenant.</span></span>

<span data-ttu-id="ebfef-531">Eine vollständige Beschreibung der enthaltenen Funktionen finden Sie unter [Einrichten von Einwahl- oder PSTN-Konferenzen für Skype for Business](https://support.office.com/article/Set-up-dial-in-or-PSTN-conferencing-for-Skype-for-Business-d01954f1-4f37-4cf5-a636-20039e5c59e9?ui=en-US&rs=en-US&ad=US) und [Telefonnummern für Einwahlkonferenzen](https://support.office.com/article/Phone-numbers-for-dial-in-conferencing-95a08f84-04e5-4f72-88a8-d6472a7c89d7?ui=en-US&rs=en-US&ad=US)**.**</span><span class="sxs-lookup"><span data-stu-id="ebfef-531">Full description of the included capabilities can be referenced from [Set up dial-in or PSTN conferencing for Skype for Business](https://support.office.com/article/Set-up-dial-in-or-PSTN-conferencing-for-Skype-for-Business-d01954f1-4f37-4cf5-a636-20039e5c59e9?ui=en-US&rs=en-US&ad=US) and [Phone numbers for dial-in conferencing](https://support.office.com/article/Phone-numbers-for-dial-in-conferencing-95a08f84-04e5-4f72-88a8-d6472a7c89d7?ui=en-US&rs=en-US&ad=US)**.**</span></span>

> [!NOTE]
> <span data-ttu-id="ebfef-532">Dedizierte Telefonnummern für Konferenzbrücken werden basierend auf der Anzahl der anwendbaren Lizenzen auf die Telefonnummern angerechnet, die pro Mandant angefordert werden können. Erläuterungen hierzu erhalten Sie unter [Erste Schritte mit Skype for Business-Servicenummern](https://support.office.com/article/Getting-Skype-for-Business-service-phone-numbers-e434aeb2-af99-40e7-981e-a474f0383734).</span><span class="sxs-lookup"><span data-stu-id="ebfef-532">Dedicated conference bridge phone numbers are counted towards the limit of phone numbers that can be acquired per tenant, based on the number of applicable licenses as described in [Getting Skype for Business service phone numbers](https://support.office.com/article/Getting-Skype-for-Business-service-phone-numbers-e434aeb2-af99-40e7-981e-a474f0383734).</span></span> <span data-ttu-id="ebfef-533">Für gebührenfreie Telefonnummern für Konferenzbrücken ist Kommunikationsguthaben erforderlich.</span><span class="sxs-lookup"><span data-stu-id="ebfef-533">Toll-free conference bridge phone numbers require Communications Credits.</span></span>

<span data-ttu-id="ebfef-534">Vorhandene Telefonnummern für Konferenzbrücken, die in den Audiokonferenzdienst übertragen werden müssen, und unter der Voraussetzung, dass diese die landespezifischen Anforderungen erfüllen, können nach Microsoft portiert werden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-534">If there are existing conference bridge phone numbers that must be transferred to the Audio Conferencing service, assuming they are meeting the country-specific requirements, then the existing conference bridge phone numbers can be transferred to Microsoft.</span></span>


> [!NOTE]
> <span data-ttu-id="ebfef-535">Die Komplexität der Portierung von Telefonnummern nach Microsoft richtet sich sehr stark nach den jeweiligen Ländern oder Regionen, Netzbetreibern, der Anzahl der beteiligten Verbindungen und vielen anderen Faktoren.</span><span class="sxs-lookup"><span data-stu-id="ebfef-535">Complexity of transferring phone numbers to Microsoft varies greatly based on the countries or regions, carriers, the number of circuits involved, and many other contributing factors.</span></span> <span data-ttu-id="ebfef-536">Informationen zur Portierung von Telefonnummern finden Sie im [Handbuch zur Portierung von Telefonnummern](https://go.microsoft.com/fwlink/?linkid=859011).</span><span class="sxs-lookup"><span data-stu-id="ebfef-536">To plan for phone number porting, check out the [Number Porting Guide](https://go.microsoft.com/fwlink/?linkid=859011).</span></span>

|  |  |
|---------|---------|
| <iframe width="350" height="200" src="https://www.youtube.com/embed/5k0C21KAsns" frameborder="0" allowfullscreen></iframe>  |  |

<span data-ttu-id="ebfef-537">Weitere Details zur Portierung von Telefonnummern zum Audiokonferenzdienst finden Sie unter [Portierung von Telefonnummern nach Skype for Business Online](https://support.office.com/article/Transfer-phone-numbers-to-Skype-for-Business-Online-47b3af8e-4171-4dec-8333-c956f108664e).</span><span class="sxs-lookup"><span data-stu-id="ebfef-537">Additional details on transferring phone numbers to Audio Conferencing service can be found in [Transfer phone numbers to Skype for Business Online](https://support.office.com/article/Transfer-phone-numbers-to-Skype-for-Business-Online-47b3af8e-4171-4dec-8333-c956f108664e).</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="ebfef-538">Entscheidungspunkte</span><span class="sxs-lookup"><span data-stu-id="ebfef-538">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-539">Wählen Sie aus, ob Ihre Organisation dedizierte Telefonnummern für Konferenzbrücken benötigt.</span><span class="sxs-lookup"><span data-stu-id="ebfef-539">Decide whether the organization requires dedicated conference bridge phone numbers</span></span></li>
<li><span data-ttu-id="ebfef-540">Entscheiden Sie, wie die dedizierten Telefonnummern für Konferenzbrücken für die jeweiligen Benutzerstandorte oder Niederlassungen für die Implementierung von Audiokonferenzen abgerufen werden sollen (über Microsoft oder anhand der Portierung von vorhandenen Telefonnummern).</span><span class="sxs-lookup"><span data-stu-id="ebfef-540">Decide how the dedicated conference bridge phone numbers will be obtained for user locations or offices in-scope for the Audio Conferencing implementation (obtain from Microsoft or transfer existing phone numbers)</span></span></li>
<li><span data-ttu-id="ebfef-541">Wenn Sie sich für Microsoft entscheiden, wählen Sie die Methode zum Abrufen von Telefonnummern (Formulareingabe oder automatisch) für die jeweiligen Benutzerstandorte oder Niederlassungen für die Implementierung von Audiokonferenzen aus.</span><span class="sxs-lookup"><span data-stu-id="ebfef-541">If you choose to obtain from Microsoft, decide the method to obtain phone numbers (form submission or automated) for user locations or offices in-scope for the Audio Conferencing implementation</span></span></li>
<li><span data-ttu-id="ebfef-542">Wählen Sie die Spracheinstellungen für alle dedizierten Telefonnummern für Konferenzbrücken aus.</span><span class="sxs-lookup"><span data-stu-id="ebfef-542">Decide the language preferences to be set up for each dedicated conference bridge phone number</span></span></li>
<li><span data-ttu-id="ebfef-543">Wählen Sie die Standardtelefonnummer für Konferenzbrücken für den Mandanten aus.</span><span class="sxs-lookup"><span data-stu-id="ebfef-543">Decide the tenant default conference bridge phone number</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="ebfef-544">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="ebfef-544">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-545">Dokumentieren Sie den Masterplan für den Erwerb von Telefonnummern mit Details darüber, wie die Telefonnummern an jedem einzelnen Benutzerstandort oder jeder einzelnen Niederlassung für die Implementierung von Audiokonferenzen abgerufen werden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-545">Document the master plan for phone numbers acquisition, detailing how phone numbers will be obtained for each user location or office in-scope for the Audio Conferencing implementation.</span></span></li>
<li><span data-ttu-id="ebfef-546">Falls anwendbar, füllen Sie für jeden Standort oder jede Niederlassung das Formular <a href="https://support.office.com/article/Get-phone-numbers-for-Skype-for-Business-Online-6b61cb3c-361c-48a8-a9ef-d81bddde27bb?ui=en-US&amp;rs=en-US&amp;ad=US">für die Anforderung neuer Telefonnummern</a> aus.</span><span class="sxs-lookup"><span data-stu-id="ebfef-546">If applicable, complete <a href="https://support.office.com/article/Get-phone-numbers-for-Skype-for-Business-Online-6b61cb3c-361c-48a8-a9ef-d81bddde27bb?ui=en-US&amp;rs=en-US&amp;ad=US">the New Telephone Number Request form</a>, one form for each location or office</span></span></li>
<li><span data-ttu-id="ebfef-547">Wenn Sie vorhandene Telefonnummern portieren möchten, können Sie diesen Vorgang mit Unterstützung des <a href="https://go.microsoft.com/fwlink/?linkid=859011">Handbuchs zur Portierung von Telefonnummern</a> planen und die zeitgerechte Implementierung des Audiokonferenzdiensts entsprechend anpassen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-547">If you choose to transfer existing phone numbers, check out the <a href="https://go.microsoft.com/fwlink/?linkid=859011">Number Porting Guide</a> to plan it and adjust Audio Conferencing implementation timeline accordingly.</span></span></li>
<li><span data-ttu-id="ebfef-548">Dokumentieren Sie die detaillierten Konfigurationen der Telefonnummern für Konferenzbrücken (freigegebene und dedizierte Telefonnummern für Konferenzbrücken, Spracheinstellungen für jede dedizierte Telefonnummer für Konferenzbrücken, standardmäßige Telefonnummer für Konferenzbrücken für den Mandanten).</span><span class="sxs-lookup"><span data-stu-id="ebfef-548">Document the detailed conference bridge phone number configurations (shared and dedicated conference bridge phone numbers, language preferences for each dedicated conference bridge phone number, tenant default conference bridge phone number)</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-549">Niederlassung</span><span class="sxs-lookup"><span data-stu-id="ebfef-549">Office</span></span></th>
<th align="left"><span data-ttu-id="ebfef-550">Anschaffung der Brückennummer und Brückentyp</span><span class="sxs-lookup"><span data-stu-id="ebfef-550">Bridge Number Acquisition and Bridge Type</span></span></th>
<th align="left"><span data-ttu-id="ebfef-551">Brückennummer</span><span class="sxs-lookup"><span data-stu-id="ebfef-551">Bridge Number</span></span></th>
<th align="left"><span data-ttu-id="ebfef-552">Brückensprache</span><span class="sxs-lookup"><span data-stu-id="ebfef-552">Bridge Language</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-553">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-553">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-554">Neu anschaffen, dediziert</span><span class="sxs-lookup"><span data-stu-id="ebfef-554">Acquire new, dedicated</span></span></td>
<td align="left"><span data-ttu-id="ebfef-555">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-555">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-556">Englisch (Australien)</span><span class="sxs-lookup"><span data-stu-id="ebfef-556">English (Australia)</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-557">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-557">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-558">Neu anschaffen, freigegeben</span><span class="sxs-lookup"><span data-stu-id="ebfef-558">Acquire new, shared</span></span></td>
<td align="left"><span data-ttu-id="ebfef-559">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-559">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-560">Englisch (Vereinigte Staaten), Chinesisch (vereinfacht)</span><span class="sxs-lookup"><span data-stu-id="ebfef-560">English (United States), Chinese (Simplified, PRC)</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-561">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-561">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-562">Port vorhanden, dediziert</span><span class="sxs-lookup"><span data-stu-id="ebfef-562">Port existing, dedicated</span></span></td>
<td align="left"><span data-ttu-id="ebfef-563">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="ebfef-563">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="ebfef-564">Englisch (Vereinigtes Königreich)</span><span class="sxs-lookup"><span data-stu-id="ebfef-564">English (United Kingdom)</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-565">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-565">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-566">Neu anschaffen, dediziert</span><span class="sxs-lookup"><span data-stu-id="ebfef-566">Acquire new, dedicated</span></span></td>
<td align="left"><span data-ttu-id="ebfef-567">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-567">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-568">Französisch (Frankreich), Englisch (Vereinigtes Königreich)</span><span class="sxs-lookup"><span data-stu-id="ebfef-568">French (France), English (United Kingdom)</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-569">_Tabelle 10: Beispiel der Details einer Konferenzbrücke_</span><span class="sxs-lookup"><span data-stu-id="ebfef-569">_Table 10 Example of conference bridge details_</span></span>


> [!NOTE]
> <span data-ttu-id="ebfef-570">Die Beispieltabelle oben und nachfolgende Tabellen in diesem Dokument dienen als Vorlage.</span><span class="sxs-lookup"><span data-stu-id="ebfef-570">The example table above and subsequent tables throughout this document serve as a template.</span></span> <span data-ttu-id="ebfef-571">Der Hinweis „TBA“ (To Be Added, wird ergänzt) zeigt an, dass Sie hier Informationen als Teil Ihres Planungsprozesses eingeben müssen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-571">You'll see "TBA" (to be added) for information that you need to complete as part of your planning process.</span></span>

## <a name="conference-bridge-settings"></a><span data-ttu-id="ebfef-572">Einstellungen der Konferenzbrücke</span><span class="sxs-lookup"><span data-stu-id="ebfef-572">Conference bridge settings</span></span>

<span data-ttu-id="ebfef-573">Organisationsweite Konfigurationsoptionen für die Teilnahme an Audiokonferenzbesprechungen (Benachrichtigung über Zu- und Abgänge der Besprechung sowie die Aufzeichnung des Anrufernamens), PIN-Länge des Besprechungsorganisators und E-Mail-Benachrichtigung sind zur weiteren Anpassung der Endbenutzerfunktionen verfügbar.</span><span class="sxs-lookup"><span data-stu-id="ebfef-573">Organization-wide configuration options around Audio Conferencing meeting join experience (meeting entry and exit notification and caller name recording), meeting organizer’s PIN length, and email notification are available to further tailor the end-user experience.</span></span>

-   <span data-ttu-id="ebfef-574">Benachrichtigungen über Zu- und Abgänge in Besprechungen sind in Form eines aufgezeichneten Namens, einer Telefonnummer und Signaltönen verfügbar.</span><span class="sxs-lookup"><span data-stu-id="ebfef-574">Meeting entry and exit notifications are available in the form of recorded name, phone number, and tones.</span></span>

-   <span data-ttu-id="ebfef-575">Die PIN-Länge ist mit 4 bis zwölf Ziffern konfigurierbar, wobei eine PIN standardmäßig aus 5 Ziffern besteht.</span><span class="sxs-lookup"><span data-stu-id="ebfef-575">PIN length is configurable from 4 to 12 digits, with a 5-digit PIN as the default.</span></span>

-   <span data-ttu-id="ebfef-576">Benachrichtigungs-E-Mails werden bei der Aktivierung der Lizenz für Audiokonferenzen oder durch andere vom Administrator vorgenommenen Änderungen standardmäßig aktiviert.</span><span class="sxs-lookup"><span data-stu-id="ebfef-576">Notification emails upon enablement of Audio Conferencing license or any other admin-driven changes are enabled by default.</span></span> <span data-ttu-id="ebfef-577">Sie können diese Funktion deaktivieren und die Kontrolle über die Kommunikation Ihrer Endbenutzer übernehmen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-577">You can disable this feature and take control of your organization’s end-user communications.</span></span>

<span data-ttu-id="ebfef-578">Für Benutzer, denen eine Lizenz für Audiokonferenzen zugewiesen ist, können die gebührenpflichtigen bzw. gebührenfreien Nummern (wie in den Koordinaten für Audiokonferenzen gezeigt) so konfiguriert werden, dass sie Folgendes verwenden können:</span><span class="sxs-lookup"><span data-stu-id="ebfef-578">For users who are assigned an Audio Conferencing license, the default toll/toll-free numbers, shown in the Audio Conferencing coordinates, are configurable to use:</span></span>

-   <span data-ttu-id="ebfef-579">die standardmäßigen Telefonnummern für Konferenzbrücken auf der Ebene des Mandanten</span><span class="sxs-lookup"><span data-stu-id="ebfef-579">the tenant-level default, or</span></span>

-   <span data-ttu-id="ebfef-580">die automatisch zugewiesenen Telefonnummern für Konferenzbrücken</span><span class="sxs-lookup"><span data-stu-id="ebfef-580">the automatically-assigned conference bridge phone numbers, or</span></span>

-   <span data-ttu-id="ebfef-581">die für jeden Benutzer manuell definierten Telefonnummern für Konferenzbrücken</span><span class="sxs-lookup"><span data-stu-id="ebfef-581">manually defined conference bridge phone numbers for each user.</span></span>

<span data-ttu-id="ebfef-582">Benutzerspezifische Telefonnummern für Konferenzbrücken sind in der Regel in globalen oder überregionalen Organisationen sinnvoll, in denen Benutzer verteilt sind und lokale Nummern als Standardtelefonnummern für Konferenzbrücken in den Besprechungseinladungen angeben müssen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-582">User-specific conference bridge phone numbers are typically useful in global or nationwide organizations where users are distributed and must provide local numbers as the default conference bridge phone numbers in the meeting invites.</span></span>

<span data-ttu-id="ebfef-583">Teilnehmer aus anderen Städten oder aus dem Ausland können weitere auf der Mandantenebene konfigurierte Nummern nachschlagen, diese Nummern werden jedoch nicht direkt in den Besprechungseinladungen angezeigt.</span><span class="sxs-lookup"><span data-stu-id="ebfef-583">Participants joining from different cities or overseas can look up additional numbers configured at the tenant-level, but these numbers do not appear directly in the meeting invites.</span></span> <span data-ttu-id="ebfef-584">Die Besprechungseinladungen enthalten einen Link, über den die Teilnehmer zu der Seite mit den Einwahlnummern für Teams-Konferenzen gelangen. Dort können die Teilnehmer die für Ihren Standort geltenden Telefonnummern für Konferenzbrücken in Erfahrung bringen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-584">The meeting invites provide a link that will take participants to the Teams Conference Dial-in Numbers page for them to lookup the closest conference bridge phone numbers available from their location.</span></span>

<span data-ttu-id="ebfef-585">Sie können auch konfigurieren, wie nicht authentifizierte Anrufer von jedem einzelnen Besprechungsorganisator gehandhabt werden. Dabei können Sie festlegen, ob der Besprechungsorganisator die Besprechung starten muss, bevor nicht authentifizierte Benutzer zugelassen werden, oder ob nicht authentifizierte Anrufer eine Besprechung starten können.</span><span class="sxs-lookup"><span data-stu-id="ebfef-585">You can also configure how unauthenticated callers are handled by each individual meeting organizer, whether to require meeting organizer to start the meeting before unauthenticated callers are admitted, or to allow unauthenticated callers to start a meeting.</span></span>

<span data-ttu-id="ebfef-586">Zusätzliche für jeden Benutzer anwendbare Konfigurationen sind verfügbar, um die Verwendung von gebührenfreien Telefonnummern für Konferenzbrücken sowie das Anrufen aus einer Konferenz heraus zu steuern.</span><span class="sxs-lookup"><span data-stu-id="ebfef-586">Additional configurations that can be applied for each user are available to control the use of toll-free conference bridge phone numbers and dial-out from a conference.</span></span>

> [!NOTE]
> <span data-ttu-id="ebfef-587">Diese mit Kosten verbundenen Steuerelemente sind derzeit nur für Preview-Kunden verfügbar.</span><span class="sxs-lookup"><span data-stu-id="ebfef-587">These cost-related controls are currently available for preview customers only.</span></span> <span data-ttu-id="ebfef-588">Über die Seite [https://www.skypepreview.com](https://go.microsoft.com/fwlink/?linkid=859013) können Sie Ihre Organisation für das Preview-Programm registrieren.</span><span class="sxs-lookup"><span data-stu-id="ebfef-588">You can enroll your organization in the preview program from [https://www.skypepreview.com](https://go.microsoft.com/fwlink/?linkid=859013).</span></span>

<span data-ttu-id="ebfef-589">Mit diesen Steuerelementen können Sie entscheiden, ob Besprechungsorganisatoren gebührenfreie Telefonnummern für Konferenzbrücken für die von ihnen organisierten Besprechungen zur Verfügung stellen können, und ob sie steuern können, ob Teilnehmer Anrufe aus den von ihnen organisierten Besprechungen heraus tätigen können.</span><span class="sxs-lookup"><span data-stu-id="ebfef-589">With these controls, you can decide whether meeting organizers can provide toll-free conference bridge phone numbers for meetings organized by them, and to control whether participants can dial out from the meetings organized by them.</span></span> <span data-ttu-id="ebfef-590">Die Steuerungsebene rangiert hierbei vom Nichtzulassen von ausgehenden Anrufen, Zulassen von ausgehenden Anrufen an Inlandsnummern bis zum Zulassen von ausgehenden Anrufen an Inlands- und Auslandsnummern.</span><span class="sxs-lookup"><span data-stu-id="ebfef-590">The level of dial-out control spans from disallowing dial out, only allowing dial out to domestic numbers, to allowing dial out to both domestic and international numbers.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="ebfef-591">Entscheidungspunkte</span><span class="sxs-lookup"><span data-stu-id="ebfef-591">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-592">Entscheiden Sie, ob die Organisation Benachrichtigungen über Zu- und Abgänge benötigt. Wenn ja, wählen Sie den zu implementierenden Benachrichtigungstyp (Signaltöne, Telefonnummer, aufgezeichneter Name) aus.</span><span class="sxs-lookup"><span data-stu-id="ebfef-592">Decide whether the organization requires entry and exit notifications, and if yes, the type of notification to be implemented (tones, phone number, or recorded name).</span></span></li>
<li><span data-ttu-id="ebfef-593">Legen Sie die PIN-Länge für Audiokonferenzen in Übereinstimmung mit den Sicherheitsanforderungen Ihrer Organisation fest.</span><span class="sxs-lookup"><span data-stu-id="ebfef-593">Decide the Audio Conferencing PIN length that meets the organizational security requirements.</span></span></li>
<li><span data-ttu-id="ebfef-594">Legen Sie fest, ob die Organisation die mit dem Audiokonferenzdienst verbundene Kommunikation der Endbenutzer steuern möchte.</span><span class="sxs-lookup"><span data-stu-id="ebfef-594">Decide if the organization wants to take control of end-user communications related to Audio Conferencing service.</span></span></li>
<li><span data-ttu-id="ebfef-595">Wählen Sie die Telefonnummern für Konferenzbrücken aus, die jedem Besprechungsorganisator zugewiesen werden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-595">Decide the conference bridge phone numbers to be assigned to each meeting organizer.</span></span></li>
<li><span data-ttu-id="ebfef-596">Legen Sie fest, ob einige Besprechungsorganisatoren in die Lage versetzt werden sollen, gebührenfreie Telefonnummern für Konferenzbrücken in Ihren Besprechungen zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-596">Decide whether some meeting organizers require the ability to use toll-free conference bridge phone numbers for their meeings</span></span></li>
<li><span data-ttu-id="ebfef-597">Legen Sie fest, ob einige Besprechungsorganisatoren in die Lage versetzt werden sollen, nicht authentifizierten Anrufern zu erlauben, eine Besprechung zu starten.</span><span class="sxs-lookup"><span data-stu-id="ebfef-597">Decide whether some meeting organizers require the ability to allow unauthenticated callers to start a meeting.</span></span></li>
<li><span data-ttu-id="ebfef-598">Legen Sie fest, ob für einige Besprechungsorganisatoren die ausgehenden Anrufe gesteuert werden sollen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-598">Decide whether some meeting organizers require conference dial out to be controlled.</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="ebfef-599">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="ebfef-599">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-600">Dokumentieren Sie die detaillierten Konferenzbrückeneinstellungen (Benachrichtigungen über Zu- und Abgänge, PIN-Länge, E-Mail-Benachrichtigung über Konfigurationsänderungen).</span><span class="sxs-lookup"><span data-stu-id="ebfef-600">Document the detailed conference bridge settings (entry and exit notifications, PIN length, configuration change email notification).</span></span></li>
<li><span data-ttu-id="ebfef-601">Dokumentieren Sie die Telefonnummern für Konferenzbrücken, die jedem Besprechungsorganisator zugewiesen werden, und die entsprechende Einstellung, um die Richtlinie für nicht authentifizierte Anrufer zu steuern, sowie Steuerelemente für gebührenfreie und ausgehende Anrufe.</span><span class="sxs-lookup"><span data-stu-id="ebfef-601">Document the conference bridge phone numbers to be assinged to each meeting organizer and the corresponding setting to control unauthenticated caller’s policy, and toll-free and dial out controls.</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<td align="left"><span data-ttu-id="ebfef-602"><strong>Benachrichtigungen über Zu- und Abgänge in Besprechungen aktivieren</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-602"><strong>Enable meeting entry and exit notifications</strong></span></span></td>
<td align="left"><span data-ttu-id="ebfef-603">Aktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-603">Enabled</span></span></td>
</tr>
</thead>
<thead>
<tr class="header">
<td align="left"><span data-ttu-id="ebfef-604"><strong>Ankündigungstyp für Zu- und Abgänge</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-604"><strong>Entry/exit announcement type</strong></span></span></td>
<td align="left"><span data-ttu-id="ebfef-605">Signaltöne</span><span class="sxs-lookup"><span data-stu-id="ebfef-605">Tones</span></span></td>
</tr>
<tr class="header">
<td align="left"><span data-ttu-id="ebfef-606"><strong>Anrufer fragen, ob ihr Name vor der Teilnahme an der Besprechung aufgezeichnet werden kann</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-606"><strong>Ask callers to record their name before joining the meeting</strong></span></span></td>
<td align="left"><span data-ttu-id="ebfef-607">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-607">Disabled</span></span></td>
</tr>
<tr class="header">
<td align="left"><span data-ttu-id="ebfef-608"><strong>PIN-Länge</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-608"><strong>PIN length</strong></span></span></td>
<td align="left"><span data-ttu-id="ebfef-609">5</span><span class="sxs-lookup"><span data-stu-id="ebfef-609">5</span></span></td>
</tr>
<tr class="header">
<td align="left"><span data-ttu-id="ebfef-610"><strong>Es werden automatisch E-Mails an den Benutzer gesendet, wenn sich die Einwahleinstellungen ändern</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-610"><strong>Automatically send emails to users if their dial-in settings change</strong></span></span></td>
<td align="left"><span data-ttu-id="ebfef-611">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-611">Disabled</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-612">_Tabelle 11: Einstellungen einer Konferenzbrücke – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-612">_Table 11 Example of conference bridge settings_</span></span>


<table>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-613">Benutzer</span><span class="sxs-lookup"><span data-stu-id="ebfef-613">User</span></span></th>
<th align="left"><span data-ttu-id="ebfef-614">Niederlassung</span><span class="sxs-lookup"><span data-stu-id="ebfef-614">Office</span></span></th>
<th align="left"><span data-ttu-id="ebfef-615">Gebührenpflichtige Standardnummer</span><span class="sxs-lookup"><span data-stu-id="ebfef-615">Default toll number</span></span></th>
<th align="left"><span data-ttu-id="ebfef-616">Gebührenfreie Standardnummer</span><span class="sxs-lookup"><span data-stu-id="ebfef-616">Default toll-free number</span></span></th>
<th align="left"><span data-ttu-id="ebfef-617">Gebührenfreie Nummer zulassen</span><span class="sxs-lookup"><span data-stu-id="ebfef-617">Allow toll-free</span></span></th>
<th align="left"><span data-ttu-id="ebfef-618">Nicht authentifizierte Anrufer umgehen Wartebereich</span><span class="sxs-lookup"><span data-stu-id="ebfef-618">Unauthenticated callers bypass lobby</span></span></th>
<th align="left"><span data-ttu-id="ebfef-619">Konferenzauswahl</span><span class="sxs-lookup"><span data-stu-id="ebfef-619">Conference dial out</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-620">Adele Vance</span><span class="sxs-lookup"><span data-stu-id="ebfef-620">Adele Vance</span></span></td>
<td align="left"><span data-ttu-id="ebfef-621">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-621">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-622">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-622">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-623">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-623">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-624">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-624">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-625">Aktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-625">Enabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-626">In- und Auslandsanrufe</span><span class="sxs-lookup"><span data-stu-id="ebfef-626">International and domestic</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-627">Alex Wilber</span><span class="sxs-lookup"><span data-stu-id="ebfef-627">Alex Wilber</span></span></td>
<td align="left"><span data-ttu-id="ebfef-628">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-628">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-629">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-629">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-630">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-630">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-631">Nein</span><span class="sxs-lookup"><span data-stu-id="ebfef-631">No</span></span></td>
<td align="left"><span data-ttu-id="ebfef-632">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-632">Disabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-633">Nicht zulässig</span><span class="sxs-lookup"><span data-stu-id="ebfef-633">Not allowed</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-634">Ben Walters</span><span class="sxs-lookup"><span data-stu-id="ebfef-634">Ben Walters</span></span></td>
<td align="left"><span data-ttu-id="ebfef-635">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-635">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-636">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-636">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-637">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-637">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-638">Nein</span><span class="sxs-lookup"><span data-stu-id="ebfef-638">No</span></span></td>
<td align="left"><span data-ttu-id="ebfef-639">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-639">Disabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-640">Nicht zulässig</span><span class="sxs-lookup"><span data-stu-id="ebfef-640">Not allowed</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-641">Christie Cline</span><span class="sxs-lookup"><span data-stu-id="ebfef-641">Christie Cline</span></span></td>
<td align="left"><span data-ttu-id="ebfef-642">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-642">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-643">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-643">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-644">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-644">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-645">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-645">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-646">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-646">Disabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-647">Inlandsanruf</span><span class="sxs-lookup"><span data-stu-id="ebfef-647">Domestic</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-648">Debra Berger</span><span class="sxs-lookup"><span data-stu-id="ebfef-648">Debra Berger</span></span></td>
<td align="left"><span data-ttu-id="ebfef-649">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-649">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-650">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-650">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-651">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-651">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-652">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-652">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-653">Aktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-653">Enabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-654">Inlandsanruf</span><span class="sxs-lookup"><span data-stu-id="ebfef-654">Domestic</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-655">Lee Gu</span><span class="sxs-lookup"><span data-stu-id="ebfef-655">Lee Gu</span></span></td>
<td align="left"><span data-ttu-id="ebfef-656">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-656">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-657">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-657">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-658">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-658">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-659">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-659">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-660">Aktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-660">Enabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-661">Inlandsanruf</span><span class="sxs-lookup"><span data-stu-id="ebfef-661">Domestic</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-662">Emily Braun</span><span class="sxs-lookup"><span data-stu-id="ebfef-662">Emily Braun</span></span></td>
<td align="left"><span data-ttu-id="ebfef-663">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-663">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-664">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="ebfef-664">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="ebfef-665">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-665">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-666">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-666">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-667">Aktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-667">Enabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-668">Nicht zulässig</span><span class="sxs-lookup"><span data-stu-id="ebfef-668">Not allowed</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-669">Lidia Holloway</span><span class="sxs-lookup"><span data-stu-id="ebfef-669">Lidia Holloway</span></span></td>
<td align="left"><span data-ttu-id="ebfef-670">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-670">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-671">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="ebfef-671">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="ebfef-672">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-672">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-673">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-673">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-674">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-674">Disabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-675">Nicht zulässig</span><span class="sxs-lookup"><span data-stu-id="ebfef-675">Not allowed</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-676">Pradeep Gupta</span><span class="sxs-lookup"><span data-stu-id="ebfef-676">Pradeep Gupta</span></span></td>
<td align="left"><span data-ttu-id="ebfef-677">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-677">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-678">+44 20 7946 0001</span><span class="sxs-lookup"><span data-stu-id="ebfef-678">+44 20 7946 0001</span></span></td>
<td align="left"><span data-ttu-id="ebfef-679">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-679">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-680">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-680">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-681">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-681">Disabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-682">Nicht zulässig</span><span class="sxs-lookup"><span data-stu-id="ebfef-682">Not allowed</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-683">Marcel Beauchamp</span><span class="sxs-lookup"><span data-stu-id="ebfef-683">Marcel Beauchamp</span></span></td>
<td align="left"><span data-ttu-id="ebfef-684">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-684">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-685">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-685">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-686">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-686">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-687">Nein</span><span class="sxs-lookup"><span data-stu-id="ebfef-687">No</span></span></td>
<td align="left"><span data-ttu-id="ebfef-688">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-688">Disabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-689">Inlandsanruf</span><span class="sxs-lookup"><span data-stu-id="ebfef-689">Domestic</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-690">Rachelle Cormier</span><span class="sxs-lookup"><span data-stu-id="ebfef-690">Rachelle Cormier</span></span></td>
<td align="left"><span data-ttu-id="ebfef-691">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-691">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-692">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-692">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-693">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-693">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-694">Ja</span><span class="sxs-lookup"><span data-stu-id="ebfef-694">Yes</span></span></td>
<td align="left"><span data-ttu-id="ebfef-695">Aktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-695">Enabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-696">In- und Auslandsanrufe</span><span class="sxs-lookup"><span data-stu-id="ebfef-696">International and domestic</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-697">Isabell Potvin</span><span class="sxs-lookup"><span data-stu-id="ebfef-697">Isabell Potvin</span></span></td>
<td align="left"><span data-ttu-id="ebfef-698">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-698">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-699">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-699">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-700">TBA</span><span class="sxs-lookup"><span data-stu-id="ebfef-700">TBA</span></span></td>
<td align="left"><span data-ttu-id="ebfef-701">Nein</span><span class="sxs-lookup"><span data-stu-id="ebfef-701">No</span></span></td>
<td align="left"><span data-ttu-id="ebfef-702">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-702">Disabled</span></span></td>
<td align="left"><span data-ttu-id="ebfef-703">Inlandsanruf</span><span class="sxs-lookup"><span data-stu-id="ebfef-703">Domestic</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-704">_Tabelle 12: Zuweisungen der Einstellungen für Konferenzbrücke – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-704">_Table 12 Example of conference bridge settings assignments_</span></span>


## <a name="dial-plans"></a><span data-ttu-id="ebfef-705">Wählpläne</span><span class="sxs-lookup"><span data-stu-id="ebfef-705">Dial plans</span></span>

<span data-ttu-id="ebfef-706">Ein [Wählplan](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b) (eine Telefonsystemfunktion von Office 365) ist eine Gruppe von Normalisierungsregeln, die gewählte Telefonnummern in ein alternatives Format (normalerweise das Format [E.164](https://go.microsoft.com/fwlink/?linkid=859014)) übersetzt, um Anrufe zu autorisieren und weiterzuleiten.</span><span class="sxs-lookup"><span data-stu-id="ebfef-706">A [Dial Plan](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b), a Phone System feature of Office 365, is a set of normalization rules that translates dialed phone numbers into an alternate format (typically [E.164](https://go.microsoft.com/fwlink/?linkid=859014) format) for call authorization and call routing.</span></span> <span data-ttu-id="ebfef-707">Der Audiokonferenzdienst nutzt dieselben Funktionen wie das Telefonsystem, um gewählte Telefonnummern in Szenarien für die Konferenzauswahl zu übersetzen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-707">Audio Conferencing service leverages the same capabilities used by Phone System to translate dialed phone numbers in conference dial out scenarios.</span></span>

<span data-ttu-id="ebfef-708">Mit einem Wählplan können Benutzer Telefonnummern so wählen, wie sie es gewöhnt sind. Zum Beispiel müssen sie bei Ortsgesprächen keine Vorwahl wählen, bei Inlandsanrufen keine Landeskennzahl wählen, und sie können sogar Kurzwahlnummern für ausgehende Anrufe in Konferenzen verwenden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-708">A dial plan allows users to dial phone numbers the way they are accustomed to, such as omitting area code for local calls, omitting country code for domestic calls, or even using short digit dialing when performing conference dial out.</span></span>

<span data-ttu-id="ebfef-709">Innerhalb der Telefonsystemfunktion in Office 36 gibt es zwei Arten von Wählplänen:</span><span class="sxs-lookup"><span data-stu-id="ebfef-709">Within the Phone System feature of Office 365, there are two types of dial plans:</span></span>

-   <span data-ttu-id="ebfef-710">**Dienstwählplan**.</span><span class="sxs-lookup"><span data-stu-id="ebfef-710">**Service dial plan**.</span></span> <span data-ttu-id="ebfef-711">Dies ist der Standardwählplan, der auf einem Office 365-Verwendungsstandort basiert und nicht geändert werden kann.</span><span class="sxs-lookup"><span data-stu-id="ebfef-711">This is the default dial plan and applied to users based on Office 365 usage location, and it cannot be modified.</span></span>

<!-- -->

-   <span data-ttu-id="ebfef-712">**Mandantenwählplan**.</span><span class="sxs-lookup"><span data-stu-id="ebfef-712">**Tenant dial plan**.</span></span> <span data-ttu-id="ebfef-713">Dies ist ein anpassbarer Wählplan innerhalb eines Mandanten, der wiederum zwei Typen umfasst:</span><span class="sxs-lookup"><span data-stu-id="ebfef-713">This is a customizable dial plan within a tenant, and further divided into two types:</span></span>

    -   <span data-ttu-id="ebfef-714">**Globaler Wählplan für Mandanten**: Der Wählplan gilt für alle Benutzer innerhalb des Mandanten.</span><span class="sxs-lookup"><span data-stu-id="ebfef-714">**Tenant-global dial plan**—the dial plan applies to all users within the tenant.</span></span>

    -   <span data-ttu-id="ebfef-715">**Wählplan für Mandantenbenutzer**: Der Wählplan gilt nur für bestimmte Benutzer.</span><span class="sxs-lookup"><span data-stu-id="ebfef-715">**Tenant-user dial plan**—the dial plan applies only to specific users.</span></span>


> [!NOTE]
> <span data-ttu-id="ebfef-716">Weitere Details und Beispiele finden Sie in der Dokumentation [Office 365 Calling Plan dial plans](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b) (Office 365-Wählpläne).</span><span class="sxs-lookup"><span data-stu-id="ebfef-716">Check out the [Office 365 Calling Plan dial plans](https://support.office.com/article/What-are-PSTN-Calling-dial-plans-2f0cfb59-1ca1-4e31-84ce-09d0b1a7ce1b) documentation for further details and examples.</span></span>

<span data-ttu-id="ebfef-717">Der den Benutzern zugewiesene wirksame Wählplan stellt eine Kombination aus dem Dienstwählplan (basierend auf dem Office 365-Verwendungsstandort des Benutzers) und dem Mandantenwählplan (entweder globaler Wählplan für Mandanten oder Wählplan für Mandantenbenutzer) dar.</span><span class="sxs-lookup"><span data-stu-id="ebfef-717">The effective dial plan assigned to users is the combination of service dial plan (based on user’s Office 365 usage location) and tenant dial plan (can be either tenant-global dial plan or tenant-user dial plan).</span></span>

![Die Tabelle zeigt drei Kombinationen aus Dienst- und Mandantenwählplänen.](media/audio_conferencing_image8.png)

<span data-ttu-id="ebfef-719">Normalisierungsregeln können maximal 25 Regeln in jedem Mandantenwählplan enthalten. Eine Duplizierung von bereits als Teil des Dienstwählplans vorhandenen Normalisierungsregeln sollte daher vermieden werden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-719">There is a maximum of 25 normalization rules in each tenant dial plan, and thus duplication with normalization rules already available as part of service dial plan needs to be avoided.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="ebfef-720">Entscheidungspunkte</span><span class="sxs-lookup"><span data-stu-id="ebfef-720">Decision Points</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-721">Legen Sie fest, ob Ihre Organisation angepasste Wählpläne (Geschäftsanforderungen, Übernahmeanforderungen usw.) benötigt.</span><span class="sxs-lookup"><span data-stu-id="ebfef-721">Decide if your organization requires customized dial plans (business requirements, adoption requirements, etc.).</span></span></li>
<li><span data-ttu-id="ebfef-722">Legen Sie (falls anwendbar) den Gültigkeitsbereich für den Mandantenwählplan (globaler Wählplan für Mandanten oder Wählplan für Mandantenbenutzer) fest, um die Anforderungen für angepasste Wählpläne zu erfüllen.</span><span class="sxs-lookup"><span data-stu-id="ebfef-722">If applicable, decide the scope of tenant dial plan (tenant-global or tenant-user) to support the requirements for customized dial plans.</span></span></li>
<li><span data-ttu-id="ebfef-723">Legen Sie (falls anwendbar) die Mandantenwählpläne fest, die zur Unterstützung von Benutzerstandorten oder Niederlassungen für die Implementierung von Audiokonferenzen erstellt wird.</span><span class="sxs-lookup"><span data-stu-id="ebfef-723">If applicable, decide the tenant dial plans that will be created to support user locations or offices in-scope for the Audio Conferencing implementation.</span></span></li>
<li><span data-ttu-id="ebfef-724">Legen Sie (falls anwendbar) fest, welche Benutzer einen angepassten Wählplan erfordern, und wählen Sie den jedem Benutzer zuzuweisenden Mandantenwählplan aus.</span><span class="sxs-lookup"><span data-stu-id="ebfef-724">If applicable, decide which user require customized dial plan and the tenant dial plan to be assigned for each user.</span></span></li></ul></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="ebfef-725">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="ebfef-725">Next Steps</span></span></td>
<td align="left"><ul><li><span data-ttu-id="ebfef-726">Dokumentieren Sie die angepassten Wählpläne und die zugehörigen Normalisierungsregeln, die als Teil der Implementierung von Audiokonferenzen konfiguriert werden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-726">Document the customized dial plans and the associated normalization rules to be configured as part of Audio Conferencing implementation.</span></span></li>
<li><span data-ttu-id="ebfef-727">Dokumentieren Sie die Benutzer, denen ein angepasster Wählplan zugewiesen wird, und die den Mandantenwählplan für jeden einzelnen Benutzer.</span><span class="sxs-lookup"><span data-stu-id="ebfef-727">Document the users to be assigned with customized dial plan and the tenant dial plan to be assigned for each user.</span></span></li></ul></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-728">Name/Beschreibung des Mandantenwählplans</span><span class="sxs-lookup"><span data-stu-id="ebfef-728">Tenant Dial Plan Name/Description</span></span></th>
<th align="left"><span data-ttu-id="ebfef-729">Name/Beschreibung der Normalisierungsregeln</span><span class="sxs-lookup"><span data-stu-id="ebfef-729">Normalization Rules Name/Description</span></span></th>
<th align="left"><span data-ttu-id="ebfef-730">Muster</span><span class="sxs-lookup"><span data-stu-id="ebfef-730">Pattern</span></span></th>
<th align="left"><span data-ttu-id="ebfef-731">Übersetzung</span><span class="sxs-lookup"><span data-stu-id="ebfef-731">Translation</span></span></th>
<th align="left"><span data-ttu-id="ebfef-732">IsInternalExtension</span><span class="sxs-lookup"><span data-stu-id="ebfef-732">IsInternalExtension</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><p><span data-ttu-id="ebfef-733"><strong>AU-NSW-NorthRyde-OER</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-733"><strong>AU-NSW-NorthRyde-OER</strong></span></span></p>
<p><span data-ttu-id="ebfef-734"><em>One Epping Road North Ryde, NSW, Wählplan für Australien</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-734"><em>One Epping Road North Ryde, NSW, AU Dial Plan</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="ebfef-735"><strong>AU-NSW-NorthRyde-OER-Internal</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-735"><strong>AU-NSW-NorthRyde-OER-Internal</strong></span></span></p>
<p><span data-ttu-id="ebfef-736"><em>Interne Nummer (x7000 - x7999) für One Epping Road-Niederlassung, North Ryde, NSW, Australien</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-736"><em>Internal number (x7000 - x7999) for One Epping Road office, North Ryde, NSW, Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-737">^(7\d{3})$</span><span class="sxs-lookup"><span data-stu-id="ebfef-737">^(7\d{3})$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-738">+6125550$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-738">+6125550$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-739">Wahr</span><span class="sxs-lookup"><span data-stu-id="ebfef-739">True</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="ebfef-740"><strong>AU-NSW-Local</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-740"><strong>AU-NSW-Local</strong></span></span></p>
<p><span data-ttu-id="ebfef-741"><em>Normalisierung für lokale Nummern für NSW, Australien</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-741"><em>Local number normalization for NSW, Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-742">^([2-9]\d{7})$</span><span class="sxs-lookup"><span data-stu-id="ebfef-742">^([2-9]\d{7})$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-743">+612$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-743">+612$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-744">Falsch</span><span class="sxs-lookup"><span data-stu-id="ebfef-744">False</span></span></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="ebfef-745"><strong>AU-TollFree</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-745"><strong>AU-TollFree</strong></span></span></p>
<p><span data-ttu-id="ebfef-746"><em>Normalisierung für gebührenfreie Nummern für Australien</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-746"><em>Toll Free number normalization for Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-747">^(1[38]\d{4,8})\d*$</span><span class="sxs-lookup"><span data-stu-id="ebfef-747">^(1[38]\d{4,8})\d*$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-748">+61$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-748">+61$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-749">Falsch</span><span class="sxs-lookup"><span data-stu-id="ebfef-749">False</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="ebfef-750"><strong>AU-Service</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-750"><strong>AU-Service</strong></span></span></p>
<p><span data-ttu-id="ebfef-751"><em>Normalisierung für Servicenummern für Australien</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-751"><em>Service number normalization for Australia</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-752">^(000|1[0125]\d{1,8})$</span><span class="sxs-lookup"><span data-stu-id="ebfef-752">^(000|1[0125]\d{1,8})$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-753">$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-753">$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-754">Falsch</span><span class="sxs-lookup"><span data-stu-id="ebfef-754">False</span></span></td>
</tr>
<tr class="odd">
<td align="left"><p><span data-ttu-id="ebfef-755"><strong>SG-Singapore-OMB</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-755"><strong>SG-Singapore-OMB</strong></span></span></p>
<p><span data-ttu-id="ebfef-756"><em>OMB Singapore, Wählplan für Singapur</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-756"><em>OMB Singapore, SG Dial Plan</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="ebfef-757"><strong>SG-OMB-Internal</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-757"><strong>SG-OMB-Internal</strong></span></span></p>
<p><span data-ttu-id="ebfef-758"><em>Interne Nummer (x8000 – x8999) für OMB-Niederlassung, Singapur</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-758"><em>Internal number (x8000 – x8999) for OMB office, Singapore</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-759">^(8\d{3})$</span><span class="sxs-lookup"><span data-stu-id="ebfef-759">^(8\d{3})$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-760">+656888$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-760">+656888$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-761">Wahr</span><span class="sxs-lookup"><span data-stu-id="ebfef-761">True</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="ebfef-762"><strong>SG-TollFree</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-762"><strong>SG-TollFree</strong></span></span></p>
<p><span data-ttu-id="ebfef-763"><em>Normalisierung für gebührenfreie Nummern für Singapur</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-763"><em>Toll Free number normalization for Singapore</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-764">^(1?800\d{7})\d*$</span><span class="sxs-lookup"><span data-stu-id="ebfef-764">^(1?800\d{7})\d*$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-765">+65$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-765">+65$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-766">Falsch</span><span class="sxs-lookup"><span data-stu-id="ebfef-766">False</span></span></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="ebfef-767"><strong>SG-Service</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-767"><strong>SG-Service</strong></span></span></p>
<p><span data-ttu-id="ebfef-768"><em>Normalisierung für Servicenummern für Singapur</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-768"><em>Service number normalization for Singapore</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-769">^(1\d{3,4}|9\d{2})$</span><span class="sxs-lookup"><span data-stu-id="ebfef-769">^(1\d{3,4}|9\d{2})$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-770">$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-770">$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-771">Falsch</span><span class="sxs-lookup"><span data-stu-id="ebfef-771">False</span></span></td>
</tr>
<tr class="even">
<td align="left"><p><span data-ttu-id="ebfef-772"><strong>FR-Paris-Issy-39qdPR</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-772"><strong>FR-Paris-Issy-39qdPR</strong></span></span></p>
<p><span data-ttu-id="ebfef-773"><em>39 quai du Président Roosevelt Issy-les-Moulineaux, Wählplan für Frankreich</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-773"><em>39 quai du Président Roosevelt Issy-les-Moulineaux, France Dial Plan</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="ebfef-774"><strong>FR-39qdPR-Internal</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-774"><strong>FR-39qdPR-Internal</strong></span></span></p>
<p><span data-ttu-id="ebfef-775"><em>Interne Nummer (x7000 – x7999) für 39 quai du Président Roosevelt-Niederlassung, Issy-les-Moulineaux, Frankreich</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-775"><em>Internal number (x7000 – x7999) for 39 quai du Président Roosevelt office, Issy-les-Moulineaux, France</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-776">^(7\d{3})$</span><span class="sxs-lookup"><span data-stu-id="ebfef-776">^(7\d{3})$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-777">+3319999$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-777">+3319999$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-778">Wahr</span><span class="sxs-lookup"><span data-stu-id="ebfef-778">True</span></span></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="ebfef-779"><strong>FR-TollFree</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-779"><strong>FR-TollFree</strong></span></span></p>
<p><span data-ttu-id="ebfef-780"><em>Normalisierung für gebührenfreie Nummern für Frankreich</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-780"><em>Toll Free number normalization for France</em></span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-781">^0?(80\d{7})\d*$</span><span class="sxs-lookup"><span data-stu-id="ebfef-781">^0?(80\d{7})\d*$</span></span></td>
<td align="left"><span data-ttu-id="ebfef-782">+33$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-782">+33$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-783">Falsch</span><span class="sxs-lookup"><span data-stu-id="ebfef-783">False</span></span></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left"><p><span data-ttu-id="ebfef-784"><strong>FR-Service</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-784"><strong>FR-Service</strong></span></span></p>
<p><span data-ttu-id="ebfef-785"><em>Normalisierung für Servicenummern für Frankreich</em></span><span class="sxs-lookup"><span data-stu-id="ebfef-785"><em>Service number normalization for France</em></span></span></p></td>
<td align="left"><p><span data-ttu-id="ebfef-786">^(1\d{1,2}|11[68]\d{3}|</span><span class="sxs-lookup"><span data-stu-id="ebfef-786">^(1\d{1,2}|11[68]\d{3}|</span></span></p>
<p><span data-ttu-id="ebfef-787">10\d{2}|3\d{3})$</span><span class="sxs-lookup"><span data-stu-id="ebfef-787">10\d{2}|3\d{3})$</span></span></p></td>
<td align="left"><span data-ttu-id="ebfef-788">$1</span><span class="sxs-lookup"><span data-stu-id="ebfef-788">$1</span></span></td>
<td align="left"><span data-ttu-id="ebfef-789">Falsch</span><span class="sxs-lookup"><span data-stu-id="ebfef-789">False</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-790">_Tabelle 13: Mandantenwählpläne – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-790">_Table 13 Example of tenant dial plans_</span></span>


<table>
<thead>
<tr class="header">
<th align="left"><span data-ttu-id="ebfef-791">Benutzer</span><span class="sxs-lookup"><span data-stu-id="ebfef-791">User</span></span></th>
<th align="left"><span data-ttu-id="ebfef-792">Niederlassung</span><span class="sxs-lookup"><span data-stu-id="ebfef-792">Office</span></span></th>
<th align="left"><span data-ttu-id="ebfef-793">Typ des Wählplans</span><span class="sxs-lookup"><span data-stu-id="ebfef-793">Dial Plan Type</span></span></th>
<th align="left"><span data-ttu-id="ebfef-794">Name des Wählplans</span><span class="sxs-lookup"><span data-stu-id="ebfef-794">Dial Plan Name</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-795">Adele Vance</span><span class="sxs-lookup"><span data-stu-id="ebfef-795">Adele Vance</span></span></td>
<td align="left"><span data-ttu-id="ebfef-796">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-796">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-797">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-797">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-798">AU-NSW-NorthRyde-OER</span><span class="sxs-lookup"><span data-stu-id="ebfef-798">AU-NSW-NorthRyde-OER</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-799">Alex Wilber</span><span class="sxs-lookup"><span data-stu-id="ebfef-799">Alex Wilber</span></span></td>
<td align="left"><span data-ttu-id="ebfef-800">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-800">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-801">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-801">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-802">AU-NSW-NorthRyde-OER</span><span class="sxs-lookup"><span data-stu-id="ebfef-802">AU-NSW-NorthRyde-OER</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-803">Ben Walters</span><span class="sxs-lookup"><span data-stu-id="ebfef-803">Ben Walters</span></span></td>
<td align="left"><span data-ttu-id="ebfef-804">One Epping Road</span><span class="sxs-lookup"><span data-stu-id="ebfef-804">One Epping Road</span></span></td>
<td align="left"><span data-ttu-id="ebfef-805">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-805">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-806">AU-NSW-NorthRyde-OER</span><span class="sxs-lookup"><span data-stu-id="ebfef-806">AU-NSW-NorthRyde-OER</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-807">Christie Cline</span><span class="sxs-lookup"><span data-stu-id="ebfef-807">Christie Cline</span></span></td>
<td align="left"><span data-ttu-id="ebfef-808">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-808">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-809">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-809">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-810">SG-Singapore-OMB</span><span class="sxs-lookup"><span data-stu-id="ebfef-810">SG-Singapore-OMB</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-811">Debra Berger</span><span class="sxs-lookup"><span data-stu-id="ebfef-811">Debra Berger</span></span></td>
<td align="left"><span data-ttu-id="ebfef-812">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-812">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-813">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-813">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-814">SG-Singapore-OMB</span><span class="sxs-lookup"><span data-stu-id="ebfef-814">SG-Singapore-OMB</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-815">Lee Gu</span><span class="sxs-lookup"><span data-stu-id="ebfef-815">Lee Gu</span></span></td>
<td align="left"><span data-ttu-id="ebfef-816">One Marina Boulevard</span><span class="sxs-lookup"><span data-stu-id="ebfef-816">One Marina Boulevard</span></span></td>
<td align="left"><span data-ttu-id="ebfef-817">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-817">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-818">SG-Singapore-OMB</span><span class="sxs-lookup"><span data-stu-id="ebfef-818">SG-Singapore-OMB</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-819">Emily Braun</span><span class="sxs-lookup"><span data-stu-id="ebfef-819">Emily Braun</span></span></td>
<td align="left"><span data-ttu-id="ebfef-820">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-820">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-821">Dienstwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-821">Service dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-822">n/v</span><span class="sxs-lookup"><span data-stu-id="ebfef-822">N/A</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-823">Lidia Holloway</span><span class="sxs-lookup"><span data-stu-id="ebfef-823">Lidia Holloway</span></span></td>
<td align="left"><span data-ttu-id="ebfef-824">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-824">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-825">Dienstwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-825">Service dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-826">n/v</span><span class="sxs-lookup"><span data-stu-id="ebfef-826">N/A</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-827">Pradeep Gupta</span><span class="sxs-lookup"><span data-stu-id="ebfef-827">Pradeep Gupta</span></span></td>
<td align="left"><span data-ttu-id="ebfef-828">32 London Bridge Street</span><span class="sxs-lookup"><span data-stu-id="ebfef-828">32 London Bridge Street</span></span></td>
<td align="left"><span data-ttu-id="ebfef-829">Dienstwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-829">Service dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-830">n/v</span><span class="sxs-lookup"><span data-stu-id="ebfef-830">N/A</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-831">Marcel Beauchamp</span><span class="sxs-lookup"><span data-stu-id="ebfef-831">Marcel Beauchamp</span></span></td>
<td align="left"><span data-ttu-id="ebfef-832">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-832">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-833">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-833">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-834">FR-Paris-Issy-39qdPR</span><span class="sxs-lookup"><span data-stu-id="ebfef-834">FR-Paris-Issy-39qdPR</span></span></td>
</tr>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-835">Rachelle Cormier</span><span class="sxs-lookup"><span data-stu-id="ebfef-835">Rachelle Cormier</span></span></td>
<td align="left"><span data-ttu-id="ebfef-836">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-836">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-837">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-837">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-838">FR-Paris-Issy-39qdPR</span><span class="sxs-lookup"><span data-stu-id="ebfef-838">FR-Paris-Issy-39qdPR</span></span></td>
</tr>
<tr class="even">
<td align="left"><span data-ttu-id="ebfef-839">Isabell Potvin</span><span class="sxs-lookup"><span data-stu-id="ebfef-839">Isabell Potvin</span></span></td>
<td align="left"><span data-ttu-id="ebfef-840">39 quai du Président Roosevelt</span><span class="sxs-lookup"><span data-stu-id="ebfef-840">39 quai du Président Roosevelt</span></span></td>
<td align="left"><span data-ttu-id="ebfef-841">Mandantenwählplan</span><span class="sxs-lookup"><span data-stu-id="ebfef-841">Tenant dial plan</span></span></td>
<td align="left"><span data-ttu-id="ebfef-842">FR-Paris-Issy-39qdPR</span><span class="sxs-lookup"><span data-stu-id="ebfef-842">FR-Paris-Issy-39qdPR</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-843">_Tabelle 14: Wählplanzuweisungen – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-843">_Table 14 Example of dial plan assignments_</span></span>


## <a name="microsoft-teams-configurations"></a><span data-ttu-id="ebfef-844">Microsoft Teams-Konfigurationen</span><span class="sxs-lookup"><span data-stu-id="ebfef-844">Microsoft Teams configurations</span></span>

<span data-ttu-id="ebfef-845">Da der Audiokonferenzdienst nur für geplante Besprechungen verfügbar ist, müssen Konfigurationen auf Mandantenebene aktiviert werden, die die Planung von Besprechungen (private und Kanalbesprechungen) steuern.</span><span class="sxs-lookup"><span data-stu-id="ebfef-845">Since Audio Conferencing is only available for scheduled meetings, tenant-level configurations that govern meeting scheduling (private and channel meetings) must be enabled.</span></span>


> [!NOTE]
> <span data-ttu-id="ebfef-846">Wenn Ihre Organisation Compliance-Anforderungen erfüllen muss, um sicherzustellen, dass alle Besprechungsdiskussionen gefunden werden können, sollten Sie private Besprechungen deaktivieren, wenn der Organisator über ein lokales Exchange-Postfach verfügt.</span><span class="sxs-lookup"><span data-stu-id="ebfef-846">Currently, if your organization has compliance requirements to ensure all meeting discussions are discoverable, you should disable private meetings if the organizer has an Exchange on-premises mailbox.</span></span><br><br>
> <span data-ttu-id="ebfef-847">Wenn in einem anderen Anwendungsfall alle Besprechungen in der Organisation nur für <strong>eingeladene Benutzer</strong> sichtbar sein müssen, empfehlen wir Ihnen, die Funktion zum Planen von Besprechungen in <strong>Kanälen</strong> zu deaktivieren, um die Offenlegung von Informationen für nicht eingeladene Benutzer zu vermeiden.</span><span class="sxs-lookup"><span data-stu-id="ebfef-847">In another use case, if all meetings in the organization must be visible <strong>to invited parties</strong> only, to avoid disclosing meeting information to uninvited parties, we recommend that you disable the ability to schedule meetings in <strong>channels</strong>.</span></span>

<span data-ttu-id="ebfef-848">Die als Konfigurationen auf Mandantenebene verfügbaren Einstellungen sind auf alle Benutzer in der Organisation anwendbar und wirken sich auf die gesamte Besprechungsplanung in Teams und nicht nur auf Teams-Besprechungen **mit** Audiokonferenzen aus.</span><span class="sxs-lookup"><span data-stu-id="ebfef-848">The settings, available as tenant-level configurations, are applicable to all users in the organization, and will impact all meeting scheduling in Teams, not specific to Teams meetings **with** Audio Conferencing.</span></span>

<table>
<thead>
<tr class="header">
<td align="left"><img src="media/audio_conferencing_image7.png" /></td>
<td align="left"><span data-ttu-id="ebfef-849">Entscheidungspunkt</span><span class="sxs-lookup"><span data-stu-id="ebfef-849">Decision Point</span></span></td>
<td align="left"><p><span data-ttu-id="ebfef-850">Legen Sie fest, ob es für die Organisation erforderlich ist, das Planen von privaten Besprechungen zu aktivieren oder zu deaktivieren.</span><span class="sxs-lookup"><span data-stu-id="ebfef-850">Decide if the organization requires to enable or disable scheduling of private meetings.</span></span></p>
<p><span data-ttu-id="ebfef-851">Legen Sie fest, ob es für die Organisation erforderlich ist, das Planen von Kanalbesprechungen zu aktivieren oder zu deaktivieren.</span><span class="sxs-lookup"><span data-stu-id="ebfef-851">Decide if the organization requires to enable or disable scheduling of channel meetings.</span></span></p></td>
</tr>
</thead>
<tbody>
<tr class="odd">
<td align="left"><img src="media/audio_conferencing_image9.png" /></td>
<td align="left"><span data-ttu-id="ebfef-852">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="ebfef-852">Next Steps</span></span></td>
<td align="left"><p><span data-ttu-id="ebfef-853">Dokumentieren Sie die Konfigurationen für die Besprechungsplanung für Teams.</span><span class="sxs-lookup"><span data-stu-id="ebfef-853">Document the meeting scheduling configurations for Teams.</span></span></p></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<td align="left"><span data-ttu-id="ebfef-854"><strong>Lassen Sie das Planen von privaten Besprechungen zu</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-854"><strong>Allow scheduling for private meetings</strong></span></span></td>
<td align="left"><span data-ttu-id="ebfef-855">Aktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-855">Enabled</span></span></td>
</tr>
</thead>
<thead>
<tr class="odd">
<td align="left"><span data-ttu-id="ebfef-856"><strong>Lassen Sie das Planen von Kanalbesprechungen zu</strong></span><span class="sxs-lookup"><span data-stu-id="ebfef-856"><strong>Allow scheduling for channel meetings</strong></span></span></td>
<td align="left"><span data-ttu-id="ebfef-857">Deaktiviert</span><span class="sxs-lookup"><span data-stu-id="ebfef-857">Disabled</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="ebfef-858">_Tabelle 15: Microsoft Teams-Besprechungskonfigurationen – Beispiel_</span><span class="sxs-lookup"><span data-stu-id="ebfef-858">_Table 15 Example of Microsoft Teams meetings configurations_</span></span>


## <a name="document-technical-implementation-plan"></a><span data-ttu-id="ebfef-859">Dokumentieren des Plans für die technische Implementierung</span><span class="sxs-lookup"><span data-stu-id="ebfef-859">Document technical implementation plan</span></span>

<span data-ttu-id="ebfef-860">Verwenden Sie die Entscheidungspunkte oben, um Ihren Plan zur technischen Implementierung zu dokumentieren.</span><span class="sxs-lookup"><span data-stu-id="ebfef-860">Use the decision points above to document your technical implementation plan.</span></span>

<span data-ttu-id="ebfef-861">Mit diesem Plan wird das Projektteam (mit FastTrack oder einem Bereitstellungspartner) mit Informationen zur Ausführung des technischen Onboardings für die Implementierung von Audiokonferenzen versorgt.</span><span class="sxs-lookup"><span data-stu-id="ebfef-861">This technical implementation plan will provide the project team, which can include FastTrack or a deployment partner, with the information required to execute the technical onboarding for the implementation of Audio Conferencing.</span></span>

<span data-ttu-id="ebfef-862">In der Regel enthält ein Plan zur technischen Implementierung die folgenden Hauptabschnitte:</span><span class="sxs-lookup"><span data-stu-id="ebfef-862">In general, a technical implementation plan will contain the following main sections:</span></span>

-   <span data-ttu-id="ebfef-863">Aktivierungsliste für Audiokonferenzdienst-Standorte</span><span class="sxs-lookup"><span data-stu-id="ebfef-863">Audio Conferencing service site enablement list</span></span>

-   <span data-ttu-id="ebfef-864">Lizenzzuweisungsliste für Besprechungsorganisatoren von Audiokonferenzen</span><span class="sxs-lookup"><span data-stu-id="ebfef-864">License assignment list for Audio Conferencing meeting organizers</span></span>

-   <span data-ttu-id="ebfef-865">Zahlen für die Planung des Kommunikationsguthabens</span><span class="sxs-lookup"><span data-stu-id="ebfef-865">Communications Credits planning numbers</span></span>

-   <span data-ttu-id="ebfef-866">Details zur Konferenzbrücke</span><span class="sxs-lookup"><span data-stu-id="ebfef-866">Conference bridge details</span></span>

-   <span data-ttu-id="ebfef-867">Einstellungen der Konferenzbrücke</span><span class="sxs-lookup"><span data-stu-id="ebfef-867">Conference bridge settings</span></span>

-   <span data-ttu-id="ebfef-868">Zuweisungen der Einstellungen für die Konferenzbrücke</span><span class="sxs-lookup"><span data-stu-id="ebfef-868">Conference bridge settings assignments</span></span>

-   <span data-ttu-id="ebfef-869">Mandantenwählpläne</span><span class="sxs-lookup"><span data-stu-id="ebfef-869">Tenant dial plans</span></span>

-   <span data-ttu-id="ebfef-870">Wählplanzuweisungen</span><span class="sxs-lookup"><span data-stu-id="ebfef-870">Dial plan assignments</span></span>

-   <span data-ttu-id="ebfef-871">Microsoft Teams-Besprechungskonfigurationen</span><span class="sxs-lookup"><span data-stu-id="ebfef-871">Microsoft Teams meetings configurations</span></span>

<span data-ttu-id="ebfef-872">Nach Abschluss des Erfolgsplans und des Plans zur technischen Implementierung können Sie Ihrer Organisation jetzt die nächsten Schritte entlang des Office 365 Customer Journey unterbreiten.</span><span class="sxs-lookup"><span data-stu-id="ebfef-872">With the completion of success plan and technical implementation plan, you are now ready to take your organization to the next steps along the Office 365 customer journey.</span></span>

<a name="onboard"></a><span data-ttu-id="ebfef-873">Onboarding</span><span class="sxs-lookup"><span data-stu-id="ebfef-873">Onboard</span></span>
=======

<span data-ttu-id="ebfef-874">*In Kürze verfügbar.*</span><span class="sxs-lookup"><span data-stu-id="ebfef-874">*Coming soon.*</span></span>

<a name="drive-value"></a><span data-ttu-id="ebfef-875">Höhere Wertschöpfung erzielen</span><span class="sxs-lookup"><span data-stu-id="ebfef-875">Drive Value</span></span>
===========

<span data-ttu-id="ebfef-876">*In Kürze verfügbar.*</span><span class="sxs-lookup"><span data-stu-id="ebfef-876">*Coming soon.*</span></span>



### <a name="see-also"></a><span data-ttu-id="ebfef-877">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="ebfef-877">See also</span></span>
[<span data-ttu-id="ebfef-878">Konfigurieren von Einwahl- oder PSTN-Konferenzen für Skype for Business</span><span class="sxs-lookup"><span data-stu-id="ebfef-878">Set up dial-in or PSTN conferencing for Skype for Business</span></span>](https://support.office.com/article/Set-up-audio-conferencing-for-Skype-for-Business-and-Microsoft-Teams-d01954f1-4f37-4cf5-a636-20039e5c59e9)
