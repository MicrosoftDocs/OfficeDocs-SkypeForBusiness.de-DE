...
![Greifbare Maßnahmen dividiert durch ein einzelnes Gefühl = Änderungs quotient](media/teams-adoption-change-quotient.png)
...
- Wählen **Teams Go Big**: In neuen Microsoft 365- oder Office 365-Kundenorganisationen ist es häufig am besten, einen Teams Go Big-Ansatz zu verwenden, um die Ermüdung von Veränderungen zu minimieren, die durch das mehrfache Erlernen neuer Technologien verursacht wird. Sie erhalten den größten Vorteil, indem Sie Teams sowohl für kernbezogene Zusammenarbeit als auch für Besprechungen, SharePoint, OneDrive, Planner und andere Workloads aktivieren und Ihren Mitarbeitern ermöglichen, im Kontext Ihrer Teams-Bereitstellung mehr darüber zu erfahren. 
...
- Wählen Sie nebeneinander **aus:** Für Organisationen, die Skype for Business für Audiokonferenzen, die Unterstützung für Konferenzraumgeräte oder Cloud-Sprachfunktionen verwenden, empfehlen wir die gleichzeitige Ausführung von Teams und Skype, um Ihre Mitarbeiter mit den grundlegenden Funktionen für die Zusammenarbeit vertraut zu machen, während Sie die Migration von Skype for Business zu einem Zeitpunkt planen, der für Ihr Unternehmen geeignet ist. Beachten Sie, dass die gleichzeitige Ausführung beider Clients beim Benutzer zu Verwirrung bei dem zu verwendende Tool führen kann. Daher wird empfohlen, diese Phase kurz zu halten. 
...
Nachdem Sie Ihre Aktivierungsstrategie ausgewählt haben, sind Sie bereit, die in Phase 1 getroffenen Governanceentscheidungen erneut zu überarbeiten und zu skalieren. Überarbeiten Sie die Entscheidungen 1 bis 6 im Schnellstart zu [Governance](teams-adoption-governance-quick-start.md) erneut, um diese Richtlinien in Übereinstimmung mit den Business-Benutzern zu erweitern, die ihre Teams. 
...
4. Erfassen Sie Feedback, und entwickeln Sie Mit Kenntnissen des Geschäftsbereichs, um den Übergang zu unterstützen,
