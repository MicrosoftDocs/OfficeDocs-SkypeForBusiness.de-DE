...
| Teams Erste | Teams Core | Teams Go Big | Skype nebeneinander | Migration |
|------------ | ---------- | ------------ | ------------------ | --------- |
...
2. Machen Sie sich mit den aktuellen Lösungen für häufige Szenarien (E-Mail, SharePoint, Yammer und andere Produkte) aus.
