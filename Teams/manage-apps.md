...
Das **Widget "Ausstehende Genehmigungen**" auf der Seite "Apps verwalten" benachrichtigt Sie, wenn ein Entwickler eine App über die API Teams App-Übermittlung übermittelt. Eine neu übermittelte App wird mit dem **Veröffentlichungsstatus** **Übermittelt und** dem **Status Blockiert** **aufgelistet**. Wechseln Sie zur Seite mit den App-Details, um weitere Informationen zu der App anzuzeigen, und legen Sie dann den Veröffentlichungsstatus **auf Veröffentlichen** **festgelegt**.
