...
Es ist einfach, ihre Telefonnummern von Ihrem aktuellen Dienstanbieter in Microsoft Teams zu übertragen. Nachdem Sie Ihre Telefonnummern in Teams portiert haben, wird Microsoft Ihr Dienstanbieter und berechnet Ihnen diese Telefonnummern.
  
Bevor Sie mit dem Übertragen von Telefonnummern beginnen, sollten Sie die Informationen unter [Transferring phone numbers common questions](transferring-phone-numbers-common-questions.md) lesen.Wenn Sie über Servicenummern für Einwahlkonferenzbrücken oder automatische Telefonzentralen bzw. Wenn Sie über Servicenummern für Einwahlkonferenzen, automatische Telefonzentralen oder andere Dienstnummern, gebührenfreie Telefonnummern oder über mehr als 999-Telefonnummern verfügen, die Sie an Teams übertragen müssen, lesen Sie [Verwalten von Telefonnummern für Ihre Organisation](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) , um die richtigen Formulare herunterzuladen und an uns zu senden.
...
## <a name="how-to-create-a-port-order-and-transfer-your-phone-numbers-to-teams"></a>So erstellen Sie einen Portierungs Auftrag und übertragen ihre Telefonnummern in Teams
...
2. Navigieren Sie in der linken Navigationsleiste zu **VoIP** > **Portierungsanträge** und klicken Sie auf **Hinzufügen**.

3. Lesen Sie die Informationen auf der Seite **Antrag zur Portierung der neuen lokalen Rufnummern** und klicken Sie anschließend auf **Erste Schritte**.

4. Geben Sie auf der Seite **Kontoinformationen** die folgenden Informationen ein und klicken Sie anschließend auf **Weiter**:
...
6. Geben Sie auf der Seite **Telefonnummern** die Telefonnummern, die Sie übertragen möchten, im E.164-Format ein. Verwenden Sie beispielsweise für eine Telefonnummer aus Nordamerika das Format +1XXXYYYZZZZ. Verwenden Sie ein Komma, um mehrere Telefonnummern voneinander zu trennen.
...
8. Wählen Sie auf der Seite **Transfer Datum** in der Dropdownliste **Tag** das Datum aus, und wählen Sie unter der Dropdownliste **Startzeit** die Uhrzeit (EST) aus, und klicken Sie dann auf **weiter**.
 ...
 **Was soll ich tun, wenn die Bearbeitung meines Auftrags zu lange dauert?** Wir möchten, dass die Nummernportierung ein sehr einfacher und schneller Vorgang ist. Wenn Ihre Bestellung länger als erwartet dauert und der Status im Skype for Business Admin Center noch nicht vollständig angezeigt wird, öffnen Sie bitte ein Support Ticket und schließen Sie die Port Order ID ein.
