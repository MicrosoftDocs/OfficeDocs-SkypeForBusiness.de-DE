...
- Teams mobiler Client für Android-Client und Google Play Store-Version 1416/1.0.0.2019121201 und höher
...
- Mit Operator Verbinden Benutzer&mdash; die Funktionen ausstehen, die der Nummer zugewiesen sind, wenn sie vom Netzbetreiber in das Inventar eines Kunden hochgeladen werden.
...
Damit ein Client einen Standort erhält, müssen Sie das LIS mit Netzwerk-IDs (Subnetzen, WAPs, Schaltern, Ports) und Notfallstandorten füllen. Sie können dies im Microsoft Teams Admin Center oder mithilfe von PowerShell tun.

### <a name="using-the-microsoft-teams-admin-center"></a>Verwenden des Microsoft Teams Admin Centers

1. Navigieren Sie im linken Navigationsbereich zu **LocationsNetworks** >  **& Speicherorte**.
...
- **Richtlinie zum Routing von Notrufen – Gilt nur für direktes Routing**. Mit dieser Richtlinie werden Notfallnummern, Masken pro Nummer bei Bedarf und die PSTN-Route pro Nummer konfiguriert. Sie können diese Richtlinie Benutzern, Netzwerkwebsites oder beiden zuweisen. Weitere Informationen finden Sie unter [Verwalten von Richtlinien für das Routing von Notrufen für direktes Routing](manage-emergency-call-routing-policies.md).  
