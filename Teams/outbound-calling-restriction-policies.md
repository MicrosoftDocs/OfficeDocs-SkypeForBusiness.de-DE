...
2.  <span data-ttu-id="dc7e7-133">Klicken Sie im Bereich „Aktion" auf **Bearbeiten**.</span><span class="sxs-lookup"><span data-stu-id="dc7e7-133">In the Action pane, click **Edit**.</span></span>
