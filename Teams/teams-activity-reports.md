...
|**6**   |Sie können die im Diagramm angezeigte Datenreihe filtern, indem Sie in der Legende auf ein Element klicken. Beispielsweise das Diagramm **Verteilung** klicken Sie oder tippen Sie auf **Windows**, **Mac**, **Web**, **iOS**und **Android** , um nur die Informationen im Zusammenhang mit jeweils finden Sie unter. Das Ändern dieser Auswahl ändert nicht die Informationen in der Tabelle Raster. |
