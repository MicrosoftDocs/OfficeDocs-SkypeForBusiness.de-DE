...
Weitere Informationen zur Unterstützung der Anrufsteuerung mit Teams finden Sie [unter Steueranrufe mit einem Headset in Teams](https://support.office.com/article/Control-calls-using-a-headset-in-Teams-65d6e104-444d-4013-b8c2-f11317dd69a8).
...
Benutzer müssen zuvor zertifizierte Geräte beim Upgrade auf Teams von Skype for Business nicht ersetzen.  Alle zertifizierten Geräte werden für Microsoft Teams und Skype for Business Benutzer unterstützt, mit nur wenigen Unterschieden.  Die Zertifizierung bietet auch eine weitere Bezeichnung für bestimmte Gerätekategorien.

- **Skype for Business zertifiziert mit Teams Upgrade** Geräte, die auf dieser Stufe zertifiziert wurden, wurden zunächst für Skype for Business zertifiziert. Microsoft hat mit Geräteherstellern zusammengearbeitet, um die bestmögliche Teams Integrationserfahrung ohne Änderungen an der ursprünglichen Hardware bereitzustellen. Die *Hookswitch-Schaltfläche* fungiert als Teams-Schaltfläche, wenn sie nicht in einem Anruf ist, und kann im Laufe der Zeit weitere Funktionen enthalten.  Geräte in dieser Kategorie können den Teams Zertifizierungsausweis auf Marketingmaterialien tragen.
- **Zertifiziert für Microsoft Teams** Geräte, die auf dieser Ebene zertifiziert sind, weisen sie auf die neuesten zertifizierten Geräte hin, um eine Teams zu ermöglichen. Diese Geräte bieten alle Vorteile der vorherigen Zertifizierung und enthalten auch eine dedizierte Teams-Taste mit LED-Indikator. Bei den meisten Formfaktoren ist die Teams Schaltfläche eine leicht zu findende taktile Schaltfläche mit dem Teams Logo. Microsoft arbeitet weiterhin mit Geräteherstellern zusammen, um im Laufe der Zeit neue Werte über Firmwareupdates bereitzustellen.
...
- Dedizierte Teams-Taste und LED-Anzeigeleuchte.
...
|NEC                  |WD551-Windows-Anzeige für zusammenarbeit                        |5/21/2021       |Zertifiziert für Microsoft Teams                           |
...
| EPOS/Sennheiser     | Auswirkung sc 45                                              | 4/9/2020       | Skype for Business mit einem Upgrade auf Microsoft Teams     |
