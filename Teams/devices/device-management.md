...
## <a name="manage-teams-rooms-devices"></a>Verwalten Teams-Räume Geräte
...
Hier finden Sie einige Dinge, die Sie zum Verwalten Ihrer Teams-Räume können. Teams-Räume Geräte finden Sie im [Microsoft Teams Admin Center](https://admin.teams.microsoft.com) **unter** Geräte  >  **Teams-Räume.**
...
| Anzeigen von Besprechungsdetails                   | Wählen Sie einen Gerätenamen aus, um Gerätedetails zu öffnen, > **Sie >** wählen Sie eine Besprechung aus. Wenn Sie die Details einer Besprechung öffnen, können Sie alle Teilnehmer an der Besprechung, die Dauer des Anrufs, die Teams-Sitzungstypen und die individuelle Anrufqualität sehen. Wenn Sie technische Informationen zum Anruf eines Teilnehmers sehen möchten, wählen Sie die Startzeit des Anrufs des Teilnehmers aus. |
...
1. Wechseln Sie in der linken **Navigationsleiste** zu Geräte, > Sie die Teams ihres > **aus.** Wählen Sie beispielsweise **Geräte**  >  **und Teams**  >  **Konfigurationsprofile aus,** um ein neues Konfigurationsprofil für die Teams erstellen.
...
1. Wechseln Sie in der linken **Navigationsleiste** zu > wählen Sie den Teams aus. Um beispielsweise einem Gerät mit Teams ein Konfigurationsprofil zuzuordnen, wählen Sie Geräte   >  **Teams aus.**
