...
description: Dieser Artikel bietet eine Übersicht über die features, die von Microsoft Teams werden.
ms.openlocfilehash: fe9d482cdce9cce9aa7f31735267b57f2e675c1c
ms.sourcegitcommit: 97c2faab08ec9b8fc9967827883308733ec162ea
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 08/13/2021
ms.locfileid: "58233060"
---
...
- **Reservieren Sie verfügbare Besprechungsräume für Ad-hoc-Besprechungen.** Mithilfe des Touchscreenbereichs können Sie einen verfügbaren Besprechungsort an Ort  und Stelle für eine Ad-hoc-Besprechung reservieren und über die Microsoft Teams-Räume- oder Surface Hub-Geräte an dieser Teams-Besprechung teilnehmen.
...
- **Barrierefreiheit.** Teams-Panels verfügen über verschiedene Barrierefreiheitsfunktionen, z. B. Text mit hohem Kontrast, damit sie für jeden leichter zu verwenden sind.
...
> [!Note]
> Wenn Sie bereits Microsoft Teams-Räume besprechungsraum bereitgestellt haben, in dem Sie Teams-Panels installieren, benötigen Sie keine zusätzliche Lizenz, um die Teams verwenden zu können.
...
- [Inventar des Besprechungsraums](#inventory-sites-and-meeting-spaces)und Planung von Funktionen: Erstellen Sie eine Bestandsaufnahme der Standorte und Besprechungsräume Ihrer Organisation für die Bereitstellung Teams Geräte.
...
Machen Sie eine Bestandsaufnahme der vorhandenen buchbaren Besprechungsräume in Ihrer Organisation. Identifizieren Sie die Websites und Besprechungsräume, die für die Bereitstellung Teams sind. Arbeiten Sie mit Ihren Einrichtungen und audio-visuellen Teams zusammen, um zu bestimmen, wo und wie die Teams-Panels-Geräte installiert werden und ob zusätzliche Hardware für die Aufnahme der Panels erforderlich ist.

## <a name="procurement"></a>Beschaffung

Beschaffen Sie die Geräte auf der Grundlage der Anzahl der Besprechungsräume, die zum Bereitstellen von Teams-Panels gehören, von einem der Partner, die für die Teams [zertifiziert sind.](#partners-certified-for-teams-panels) Besuchen Sie die Websites der Partner, um mehr über die Geräte und Beschaffungsoptionen zu erfahren.
...
Für jedes Teams-Panels ist ein Konto Microsoft 365 Raumressourcen erforderlich. Sie verwenden die Anmeldeinformationen für das Ressourcenkonto, um sich auf Microsoft Teams Panels bei einer App anmelden.
...
> [!TIP]
> Es wird empfohlen, das Ressourcenkonto bereits vor der tatsächlichen Installation Teams Ressourcenpanels zu erstellen.
...
Um Ihre Geräte Teams-Panels zu verwalten, wechseln Sie in der linken Navigationsleiste Microsoft Teams Admin Center zu Geräte  >  **Teams Panels**. Hier können Sie das Gerätekonfigurationsprofil ändern, Updates verwalten, Geräte neu starten, Gerätetags hinzufügen und entfernen und vieles mehr. Weitere Informationen finden Sie unter [Verwalten ihrer Geräte in Teams.](device-management.md)
...
[Teams Marketplace für Panels](https://www.microsoft.com/microsoft-teams/across-devices/devices/product?deviceid=815)
