---
title: Teams-Geräte für Bildungseinrichtungen
author: dstrome
ms.author: dstrome
manager: serdars
ms.date: 08/3/2021
...
ms.reviewer: ''
description: Beschreibt die potenziellen Nutzungsmöglichkeiten und Vorteile von Teams-Räume Systemen und Geräten in verschiedenen Räumen und Einrichtungsräumen für Lehrkräfte.
ms.collection:
- M365-voice
- M365-collaboration
f1.keywords:
...
- Microsoft Teams-Räume sicheres, schülerorientiertes Lernen ermöglichen, von der Klassenintegration bis hin zu Gruppenräumen für eine fokussiertere Zusammenarbeit und sogar Einzelunterricht, um bestimmte Anforderungen und Fragen von Kursteilnehmern zu erfüllen.
...
Um sicherzustellen, dass Studenten und Lehrkräfte, die remote arbeiten, vollständig an der Zusammenarbeit und an Besprechungen in Gruppen teilnehmen können, benötigen Bildungsarbeitsbereiche Technologie, um die Kluft zwischen den alten, persönlich-modellen und den neuen, hybriden und remoten Räumen zu überbrücken.
...
Physische Räume sind so konzipiert, dass sie die Arten von Aktivitäten aufnehmen, die dort stattfinden werden. Unterschiedliche Arten von Aktivitäten oder Verbindungen können unterschiedliche Besprechungsverhalten erleichtern. Ein Klassenzimmer sieht zum Beispiel viel anderes Verhalten als das eines Sitzungssaals.

Möbel helfen zu definieren, wie ein Raum genutzt werden soll. Möbel und Oberflächen sind wichtig zu berücksichtigen, damit ein Klassenzimmer oder Besprechungsraum effektiv ist.

Bei vorhandenen Räumen sollte die Technologie am vorhandenen Layout des Raums ausgerichtet werden. Wenn beispielsweise Tische und Stühle für Präsentationen und In-Person-Unterricht eingerichtet sind, sollte die Technologie folgen. Mikrofone und Kameras müssen optimal im Raum positioniert werden und nicht einfach überall hin hinzugefügt werden, wo sie passen, ohne zu berücksichtigen, wie der Raum genutzt wird. Remoteteilnehmer müssen das Präsentationsmaterial genauso deutlich sehen wie die Teilnehmer vor Ihrer Person.
...
Ein öffentlicher Raum, z. B. ein Gemeinschaftsraum in einem Familienhaus oder ein Tisch in einer Bibliothek, bedeutet in der Regel, dass Benutzer mit Lärm, einem Mangel an einem permanenten Arbeitsbereich und anderen potenziellen Ablenkungen zu kämpfen haben.

![Abbildung eines Schülers, der mit einem persönlichen PC und Headset arbeitet.](media/devices4.png)
...
Ein Laptop mit Teams stellt sicher, dass der Benutzer nicht auf einen Arbeitsbereich beschränkt ist und seine Einrichtung verschieben kann, ohne sich bei Besprechungen anmelden und abmelden zu müssen. Ein Headset mit integriertem Mikrofon schränkt Audio auf Besprechungsteilnehmer ein und filtert Hintergrundgeräusche. Die integrierte Kamera des Laptops stellt sicher, dass der Benutzer von allen Besprechungsteilnehmern gesehen werden kann.
...
Sehr einfach. Dies ist etwas, das vollständig von Endbenutzern behandelt werden kann, indem sie ihren PC einfach mit einem zertifizierten Headset für Audio- und Videoanrufe kämmen.

### <a name="personal-space"></a>Persönlicher Raum

Ein persönlicher Raum kann alles sein, vom Schlafzimmer eines Schülers bis zum Büro eines Lehrers. Persönliche Räume bedeuten im Allgemeinen, dass der Benutzer in seiner Arbeits- oder Lernumgebung sowie in einem dedizierten Arbeitsbereich Datenschutz hat.
...
Ein persönlicher PC mit einer hochwertigen USB-Kamera und einem separaten USB-Freisprechgerät.

*Warum dieses Layout und dieser Gerätetyp?*

Ein kleinerer, ruhigerer, fokussierterer persönlicher Raum bedeutet, dass der Benutzer nicht die Ablenkungen öffentlicher freigegebener Räume oder eines herkömmlichen Klassenzimmers hat. Ein PC mit Teams ermöglicht einen dedizierten Arbeitsbereich, und eine USB-Kamera stellt sicher, dass der Benutzer in hoher Qualität in der Besprechung zu sehen ist. Ein Freisprechgerät eignet sich am besten in privaten Räumen, in denen Besprechungsaudio nicht mit anderen Geräuschen und Ablenkungen konkurrieren muss.
...
- [Poly-Freisprecheinrichtung – Sync 20](https://www.microsoft.com/microsoft-teams/across-devices/devices/product/poly-sync-20/825)
...
Diese Lösung dient demselben Zweck wie Beispiel A und bezieht sich auf einen fokussierten persönlichen Bereich. Ein PC mit Teams ermöglicht einen dedizierten Arbeitsbereich in Kombination mit einer Kombination aus USB-Kamera, Mikrofon und Lautsprecher-Soundleiste.
...
Sehr einfach. Dies kann vollständig von Endbenutzern gehandhabt werden, indem sie ihren PC mit den zertifizierten USB-Peripheriegeräten kämmen. Kameras und persönliche Soundbars können problemlos über dem Display montiert werden.
...
Ein Kursraum, der sowohl für Personenteilnehmer als auch für Remoteteilnehmer konzipiert ist, mit einem Layout, in dem ein einzelner Lehrer gleichzeitig auf beide Gruppen zutrifft.
...
- Touch-Konsole für Raumsteuerung – [Logitech TAP](https://www.logitech.com/products/video-conferencing/room-solutions/tap.html?crid=1691)

*Diese Lösung wird installiert oder eingerichtet:*

Komplex. Dieser Raum verfügt über eine physische Installation, einschließlich Verdrahtung, die einen sachkundigen AV-Bereitstellungspartner erfordert, um die Kamera- und Audiolösungen ordnungsgemäß zu planen und bereitzustellen, damit sie nahtlos für die Endbenutzer im Raum funktionieren.

### <a name="lecture-halls"></a>Hörsäle
...
Ein Hörsaal, der sowohl für teilnehmerbezogene als auch für remote Studierende konzipiert ist, mit einem Layout, in dem ein einzelner Dozent beide Gruppen gleichzeitig adressiert, sowie Inhalte über eine Touchoberfläche erstellt und kommentiert.

*Warum dieses Layout und dieser Gerätetyp?*

Remoteteilnehmer können über die montierte Kamera dasselbe Sichtfeld sehen, das die Teilnehmer vor Ort haben. Der Dozent kann die Fernstudenten über ihre Kameras auf einem Bildschirm sehen. Ein dedizierter Präsentationsbildschirm und ein Touchscreen für Whiteboarding zeigen das Lehrmaterial des Dozenten für alle an. Deckenkachelmikrofone und leistungsstarke Lautsprecher sorgen dafür, dass der Dozent und alle Fragen der Schüler klar zu hören sind.
...
- Installed Audio – [QSC und Sennheiser für große Räume](https://www.microsoft.com/microsoft-teams/across-devices/devices/product/qsc-meeting-room-audio-in-ceiling-speakers/701)
