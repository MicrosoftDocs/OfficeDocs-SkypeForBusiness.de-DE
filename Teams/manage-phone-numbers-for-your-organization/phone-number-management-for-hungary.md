...
|Lassen Sie Telefonnummern an uns übertragen.<br/> | Laden Sie dieses Formular herunter. <br/>[Genehmigungsschreiben für Ungarn (alle Nummern) (v.1.0) (hu-hu)](https://download.microsoft.com/download/f/b/1/fb17b2df-b5cf-45b7-89f0-0cbf250df1f7/letter-of-authorization-(loa)-for-hungary-(all-numbers)-(v1.0)-(hu-hu)%20(1).pdf) <br/> <br/>Füllen Sie sie aus, [und wenden Sie sich an den TNS Service Desk, um Anweisungen zu erhalten](contact-tns-service-desk.md). <br/><br/>Die Übertragung von Nummern kann in diesem Markt zwei bis drei Wochen dauern. <br/><br/>Diese Nummern können derzeit nicht für Konferenzen verwendet werden.   |
