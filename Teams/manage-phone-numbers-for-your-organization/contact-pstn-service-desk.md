...
- **[Erstellen Sie einen neuen Fall](#create-a-new-case)** – Übermitteln einer neuen Anfrage oder einer allgemeinen Anfrage. 

- **[Meine vorhandenen Fälle anzeigen](#view-and-manage-existing-cases)**– Ihre vorhandenen Fälle nachverfolgen und überwachen. 

- **[Meine vorhandenen Fälle anzeigen](#view-and-manage-existing-cases)** – Ihre vorhandenen Fälle nachverfolgen und überwachen. Wenn Ihre Kollegen aus Ihrem Unternehmen Fälle geöffnet haben, können Sie diese in dieser Ansicht nachschlagen.  
...
Beschreiben Sie, was Sie erreichen möchten, und listen Sie Ihre Fragen für den Microsoft PSTN Service Desk auf.  
...
- **Kommunizieren Sie mit dem PSTN Service Desk** bezüglich Ihres Falls, indem Sie einen vorhandenen Fall öffnen, nach unten scrollen und **Kommentar hinzufügen** auswählen. Ein neues Fenster wird angezeigt. Geben Sie Ihre Nachricht in das Kommentarfeld ein. Fügen Sie alle unterstützenden Dokumente (sofern verfügbar) an, die bei Ihrer Anforderung hilfreich sein können, und wählen Sie **Submit** aus.  

  Antworten vom PSTN Service Desk werden unter derselben Zeitachse angezeigt. Wenn in Ihrem Fall ein Update vorhanden ist, erhalten Sie eine automatisierte E-Mail-Benachrichtigung über das Update. 
...
- Unterstützung im Zusammenhang mit der Einrichtung und Konfiguration von Nummern, Lizenzen, Gebühren oder Abrechnung finden Sie unter [Supportkontakt für Geschäftsprodukte – Administratorhilfe](/microsoft-365/admin/contact-support-for-business-products?tabs=online&view=o365-worldwide).
