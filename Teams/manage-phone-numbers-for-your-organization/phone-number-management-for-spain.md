...
|:-----|:-----|
|Rufen Sie neue Benutzer- oder Diensttelefonnummern ab, die nicht im Microsoft Teams Admin Center aufgeführt sind.   <br/> | Laden Sie eines dieser Formulare herunter.</br> [Anforderung einer neuen Telefonnummer für Spanien (v.5.0) (es-es)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-spain-(v.5.0)-(es-es).pdf?raw=true) <br/>  [Anforderung einer neuen Telefonnummer für Spanien (v.5.0) (en-us)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-spain-(v.5.0)-(en-us).pdf?raw=true)<br/><br/>    Füllen Sie das Feld aus, und wenden Sie sich [an den PTSN Service Desk, um Anweisungen zu erhalten.](contact-pstn-service-desk.md)  <br/> |
|Lassen Sie Telefonnummern an uns übertragen.  <br/> |Laden Sie dieses Formular herunter. <br/>[Genehmigungsschreiben für Spanien (alle Nummern) (v.5.0)(es-es)](https://download.microsoft.com/download/e/8/b/e8bd034a-c5fa-4da2-8fd6-3dd13988b834/letter-of-authorization-(loa)-for-spain-(all-numbers)-(v.5.0)-(es-es).pdf)<br/><br/> Füllen Sie die Angaben aus, und wenden Sie sich [an den PTSN Service Desk, um Anweisungen](contact-pstn-service-desk.md)zu[erhalten.](mailto:ptneu@microsoft.com) <br/> |
