...
|:-----|:-----|
|Holen Sie sich neue Telefonnummern für Benutzer und Dienste, die im Microsoft Teams Admin Center nicht aufgelistet sind.   <br/> |Laden Sie eines dieser Formulare herunter. <br/>  [Neue Telefonnummernanforderung für Dänemark (v.5.0) (da-dk)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-denmark-(v.5.0)-(da-dk).pdf?raw=true) <br/>[Neue Telefonnummernanforderung für Dänemark (v.5.0) (en-us)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/new-number-request-forms/new-phone-number-request-for-denmark-(v.5.0)-(en-us).pdf?raw=true)<br/><br/>  Füllen Sie das Formular aus, und [senden Sie es an uns](mailto:ptneu@microsoft.com).
|Übertragen Sie uns Telefonnummern.  <br/> | Laden Sie dieses Formular herunter. <br/>[LoA (Letter of Authorization) für Dänemark (alle Nummern) (v.5.0) (da-dk)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/LOA-forms/letter-of-authorization-(loa)-for-denmark-(all-numbers)-(v.5.0)-(da-dk).pdf?raw=true) <br/> <br/>Füllen Sie das Formular aus, und [senden Sie es an uns](mailto:ptneu@microsoft.com). <br/> |
