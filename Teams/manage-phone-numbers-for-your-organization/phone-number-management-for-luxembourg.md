---
title: Telefon der Nummerverwaltung für Luxemburg
author: SerdarSoysal
ms.author: serdars
manager: serdars
...
# <a name="phone-number-management-for-luxembourg"></a>Telefon der Nummerverwaltung für Luxemburg
...
|Lassen Sie Telefonnummern an uns übertragen.| Laden Sie dieses Formular herunter. <br/>[Genehmigungsschreiben für Luxemburg (alle Nummern) (v.1.0) (en-lu)](https://download.microsoft.com/download/5/d/e/5dec4f65-c5a9-4dae-a576-56c737f739d2/letter-of-authorization-(loa)-for-luxembourg-(all-numbers)-(v1.1)-(en-lu).pdf) <br/> <br/>Füllen Sie sie aus, [und wenden Sie sich an den TNS Service Desk, um Anweisungen zu erhalten](contact-tns-service-desk.md). <br/><br/>Die Übertragung von Nummern kann in diesem Markt zwei bis drei Wochen dauern.<br/><br/>Diese Nummern können derzeit nicht für Konferenzen verwendet werden.    |
