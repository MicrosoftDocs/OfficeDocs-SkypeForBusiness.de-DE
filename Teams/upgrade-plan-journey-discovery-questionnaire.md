...
> | Frage | Antwort | Kommentare |
> |---|---|---|
> | Wie (oder wie) werden die Benutzer im Gültigkeitsbereich der Migration <br>Zugriff auf Teams, wenn sie im Büro sind? <br/>Wählen Sie alle anzuwendende Option aus. | <input type="checkbox"> Routed NAT connection <br/> <input type="checkbox"> Proxyserver <br/> <input type="checkbox"> Öffentliche Wi-Fi <br/> <input type="checkbox"> Verwaltete (nicht öffentliche) Wi-Fi <br/> <input type="checkbox"> ExpressRoute (Microsoft-Peering) ||
