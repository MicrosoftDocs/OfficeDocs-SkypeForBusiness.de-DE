...
Sie können das Microsoft Teams [Admin Center](#using-the-microsoft-teams-admin-center) oder [PowerShell](#using-powershell) verwenden, um ihr Location-Based aktivieren.
...
Zum Erzwingen Location-Based Routings für bestimmte Benutzer richten Sie die Sprachrichtlinie der Benutzer ein, um die gebührenpflichtige Umgehung der PTSN zu verhindern. 
