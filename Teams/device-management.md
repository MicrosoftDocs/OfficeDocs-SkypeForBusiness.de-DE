...
|---------|---------|
|Ändern von Geräteinformationen   | Wählen Sie ein Gerät > **Bearbeiten**aus. Sie können Details wie Gerätename, Benutzerinformationen, Inventar Kategorien und Notizen bearbeiten.     |
...
|Starten eines Geräts   |Wählen Sie einen Geräte > **Neustart**aus.          |
|Geräte Verlauf anzeigen  | Wählen Sie ein Device->- **Protokoll**aus. Sie können den Updateverlauf für das Gerät anzeigen.     |
|Anzeigen von Diagnosen  | Wählen Sie eine Geräte >- **Diagnose**aus.        |
...
![Ein Symbol mit dem Microsoft Teams-Logo](media/teams-logo-30x30.png) Verwenden des Microsoft Teams & Skype for Business Admin Center
