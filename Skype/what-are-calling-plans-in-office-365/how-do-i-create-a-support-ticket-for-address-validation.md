---
title: "Wie erstelle ich ein Support-Ticket für die Adressvalidierung?"
ms.author: tonysmit
author: tonysmit
ms.date: 11/21/2017
...
3. Klicken Sie auf **Hinzufügen**, wählen Sie unter **Serviceanfragen**
    
4. Klicken Sie auf der Seite **Erstellen Sie eine Serviceanfrage** auf **Onlinezusammenarbeit**.
...
5. Wählen Sie auf der Seite **Das Problem identifizieren** Folgendes aus, bzw. geben Sie Folgendes ein:
  ...
  - Geben Sie **Zusammenfassung Problem** **Adressüberprüfung** aus.
...
6. Auf der **nächsten** Seite, und klicken Sie auf **Ja, fortsetzen**, um den Vorgang fortzusetzen.
    
7. Klicken Sie auf der Seite **Details hinzufügen** wählen Sie aus, und geben Sie Folgendes ein:
