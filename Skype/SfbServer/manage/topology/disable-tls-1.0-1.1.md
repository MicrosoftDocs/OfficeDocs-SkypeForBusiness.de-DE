...
- Skype für Business 2016 klicken Sie auf Ausführen, sind die [April 2018](https://docs.microsoft.com/en-us/officeupdates/release-notes-office365-proplus) -Updates erforderlich: 
...
- Skype-Chatroom-System (auch bekannt als 'SRSv2' oder Rigel)
- Surface Hub
...
#### <a name="call-quality-dashboard"></a>* Qualitätsdashboard aufrufen
...
Wir möchten die übliche Reihenfolge der Vorgänge von "innen nach außen" führen für das Upgrade von Skype für Unternehmensserver. Behandeln von Director-Pools, Pchat und gepaart Pools in die gleiche Weise wie gewohnt verwenden. Reihenfolge und Methoden für das Upgrade fallen [hier](topology.md) und [hier](https://support.microsoft.com/en-us/help/3061064/updates-for-skype-for-business-server-2015).
...
Nachdem TLS 1.0 und 1.1 in Ihrer Umgebung deaktiviert haben, stellen Sie sicher, dass alle Ihre wichtigsten Arbeitslasten wie Sofortnachrichten und Anwesenheit, P2P erwartungsgemäß funktionieren, aufruft, Enterprise-VoIP usw..
...
1. Laden und SQL Express 2014 SP2 (SQLEXPR_x64.exe) in lokalen Ordner auf FE kopieren. Nehmen wir an Ordnerpfad < SQL_FOLDER_PATH >.
