...
4. Geben Sie die PIN-Nummer für Ihre Smartcard ein, und klicken Sie dann auf **"OK".**
    ...
    > [!NOTE]
    > Wenn Ihrer Supportperson keine Smartcard-PIN-Nummer zugewiesen wurde, verwenden Sie den Standardwert, der 12345678 ist. 
