...
Skype for Business Server ermöglicht es Ihnen, einen Server offline zu schalten (z. B. Software- oder Hardwareupgrades anzuwenden), ohne dass der Dienst für Benutzer verloren geht.
