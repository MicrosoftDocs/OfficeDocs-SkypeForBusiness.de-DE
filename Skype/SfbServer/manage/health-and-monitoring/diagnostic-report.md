...
Auf den Diagnosebericht kann zugegriffen werden, indem Sie im [Detailbericht über Peer-to-Peer-Sitzungen in Skype for Business Server](peer-to-peer-session-detail-report.md) oder im Konferenz Detailbericht auf die Metrik für den Diagnosebericht (Detail) klicken.
...
|**Application** <br/> |Nein  <br/> |Anwendung, die am Fehler beteiligt ist.  <br/> |
...
Eine Liste der Diagnosefehler finden Sie auf der [Kopfzeilenseite der MS-Diagnostics](https://msdn.microsoft.com/library/gg132446%28v=office.12%29.aspx).
