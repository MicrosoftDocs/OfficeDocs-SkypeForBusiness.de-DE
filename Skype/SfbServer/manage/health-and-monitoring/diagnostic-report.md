...
Auf den Diagnosebericht kann zugegriffen werden, indem Sie auf die Metrik "Diagnosebericht (Detail) " im [Detailbericht über Peer-to-Peer-Sitzungen in Skype for Business Server](peer-to-peer-session-detail-report.md) oder im Detaillierten Konferenzbericht klicken.
...
Eine Liste der Diagnosefehler finden Sie auf der [Kopfzeile "Ms-Diagnostics"](/openspecs/office_protocols/ms-ocer/f6787b39-0842-43ca-94a2-6afadda5f0a3).
