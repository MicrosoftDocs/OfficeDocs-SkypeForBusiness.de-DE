...
**Zusammenfassung:** Lernen Sie die Aufzeichnung von kommunikationsdatensätzen (CDR) Datensätze in Skype für Business Server verwendet wird.
  
Bei der KDS (Aufzeichnung von Kommunikationsdatensätzen) werden Nutzungs- und Diagnoseinformationen über Peer-to-Peer-Aktivitäten wie Chats, VoIP-Anrufe, Anwendungsfreigaben, Dateiübertragungen und Besprechungen aufgezeichnet. Anhand der Nutzungsdaten kann die Rendite berechnet werden und die Diagnosedaten können zur Problembehandlung bei Peer-to-Peer-Aktivitäten und Besprechungen genutzt werden. Wenn Sie Skype für Business Server installieren, installieren Sie auch eine vordefinierte Sammlung von globalen Konfigurationseinstellungen für CDR. In den Themen in diesem Abschnitt wird beschrieben, wie KDS konfiguriert wird.
  
## <a name="in-this-section"></a>Inhalt dieses Abschnitts

- [Ansicht KDS-Konfigurationsinformationen in Skype für Business Server](view-configuration-information.md)
    
- [Aktivieren Sie die Aufzeichnung von kommunikationsdatensätzen in Skype für Business Server](enable-cdr.md)
    
- [Erstellen oder Ändern einer Auflistung von KDS-Konfigurationseinstellungen in Skype für Business Server](create-or-modify-a-collection-of-settings.md)
    
- [Löschen einer vorhandenen Auflistung von KDS-Konfigurationseinstellungen in Skype für Business Server](delete-configuration-settings.md)
