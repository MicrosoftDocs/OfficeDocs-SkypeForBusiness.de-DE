...
## <a name="removing-qoe-configuration-settings-by-using-windows-powershell-cmdlets"></a>Entfernen von QoE-Konfigurations-Einstellungen mithilfe von Windows PowerShell Cmdlets
