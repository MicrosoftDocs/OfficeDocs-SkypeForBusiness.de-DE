...
Wenn Sie Probleme beim Suchen einer Metrik haben, geben Sie einen Teil der Metrikbezeichnung in das Suchfeld ein, und klicken Sie dann auf **"Suchen**". Wenn Sie beispielsweise die Metrik "Low SNR time" nicht finden können, geben Sie "SNR" in das Suchfeld ein, und klicken Sie dann auf **"Suchen**".
  
Beachten Sie, dass der Bericht nur Informationen zu einem Anruf verfolgt. Der Anruf selbst wird nicht aufgezeichnet.
