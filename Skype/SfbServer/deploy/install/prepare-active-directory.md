...
10. **Schritt 7: Hinzufügen von Benutzern zum Bereitstellen des administrativen Zugriffs auf die Skype for Business Server Systemsteuerung**
    ...
    d. Klicken Sie auf der Registerkarte **Mitglieder** auf **Hinzufügen**. Suchen **Sie unter "Benutzer, Kontakte, Computer, Dienstkonten oder Gruppen auswählen**" **nach der Eingabe der auszuwählenden Objektnamen**. Geben Sie die Benutzernamen oder Gruppennamen ein, die der Gruppe "CSAdministrators" hinzugefügt werden sollen. Klicken Sie auf **OK**.
...
11. Melden Sie sich ab, und melden Sie sich dann wieder bei Windows an, sodass Ihr Sicherheitstoken mit der neuen Skype for Business Server Sicherheitsgruppe aktualisiert wird, und öffnen Sie dann den Bereitstellungs-Assistenten erneut.
