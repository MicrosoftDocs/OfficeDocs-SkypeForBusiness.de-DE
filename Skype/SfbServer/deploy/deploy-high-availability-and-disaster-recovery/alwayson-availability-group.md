...
8. Führen Sie nach der Bereitstellung des Pools und der AG einige abschließende Schritte aus, um sicherzustellen, dass sich die SQL Anmeldungen für jedes Replikat in der AlwaysOn-Verfügbarkeitsgruppe befinden. 
   ...
   - Veröffentlichen Sie die Topologie. Klicken Sie im Menü **"Aktion** " auf **"Topologie** ", und klicken Sie dann auf **"Veröffentlichen**". Klicken Sie dann auf der Bestätigungsseite auf **"Weiter"**. Warten Sie dann einige Minuten, bis die neue Topologie repliziert wurde.
   ...
   - Wiederholen Sie die beiden vorherigen Schritte (Führen Sie ein Failover der Gruppe zu einem sekundären Replikat durch, und verwenden Sie  `Install-CsDatabase -Update`sie dann) für jedes Replikat in der Gruppe.
...
3. Veröffentlichen Sie die geänderte Topologie. Klicken Sie im Menü **"Aktion** " auf **"Topologie** ", und klicken Sie dann auf **"Veröffentlichen**". Klicken Sie dann auf der Bestätigungsseite auf **"Weiter".**
...
12. Ordnen Sie die neue AG dem Front-End-Pool zu.
    ...
    - Under **Associations**, in the **SQL Server Store** box, select the AG. Wählen Sie dieselbe Gruppe für alle anderen Datenbanken im Pool aus, die Sie in die AG verschieben möchten.
    
    - Wenn Sie sicher sind, dass alle erforderlichen Datenbanken auf AG festgelegt sind, klicken Sie auf **OK**.
    
13. Veröffentlichen Sie die Topologie. Klicken Sie im Menü **"Aktion** " auf **"Topologie** ", und klicken Sie dann auf **"Veröffentlichen**". Klicken Sie dann auf der Bestätigungsseite auf **"Weiter"**.
...
> [!NOTE]
> Wenn der Pool, den Sie auf eine AG aktualisieren, den zentralen Verwaltungsspeicher für Ihre Organisation hostet, müssen Sie den CMS zuerst in einen anderen Pool verschieben, bevor Sie diesen Pool aktualisieren. Verwenden Sie das Cmdlet Move-CsManagementServer, um den Pool zu verschieben. Wenn Sie keinen anderen Pool in Ihrer Organisation haben, können Sie einen Standard Edition Server vorübergehend bereitstellen und den CMS auf diesen Server verschieben, bevor Sie Ihr Pool auf die AG aktualisieren. 
...
5. Aktivieren Sie AG auf jedem Server im Cluster in SQL Server-Konfigurations-Manager.
...
9. Veröffentlichen Sie die Topologie. Klicken Sie im Menü **"Aktion** " auf **"Topologie** ", und klicken Sie dann auf **"Veröffentlichen**". Klicken Sie dann auf der Bestätigungsseite auf **"Weiter"**.
    
10. Führen Sie einige letzte Schritte aus, um sicherzustellen, dass sich die SQL Anmeldungen für jedes Replikat in der AG befinden.
