...
---
# <a name="integrate-skype-for-business-server-2015-with-exchange-server"></a>Integrieren von Skype for Business Server 2015 mit Exchange Server
 
**Summary:** Review integration steps for Exchange Server 2016 or Exchange Server 2013 and Skype for Business Server 2015.
  
Exchange Server 2016 or Exchange Server 2013 and Skype for Business Server 2015 are compatible and integrate well.  und  sind kompatibel und lassen sich problemlos integrieren. Anwesenheitsinformationen aus  können beispielsweise in Microsoft Outlook genutzt werden, während  auf den Outlook-Kalender eines Nutzers zugreifen, den Nutzer über eine geplante Besprechung benachrichtigen und ihn während der Besprechung als beschäftigt anzeigen kann. Sie müssen  zwar nicht für den Betrieb von  ausführen (bzw. umgekehrt), doch die beiden Produkte verbessern das Nutzungserlebnis des jeweils anderen. Although you do not have to run Exchange Server in order to run Skype for Business Server (or vice-versa) the two products together enhance each other's user experience.
...
[Konfigurieren von Partneranwendungen in Skype for Business Server 2015 und Microsoft Exchange Server](configure-partner-applications.md)
  
[Konfigurieren von Skype for Business Server 2015 für die Verwendung der Exchange Server-Archivierung](use-exchange-archiving.md)
...
[Konfigurieren von Skype for Business Server 2015 für die Verwendung des einheitlichen Kontaktspeichers](use-the-unified-contact-store.md)
  
[Konfigurieren der Verwendung von hochauflösenden Fotos in Skype for Business Server 2015](high-resolution-photos.md)
  
[Konfigurieren von Exchange Server Unified Messaging für Voicemail on Skype for Business Server 2015](exchangeunified-messaging-for-voice-mail.md)
  
[Integrieren von Skype for Business Server 2015 in Microsoft Outlook Web App](http://technet.microsoft.com/library/513d4cc7-aa87-4f68-b99d-d58b63bdf242.aspx)
  
[Konfigurieren des persönlichen Kontaktspeichers auf Clientcomputern für Skype for Business Server 2015](personal-contacts-store.md)
