...
Beim Erstellen von SIP-Trunk-Konfigurationseinstellungen mithilfe der Skype for Business Server-Systemsteuerung stehen Ihnen die folgenden Optionen zur Verfügung.
...
|Zentrale Medienverarbeitung  <br/> |12222  <br/> |Gibt an, ob ein bekannter Medienendpunkt vorhanden ist. (Ein Beispiel für einen bekannten Medienendpunkt ist ein PSTN-Gateway, bei dem der Medienendpunkt die gleiche IP-Adresse hat wie der Signaldatenverkehr-Endpunkt.)  <br/> |
