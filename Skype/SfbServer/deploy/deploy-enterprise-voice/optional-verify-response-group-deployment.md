...
Überprüfen Sie den Erfolg ihrer Reaktionsgruppen Bereitstellung in Skype for Business Server Enterprise Voice.
...
- Ein Benutzer, der in Skype for Business beheimatet ist
    
- Ein externer Benutzer, der das Telefonfestnetz (Public Switched Telephone Network, PSTN) verwendet
    
- Ein Agent, der in Skype for Business beheimatet ist
...
- Ein Benutzer ruft die Reaktionsgruppe an, während der Agent sich in einem Gespräch befindet; der Benutzer wird in der Warteschleife platziert.
    ...
    > [!NOTE]
    > Wenn die Reaktionsgruppe nicht wie erwartet funktioniert, überprüfen Sie den nächsten Link:https://support.office.com/en-us/article/troubleshooting-for-response-groups-ca72d8f8-4054-4974-b832-4f173611bd89
