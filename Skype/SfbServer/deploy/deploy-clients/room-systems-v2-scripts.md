---
title: Skype-Chatroom-Systemen v2 Skripts
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 5/10/2018
...
description: Verwenden Sie in diesem Thema erhalten Sie Skripts mit Skype Raum Systemen v2 verwendet.
...
---
# <a name="skype-room-systems-v2-scripts"></a><span data-ttu-id="30c89-103">Skype Raum Systemen v2 Skripts</span><span class="sxs-lookup"><span data-stu-id="30c89-103">Skype Room Systems v2 Scripts</span></span>
 
<span data-ttu-id="30c89-104">Kopieren Sie den Abschnitten in diesem Artikel in eine Textdatei mit dem Namen in der Abschnittsüberschrift.</span><span class="sxs-lookup"><span data-stu-id="30c89-104">Copy each of the sections in this article into a text file named in the section heading.</span></span> <span data-ttu-id="30c89-105">Diese Dateien werden bei der Bereitstellung von Skype Raum Systemen v2 verwendet:</span><span class="sxs-lookup"><span data-stu-id="30c89-105">These files are used in deploying Skype Room Systems v2:</span></span> 
* <span data-ttu-id="30c89-106">[CreateSrsMedia.ps1](#createsrsmediaps1) ist ein Powershell-Skript verwendet, um ein Software-Image für das Gerät Konsole zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="30c89-106">[CreateSrsMedia.ps1](#createsrsmediaps1) is a Powershell script used to create a software image for the console device.</span></span>  
* <span data-ttu-id="30c89-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) ist eine Powershell Skype für Geschäfts- und Exchange-Konten die Geräte eingerichtet Skript verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="30c89-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) is a Powershell script used to set up Skype for Business and Exchange accounts the devices will use.</span></span>  
* <span data-ttu-id="30c89-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) wird beim Einrichten der Verwaltung von Skype Raum Systemen v2 mithilfe von OMS verwendet.</span><span class="sxs-lookup"><span data-stu-id="30c89-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview)  is used when setting up management of Skype Room Systems v2 using OMS.</span></span>
  
<a name="CreateSrs"></a>
## <a name="createsrsmediaps1"></a><span data-ttu-id="30c89-109">CreateSrsMedia.ps1</span><span class="sxs-lookup"><span data-stu-id="30c89-109">CreateSrsMedia.ps1</span></span>
...
<a name="CreateRoom"></a>
## <a name="skyperoomprovisioningscriptps1"></a><span data-ttu-id="30c89-110">SkypeRoomProvisioningScript.ps1</span><span class="sxs-lookup"><span data-stu-id="30c89-110">SkypeRoomProvisioningScript.ps1</span></span>
...
```
<a name="OMSVIEW"></a>
## <a name="skyperoomsystemsv2omsview"></a><span data-ttu-id="30c89-111">SkypeRoomSystems_v2.omsview</span><span class="sxs-lookup"><span data-stu-id="30c89-111">SkypeRoomSystems_v2.omsview</span></span>
...
## <a name="see-also"></a><span data-ttu-id="30c89-112">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="30c89-112">See also</span></span>

#### 

[<span data-ttu-id="30c89-113">Planen von Skype Raum Systemen v2</span><span class="sxs-lookup"><span data-stu-id="30c89-113">Plan for Skype Room Systems v2</span></span>](../../plan-your-deployment/clients-and-devices/skype-room-systems-v2-0.md)
  
[<span data-ttu-id="30c89-114">Konfigurieren einer Skype Raum Systemen v2-Konsole</span><span class="sxs-lookup"><span data-stu-id="30c89-114">Configure a Skype Room Systems v2 console</span></span>](console.md)
  
[<span data-ttu-id="30c89-115">Verwalten von Skype Raum Systemen v2</span><span class="sxs-lookup"><span data-stu-id="30c89-115">Manage Skype Room Systems v2</span></span>](../../manage/skype-room-systems-v2/skype-room-systems-v2.md)
