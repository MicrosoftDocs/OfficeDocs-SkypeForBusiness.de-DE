...
---
# <a name="skype-room-systems-v2-scripts"></a>Skype Raum Systemen v2 Skripts
 
Kopieren Sie den Abschnitten in diesem Artikel in eine Textdatei mit dem Namen in der Abschnittsüberschrift. Diese Dateien werden bei der Bereitstellung von Skype Raum Systemen v2 verwendet: 
* [CreateSrsMedia.ps1](#createsrsmediaps1) ist ein Powershell-Skript verwendet, um ein Software-Image für das Gerät Konsole zu erstellen.  
* [SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) ist eine Powershell Skype für Geschäfts- und Exchange-Konten die Geräte eingerichtet Skript verwendet werden soll.  
* [SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) wird beim Einrichten der Verwaltung von Skype Raum Systemen v2 mithilfe von OMS verwendet.
