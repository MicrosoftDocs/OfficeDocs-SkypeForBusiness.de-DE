...
Der nächste Befehl wählt die Skype for Business Clientumgebung für alle Benutzer am Standort Redmond aus:
...
5. Erweitern **Sie im Gruppenrichtlinienverwaltungs-Editor** "**Benutzerkonfiguration**", "**Einstellungen**", **"Windows Einstellungen**", und wählen Sie dann den **Registrierungsknoten** aus.
    
6. Klicken Sie mit der rechten Maustaste auf den **Registrierungsknoten**, und wählen Sie "**NewRegistry** >  Item" aus.
