---
title: Skype Raumsystem – Verwaltbarkeit und Tools
ms.author: serdars
author: SerdarSoysal
manager: serdars
audience: ITPro
...
# <a name="skype-room-system-manageability-and-tools"></a>Skype Raumsystem – Verwaltbarkeit und Tools
...
## <a name="exchange-checklist"></a>Checkliste für Exchange
...
## <a name="skype-for-business-checklist"></a>Prüfliste für Skype for Business
...
Skype Raumsystem ist ein eingebettetes System, das vollständig in eine Windows Bereitstellung integriert werden kann, indem das Skype for Business Sicherheitsmodell, Rechteverwaltungs- und Verwaltungstools wie SCOM verwendet werden. Zu den Features gehören:
...
- Skype Raumsystem wird durch standardmäßige Microsoft Update-Prozesse aktualisiert.
    
- Skype Raumsystem stellt eine Verbindung mit Skype for Business her.
    
  - Skype for Business verwendet End-to-End-Verschlüsselung und Autorisierung für alle Kommunikationsmodi.
    
  - Skype Raumsystem unterstützt Skype for Business Sicherheits- und Compliancestandards. Weitere Informationen finden Sie [unter Plan for security in Skype For Business Server](../../plan-your-deployment/security/security.md).
...
Importieren Sie die CRL-Dateien im Skype Raumsystem unter dem Ordner "Zwischenzertifizierungsstellen". (Sie müssen den Dateierweiterungsfilter im Zertifikat-Manager in CRL ändern, um die Dateien anzuzeigen).
...
Die Domänenmitgliedschaft kann einige Dinge vereinfachen, da Sie das Skype Raumsystem als Windows System behandeln können und für einige Zertifikataspekte auf Active Directory zurückgreifen können. Es empfiehlt sich jedoch, dies manuell zu verwalten.
