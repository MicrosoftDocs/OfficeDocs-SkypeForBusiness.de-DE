...
> [!NOTE]
> AlwaysOn-Verfügbarkeitsgruppen werden mit Servern für beständigen Chat nicht unterstützt. 
...
15. Beachten Sie den im Feld **Zeitplan** unter **Kopierauftrag** aufgeführten Kopierzeitplan. Um den Zeitplan für Ihre Installation anzupassen, klicken Sie auf "Zeitplan", und passen Sie den Zeitplan SQL Server Agent nach Bedarf an. Dieser Zeitplan sollte in etwa dem Sicherungszeitplan entsprechen.
...
20. Wählen Sie die erste Hälfte der Abfrage (siehe Schritt 18) bis zur Zeile aus, und führen Sie sie aus: -- End: Skript, das bei Primär \* \* \* \* \* \* ausgeführt werden soll: \* \* \* \* \* \* .
    ...
    > [!IMPORTANT]
    > Die manuelle Ausführung dieses Skripts ist erforderlich, da SQL Server Management Studio nicht mehrere primäre Datenbanken in einer Konfiguration SQL Server Protokollversand unterstützt. 
