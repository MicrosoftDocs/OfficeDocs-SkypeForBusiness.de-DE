...
description: 'Sie haben drei Optionen, wenn Sie IP-Adressen in Skype for Business Server 2015 konfigurieren: Sie können Skype for Business Server 2015 so konfigurieren, dass nur IP-Version 4 (IPv4), nur IP-Version 6 (IPv6) oder eine Kombination aus beiden (auch als dualer Stapel bezeichnet) unterstützt wird.'
---
