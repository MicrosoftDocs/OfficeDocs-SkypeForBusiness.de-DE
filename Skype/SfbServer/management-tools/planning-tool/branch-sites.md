...
ms.locfileid: "30899222"
---
# <a name="branch-sites-planning-tool"></a><span data-ttu-id="582eb-103">Branch Sites (Planning Tool)</span><span class="sxs-lookup"><span data-stu-id="582eb-103">Branch Sites (Planning Tool)</span></span>

<span data-ttu-id="582eb-104">Ausführliche Informationen zu Zweigstellenstandorte finden Sie unter [Planning for Branch-Site Voice Resiliency](https://technet.microsoft.com/library/67713f57-3ded-4127-ac37-57d8099bf384.aspx).</span><span class="sxs-lookup"><span data-stu-id="582eb-104">For details about branch-site resiliency, see [Planning for Branch-Site Voice Resiliency](https://technet.microsoft.com/library/67713f57-3ded-4127-ac37-57d8099bf384.aspx).</span></span>
