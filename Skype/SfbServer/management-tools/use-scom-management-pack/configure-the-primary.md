...
Das Component and User Management Pack wird nur zur Überwachung von Skype for Business Server 2015 verwendet. Wenn Sie sich in einem Koexistenzszenario befinden, in dem sowohl Skype for Business Server 2015 als auch Lync Server 2013 installiert sind, sollten Sie weiterhin die Lync Server 2013-Verwaltungspakete für Ihre Lync Server 2013-Computer verwenden.

> [!NOTE]
> Management Packs für Skype for Business Server 2015 umfassen die Skype for Business Server 2015-Komponente und das Benutzerverwaltungspaket und das Skype for Business Server 2015 Active Monitoring Management Pack.
...
1. Laden Sie die SkypeForBusiness2015ManagementPacks.msi aus dem Microsoft Web herunter, und installieren Sie den msi.
...
6. Suchen Und wählen Sie im Dialogfeld Zu **importierende** Management Packs auswählen die Dateien Microsoft.LS.2015.Monitoring.ActiveMonitoring.mp und Microsoft.LS.2015.Monitoring.ComponentAndUser.mp aus, und klicken Sie dann auf **Öffnen**. Klicken Sie zum Auswählen mehrerer Dateien im Dialogfeld auf die erste Datei, halten Sie dann die STRG-TASTE gedrückt, und klicken Sie auf die nachfolgenden Dateien.
...
2. Geben Sie in operations manager shell den folgenden Befehl an der Eingabeaufforderung ein, indem Sie den tatsächlichen Pfad zu Ihrer Kopie der Datei Microsoft.LS.2015.Monitoring.ActiveMonitoring.mp, und drücken Sie dann die EINGABETASTE:

   ```PowerShell
   Import-SCOMManagementPack -FullName "D:\MP\Microsoft.LS.2015.Monitoring.ActiveMonitoring.mp"
   ```

3. Wiederholen Sie den Vorgang, nachdem Sie das erste Management Pack importiert haben, indem Sie den Pfad zu Ihrer Kopie der Datei Microsoft.LS.2015.Monitoring.ComponentAndUser.mp:
