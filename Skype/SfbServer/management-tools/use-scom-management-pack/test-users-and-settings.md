...
Geben Sie in der Skype for Business Server-Verwaltungsshell den folgenden Befehl ein, um zu überprüfen, ob der Watcher-Knoten ordnungsgemäß konfiguriert wurde:
