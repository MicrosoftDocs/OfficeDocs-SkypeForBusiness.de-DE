...
2. Klicken Sie im Setup-Assistenten für System Center Operation Manager im Abschnitt "Agent installieren" unter "Optionale Installationen" auf "**Operations Manager-Agent** installieren".
