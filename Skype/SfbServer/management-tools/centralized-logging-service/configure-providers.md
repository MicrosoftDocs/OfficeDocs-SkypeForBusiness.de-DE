...
- **Protokollierungsstufen** OCSLogger bot die Möglichkeit, eine Reihe von Detailebenen für die erfassten Daten auszuwählen. Dieses Feature ist ein integraler Bestandteil des zentralisierten Protokollierungsdiensts und der Szenarien und wird durch den **Parameter Type** definiert. Es stehen folgende Optionen zur Auswahl:
  ...
  - **Schwerwiegender** Sammelt nur die Als "Schwerwiegend" definierten Ablaufverfolgungsmeldungen.
  ...
  - **Informationen** Sammelt nur die Ablaufverfolgungsmeldungen, die eine Informationsnachricht für den definierten Anbieter sowie schwerwiegende, Fehler- und Warnmeldungen angeben.
    
  - **Ausführliche** Sammelt alle Ablaufverfolgungsmeldungen vom Typ "schwerwiegend", "Fehler", "Warnung" und "Ausführlich" für den definierten Anbieter.
...
- **Flaggen** OCSLogger hat die Option zum Auswählen von Flags für jeden Anbieter bereitgestellt, der definiert hat, welche Art von Informationen Sie aus den Ablaufverfolgungsdateien abrufen können. Sie können basierend auf dem Anbieter die folgenden Flags auswählen:
