...
2. Klicken Sie auf **"Start**", "**Alle Programme"**, auf **Skype for Business Server** und dann auf **Skype for Business Server Bereitstellungs-Assistenten**.
...
2. Starten Sie Skype for Business Server Systemsteuerung: Klicken Sie auf **"Start**", klicken Sie auf **"Alle Programme**", zeigen Sie auf **"Verwaltungstools**", zeigen Sie auf **Skype for Business Server**, und klicken Sie dann auf **Skype for Business Server Systemsteuerung**.
