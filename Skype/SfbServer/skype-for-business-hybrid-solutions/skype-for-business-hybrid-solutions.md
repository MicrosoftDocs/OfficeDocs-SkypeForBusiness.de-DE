...
- [Hybridkonfigurationen für Skype for Business](skype-for-business-hybrid-solutions.md#BKMK_HybridConfigurations)
    
- [Fügen Sie Skype für Business Online in Ihre vorhandenen Skype für geschäftsumgebung lokale hinzu](skype-for-business-hybrid-solutions.md#BKMK_HybridConnectivity)
    
- [Nutzen Sie Telefonsystem in Office 365 (Cloud, PBX)](skype-for-business-hybrid-solutions.md#BKMK_CloudPBX)
    
- [Integrieren in Exchange und SharePoint](skype-for-business-hybrid-solutions.md#BKMK_IntegratewExchangeSharePoint)
    
- [Aufgaben zum Planen und Konfigurieren einer Hybridumgebung](skype-for-business-hybrid-solutions.md#BKMK_Tasks)
    
- [Weitere Informationen](skype-for-business-hybrid-solutions.md#BKMK_MoreInfo)
...
Microsoft bietet zusätzlich zu den zwei Telefonsystem in Office 365-Hybrid-Dienstangebote, Telefonsystem in Office 365 mit Aufrufen planen – ein Dienst aufrufen PSTN – für eine all-in-Cloud-Lösung, die keine lokalen Server-Bereitstellung erforderlich sind. Wenn Sie entscheiden, ob Telefonsystem in Office 365 mit Aufrufen planen die richtige Lösung für Ihre Organisation möglicherweise, finden Sie unter [Telefonsystem in Office 365-Lösungen](plan-your-phone-system-cloud-pbx-solution/plan-your-phone-system-cloud-pbx-solution.md#BKMK_PBXOfferings).
  
Es gibt zwei Telefonsystem in Office 365 Hybrid angeboten: 
  
- [Telefonsystem in Office 365 mit der lokale Konnektivität bereitgestellt, die von Ihrer Skype für Business Server-Bereitstellung](skype-for-business-hybrid-solutions.md#BKMK_Server)
    
- [In Office 365 mit der lokale Konnektivität von Skype für Business Server Cloud Connector Edition bereitgestellten Telefonsystem](skype-for-business-hybrid-solutions.md#BKMK_CCE)
...
Weitere Informationen finden Sie unter [Planen von Telefonsystem in Office 365 mit lokalen PSTN-Konnektivität in Skype für Business Server](plan-your-phone-system-cloud-pbx-solution/plan-phone-system-with-on-premises-pstn-connectivity.md) und [Aktivieren von Benutzern für Telefonsystem in Office 365 mit lokalen PSTN-Konnektivität in Skype für Business Server](plan-your-phone-system-cloud-pbx-solution/enable-users-for-phone-system.md).
...
Weitere Informationen finden Sie unter [Planen von Skype für Business Cloud Connector Edition](plan-your-phone-system-cloud-pbx-solution/plan-skype-for-business-cloud-connector-edition.md).
...
- [Microsoft cloudidentität für Enterprise-konstruiert](https://aka.ms/cloudidarch)
...
- [Bereitstellen von hybridkonnektivität zwischen Skype für Business Server und Skype für Business Online](deploy-hybrid-connectivity/deploy-hybrid-connectivity.md)
...
- [Planen der Integration von Skype für Unternehmen und Exchange](../plan-your-deployment/integrate-with-exchange/integrate-with-exchange.md)
    
Eine Posterversion dieses Themas können Sie hier herunterladen:
  
- [Skype für Business-Architektur-Modelle (Pdf)](https://download.microsoft.com/download/7/7/4/7741262C-A60D-41F7-863B-99BF5964FBFE/Skype for Business Architectural Models.pdf)
    
- [Skype für Business-Architektur-Modelle (Visio)](https://download.microsoft.com/download/7/7/4/7741262C-A60D-41F7-863B-99BF5964FBFE/Skype for Business Architectural Models.vsd)
