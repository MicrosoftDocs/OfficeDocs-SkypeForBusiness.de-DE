...
---
# <a name="deployment-wizard-unified-communications-api"></a><span data-ttu-id="b22f6-103">Bereitstellungs-Assistent: Unified Communications-API</span><span class="sxs-lookup"><span data-stu-id="b22f6-103">Deployment Wizard: Unified Communications API</span></span>
 
<span data-ttu-id="b22f6-104">Weitere Informationen zur Verwendung von Bereitstellungs-Assistenten zum Installieren von Skype für Business Server 2015 finden Sie unter [Installieren von Skype für Business Server 2015](../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="b22f6-104">For details about using Deployment Wizard to install Skype for Business Server 2015, see [Install Skype for Business Server 2015](../../deploy/install/install.md).</span></span>
