...
---
# <a name="deployment-wizard-admin-tools"></a><span data-ttu-id="db730-103">Bereitstellungs-Assistent: Admin-Tools</span><span class="sxs-lookup"><span data-stu-id="db730-103">Deployment Wizard: Admin Tools</span></span>
 
<span data-ttu-id="db730-104">Weitere Informationen zur Verwendung von Bereitstellungs-Assistenten zum Installieren von Skype für Business Server 2015 finden Sie unter [Installieren von Skype für Business Server 2015](../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="db730-104">For details about using Deployment Wizard to install Skype for Business Server 2015, see [Install Skype for Business Server 2015](../../deploy/install/install.md).</span></span>
