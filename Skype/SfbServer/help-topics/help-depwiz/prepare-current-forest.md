...
2. Klicken Sie auf der Seite **Gesamtstruktur vorbereiten** auf **Weiter**.
    ...
    > [!NOTE]
    > Mit der Gesamtstrukturvorbereitung können Sie auswählen, wo die universellen Gruppen für Skype for Business Server 2015 platzieren werden. Wählen Sie einen Speicherort entsprechend den Anforderungen Ihrer Organisation.
