...
---
# <a name="certificate-request-specify-termplate"></a><span data-ttu-id="8630a-107">Zertifikatsanforderung (mit Angabe der Vorlage)</span><span class="sxs-lookup"><span data-stu-id="8630a-107">Certificate Request (Specify Termplate)</span></span>
