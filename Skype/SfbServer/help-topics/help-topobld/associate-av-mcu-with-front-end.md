...
ms.locfileid: "48216806"
---
# <a name="associate-av-mcu-with-front-end"></a><span data-ttu-id="5ec90-104">Zuordnen der A/V MCU zum Front-End</span><span class="sxs-lookup"><span data-stu-id="5ec90-104">Associate AV MCU With Front End</span></span>
 
<span data-ttu-id="5ec90-p102">Sämtliche Front-End-Pools der Enterprise Edition, für welche die Konferenzfunktion aktiviert ist, müssen über einen A/V-Konferenzdienst verfügen oder einen eigenständigen A/V-Konferenzpool verwenden. Für vorhandene Front-End-Pools der Enterprise Edition, die gegenwärtig über einen A/V-Konferenzdienst verfügen, kann festgelegt werden, dass stattdessen dieser neue eigenständige A/V-Konferenzpool verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="5ec90-p102">All Enterprise Edition Front End pools with Conferencing enabled must have an A/V Conferencing service collocated, or must use a stand-alone A/V Conferencing pool. Any existing Enterprise Edition Front End pools that currently have an A/V Conferencing service collocated may be selected to use this new stand-alone A/V Conferencing pool instead.</span></span>
