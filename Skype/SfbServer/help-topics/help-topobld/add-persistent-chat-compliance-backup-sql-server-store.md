...
Wählen Sie aus der Liste **"Spiegelung", SQL Server** speichern Sie eine SQL Server und eine optionale Instanz, die als SQL Server Spiegel für die Sicherungscompliance SQL Server für beständigen Chat fungiert.
