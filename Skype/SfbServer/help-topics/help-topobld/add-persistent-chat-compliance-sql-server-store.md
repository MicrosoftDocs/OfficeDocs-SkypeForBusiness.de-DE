...
Wählen Sie aus der Liste **"Spiegelung", SQL Server** speichern Sie eine SQL Server und optionale Instanz, die als SQL Server Spiegel für die Kompatibilität des beständigen Chats SQL Server fungieren soll.
