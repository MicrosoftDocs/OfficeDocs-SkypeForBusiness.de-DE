...
description: 'Die Archivierung erfordert eine unterstützte 64-Bit-Edition der Microsoft SQL Server-Datenbanksoftware, um die Archivierungsdaten zu speichern. Sie können entweder eine zuvor definierte SQL Server Datenbank auswählen, die für die Archivierung verwendet werden soll, oder eine neue SQL Server Datenbank definieren, indem Sie einen vollqualifizierten Domänennamen (Fully Qualified Domain Name, FQDN) des Servers angeben, auf dem sich die SQL Server-Datenbank befinden soll, zusätzlich zu der Instanz von SQL Server, die Sie für die neue Datenbank verwenden möchten. SQL Server Datenbank (dies kann die Standardinstanz oder eine benannte Instanz sein, die Sie angeben).'
---
