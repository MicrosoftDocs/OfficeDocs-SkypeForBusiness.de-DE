...
ms.locfileid: "58595769"
---
# <a name="select-a-service"></a>Auswählen eines Diensts

Verwenden Sie das Dialogfeld **"Dienst auswählen",** um in Ihrer Umgebung verfügbare Dienste zu suchen. Klicken Sie auf einen Dienst in der Liste und anschließend auf **OK**, um einen vorhandenen Dienst zu verwenden.
...
Wählen Sie in **"Dienst auswählen"** den Dienst aus, der dem Serverpool für beständigen Chat entspricht, in dem die Kategorie erstellt werden muss. Der Dienst ist der Serverpool für beständigen Chat, den der Beständige Chat (Client) verwendet, um zu identifizieren, zu welchem Pool die Kategorie gehört. Eine Kategorie kann nur zu einem Serverpool für beständigen Chat gehören und kann nicht in einen anderen Pool verschoben oder für einen anderen Pool freigegeben werden.
