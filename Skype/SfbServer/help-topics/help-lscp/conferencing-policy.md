...
- **Websiterichtlinien (optional):** Sie können eine oder mehrere Konferenzrichtlinien für Den Standort erstellen, die jeweils für einen bestimmten Standort gelten. Standortrichtlinien setzen die globale Richtlinie außer Kraft.

- **Benutzerrichtlinien (optional):** Sie können eine oder mehrere Konferenzrichtlinien für Benutzer erstellen, die jeweils für einen bestimmten Benutzer oder eine Bestimmte Benutzergruppe gelten. Benutzerrichtlinien setzen die globale Richtlinie und Standortrichtlinien außer Kraft.
...
- **Name** Gibt die Konferenzrichtlinie an.

- **Bereich** Gibt den Bereich der Konferenzrichtlinie an: global, Standort oder Benutzer.

- **Datenzusammenarbeit** Aktiviert, wenn die Konferenzrichtlinie angibt, dass die Datenzusammenarbeit in Konferenzen zulässig ist.

- **Anwendungsfreigabe** Aktiviert, wenn die Konferenzrichtlinie angibt, dass die Anwendungsfreigabe in Konferenzen zulässig ist.

- **Audio** Aktiviert, wenn die Konferenzrichtlinie angibt, dass Audio in Konferenzen zulässig ist.

- **Video** Aktiviert, wenn die Konferenzrichtlinie angibt, dass Video in Konferenzen zulässig ist.

- **PSTN** Aktiviert, wenn die Konferenzrichtlinie angibt, dass Einwahlkonferenzen im öffentlichen Telefonnetz zulässig sind.

- **Aufzeichnung** Aktiviert, wenn die Konferenzrichtlinie angibt, dass die Aufzeichnung in Konferenzen zulässig ist.
