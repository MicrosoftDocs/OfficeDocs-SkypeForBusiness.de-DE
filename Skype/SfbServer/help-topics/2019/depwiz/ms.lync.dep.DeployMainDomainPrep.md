...
1. Führen Sie im Skype for Business Server-Installationsordner oder-Medium die Datei "Setup. exe" aus, um den Skype for Business Server-Bereitstellungs-Assistenten zu starten.
