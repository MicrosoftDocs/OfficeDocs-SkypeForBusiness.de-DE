...
---
# <a name="deployment-wizard-windows-update"></a><span data-ttu-id="69a63-103">Bereitstellungs-Assistent: Windows Update</span><span class="sxs-lookup"><span data-stu-id="69a63-103">Deployment Wizard: Windows Update</span></span>
 
<span data-ttu-id="69a63-104">Weitere Informationen zur Verwendung von Bereitstellungs-Assistenten zum Installieren von Skype für Business Server 2015 finden Sie unter [Installieren von Skype für Business Server 2015](../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="69a63-104">For details about using Deployment Wizard to install Skype for Business Server 2015, see [Install Skype for Business Server 2015](../../deploy/install/install.md).</span></span>
