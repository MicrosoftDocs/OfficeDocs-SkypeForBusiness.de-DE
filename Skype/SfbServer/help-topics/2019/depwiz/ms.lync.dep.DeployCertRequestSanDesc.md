...
ms.locfileid: "19997059"
---
# <a name="certificate-request-subject-alternate-names"></a><span data-ttu-id="19618-104">Zertifikatanforderung (alternative Antragstellernamen)</span><span class="sxs-lookup"><span data-stu-id="19618-104">Certificate Request (Subject Alternate Names)</span></span>
 
<span data-ttu-id="19618-105">Die **Antragstellername / Alternative Antragstellernamen** Seite enthält eine Zusammenfassung der den Antragstellernamen und alle alternativen Antragstellernamen, die das Zertifikat aufgefüllt werden soll.</span><span class="sxs-lookup"><span data-stu-id="19618-105">The **Subject Name / Subject Alternative Names** page presents a summary of the subject name and all subject alternative names that will populate the certificate.</span></span> <span data-ttu-id="19618-106">Die Namen für den Antragstellernamen und den alternativen Antragstellernamen präsentiert werden aus dem Dokument Definition zusammengefasst, wie es erstellt wurde, wenn Sie die Bereitstellung im Topologie-Generator definiert haben.</span><span class="sxs-lookup"><span data-stu-id="19618-106">The names presented for subject name and subject alternative names are gathered from the definition document, as it was created when you defined the deployment in Topology Builder.</span></span>
  
<span data-ttu-id="19618-107">Wenn Sie Änderungen an den Antragstellernamen oder eines alternativen Antragstellernamen vornehmen müssen, klicken Sie auf **Abbrechen** , um den Zertifikatsanforderungs-Assistenten zu beenden und erneut ausführen, Topologie-Generator.</span><span class="sxs-lookup"><span data-stu-id="19618-107">If you must make changes to the subject name or any of the subject alternative names, click **Cancel** to exit the Certificate Request Wizard and rerun Topology Builder.</span></span> <span data-ttu-id="19618-108">Veröffentlichen Sie die neue Konfiguration mit den ordnungsgemäß definierte Betreff und den alternativen Antragstellernamen klicken Sie dann erneut.</span><span class="sxs-lookup"><span data-stu-id="19618-108">Then republish the new configuration with the correctly defined subject and subject alternative names.</span></span>
