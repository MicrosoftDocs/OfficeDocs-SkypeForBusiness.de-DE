...
ms.locfileid: "21004504"
---
# <a name="deployment-wizard-request-a-certificate"></a><span data-ttu-id="6dc82-103">Bereitstellungs-Assistent: Anfordern eines Zertifikats</span><span class="sxs-lookup"><span data-stu-id="6dc82-103">Deployment Wizard: Request a Certificate</span></span>
 
<span data-ttu-id="6dc82-104">Weitere Informationen zur Verwendung von Bereitstellungsassistenten Skype für Business Server installieren finden Sie unter [Skype für Business Server installieren](../../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="6dc82-104">For details about using Deployment Wizard to install Skype for Business Server, see [Install Skype for Business Server](../../../deploy/install/install.md).</span></span>
