---
title: Assistenten Admin-Bereitstellungstools
ms.reviewer: ''
ms.author: kenwith
author: kenwith
manager: serdars
...
ms.locfileid: "32216592"
---
# <a name="deployment-wizard-admin-tools"></a><span data-ttu-id="ddc84-103">Bereitstellungs-Assistent: Admin-Tools</span><span class="sxs-lookup"><span data-stu-id="ddc84-103">Deployment Wizard: Admin Tools</span></span>
 
<span data-ttu-id="ddc84-104">Weitere Informationen zur Verwendung von Bereitstellungsassistenten Skype für Business Server installieren finden Sie unter [Skype für Business Server installieren](../../../deploy/install/install.md).</span><span class="sxs-lookup"><span data-stu-id="ddc84-104">For details about using Deployment Wizard to install Skype for Business Server, see [Install Skype for Business Server](../../../deploy/install/install.md).</span></span>
