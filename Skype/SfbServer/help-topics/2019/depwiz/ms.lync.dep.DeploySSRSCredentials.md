...
---
# <a name="sql-server-reporting-services-credentials"></a>SQLServer Reporting Services (Anmeldeinformationen)
...
Ausführliche Informationen zur Bereitstellung der Reporting Services-Berichte für den Server mit der Überwachung finden Sie unter [Installieren von Überwachungsberichten in Skype für Business Server 2015](../../deploy/deploy-monitoring/install-monitoring-reports.md).
