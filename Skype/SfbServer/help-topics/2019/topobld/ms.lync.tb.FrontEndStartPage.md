...
---
# <a name="front-end-start-page"></a><span data-ttu-id="fc916-105">Front-End-Startseite</span><span class="sxs-lookup"><span data-stu-id="fc916-105">Front End Start Page</span></span>

<span data-ttu-id="fc916-106">Verwenden Sie diesen Assistenten, um einen neuen Front-End-Pool für einen Standort zu definieren.</span><span class="sxs-lookup"><span data-stu-id="fc916-106">Use this wizard to define a new Front End pool for a site.</span></span> <span data-ttu-id="fc916-107">Jede Website muss mindestens einen Enterprise Edition-Pool oder Standard Edition-Server verfügen.</span><span class="sxs-lookup"><span data-stu-id="fc916-107">Each site must have at least one Enterprise Edition pool or Standard Edition server.</span></span> <span data-ttu-id="fc916-108">Weitere Informationen zu den Anforderungen für die Verwendung des Assistenten zum Erstellen eines neuen Front-End-Pools finden Sie unter [Define and Configure a Front End Pool](https://technet.microsoft.com/library/713fc263-23dd-414a-b001-82932e4fe966.aspx) in der Bereitstellungsdokumentation.</span><span class="sxs-lookup"><span data-stu-id="fc916-108">For details about the requirements for using the wizard to create a new Front End pool, see [Define and Configure a Front End Pool](https://technet.microsoft.com/library/713fc263-23dd-414a-b001-82932e4fe966.aspx) in the Deployment documentation.</span></span>
