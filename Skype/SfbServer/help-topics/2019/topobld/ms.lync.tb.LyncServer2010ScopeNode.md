...
---
# <a name="lync-server-2010-create-new-expander"></a><span data-ttu-id="b3314-103">Lync Server 2010 erstellen neue – Erweiterung</span><span class="sxs-lookup"><span data-stu-id="b3314-103">Lync Server 2010 Create New Expander</span></span>
 
<span data-ttu-id="b3314-104">Sie können im Lync Server 2010-Knoten des Topologie-Generator neue Serverrollen erstellen, indem Sie mit der rechten Maustaste auf **Lync Server 2010**, wählen Sie **neu**und dann die zu erstellende Serverrolle auswählen.</span><span class="sxs-lookup"><span data-stu-id="b3314-104">You can create new server roles in the Lync Server 2010 node of Topology Builder by right clicking on **Lync Server 2010**, select **New**, then select the server role to create.</span></span>
