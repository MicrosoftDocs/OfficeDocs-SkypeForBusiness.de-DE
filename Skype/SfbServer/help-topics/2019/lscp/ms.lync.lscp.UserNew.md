...
ms.locfileid: "54280180"
---
# <a name="users-new-user"></a>Benutzer: Neuer Benutzer

Was möchten Sie machen? Klicken Sie auf den Link zu der Aufgabe, die Sie ausführen möchten.

- [Hinzufügen eines neuen Benutzers](/previous-versions/office/lync-server-2013/lync-server-2013-add-and-enable-user-account-for-lync-server)
