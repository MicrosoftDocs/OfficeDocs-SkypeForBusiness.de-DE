...
- **Maximale Cachegröße (Bytes)** Sie können die maximale Informationsmenge (in Byte) angeben, die im Protokolldateicache gespeichert werden kann, bevor dieser Cache gelöscht und die Daten in eine Protokolldatei geschrieben werden müssen. Der Standardwert beträgt 512.000 (0,5 MB).
