...
- **Umfang** Gibt den Bereich (Standort, Pool oder Benutzer) der Clientversionsrichtlinie an.

- **Namen** Sie können den Namen der Clientversionsrichtlinie hinzufügen oder ändern.
