...
Klicken Sie auf der Seite **Testgerät** können Sie die folgenden Aufgaben ausführen:
  
- Hinzufügen eines neuen Geräts global oder für einen bestimmten Standort.
...
- **Neue** Sie können ein neues Testgerät mit dem folgenden Bereich hinzufügen:
    
  - Global
    
  - Standort
    
- **Bearbeiten** Sie können die Optionen in der Liste ein Testgerät ändern. Mit dieser Option haben Sie folgende Möglichkeiten:
    
  - **Details anzeigen** Diese Option öffnet ein Dialogfeld, in dem Sie die Optionen für ein Testgerät ändern können.
    
  - **Wählen Sie alle** Diese Option werden alle Testgeräte der Liste ausgewählt.
    
  - **Löschen** Diese Option werden alle ausgewählten Testgeräte gelöscht.
    
- **Aktualisieren** Sie können den Status der Optionen aller Testgeräte zu überprüfen, um eine Liste mit den Testgeräten aktualisieren.
...
[Testgerät: Erstellen Sie einer neuen oder bearbeiten Sie einer vorhandenen](ms.lync.lscp.ClientDeviceTestEdit.md)
