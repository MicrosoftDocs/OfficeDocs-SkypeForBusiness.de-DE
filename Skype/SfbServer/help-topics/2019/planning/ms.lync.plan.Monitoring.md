...
---
# <a name="monitoring-planning-tool"></a><span data-ttu-id="055e3-103">Monitoring (Planning Tool)</span><span class="sxs-lookup"><span data-stu-id="055e3-103">Monitoring (Planning Tool)</span></span>

<span data-ttu-id="055e3-104">In Skype für Business Server monitoring dient zum Erfassen von Informationen zur Verwendung und Quality of Experience (QoE)-Daten über die kommunikationssitzungen, an denen die Benutzer beteiligt sind.</span><span class="sxs-lookup"><span data-stu-id="055e3-104">In Skype for Business Server, monitoring is used to collect usage information and Quality of Experience (QoE) data about the communication sessions that your users are involved in.</span></span>

<span data-ttu-id="055e3-105">Weitere Informationen zur Planung von Monitoring Server finden Sie unter [Planning for Monitoring](https://technet.microsoft.com/library/26cead5a-183c-42f1-a4b0-0e8d61c6159d.aspx).</span><span class="sxs-lookup"><span data-stu-id="055e3-105">For more details about planning for Monitoring Server, see [Planning for Monitoring](https://technet.microsoft.com/library/26cead5a-183c-42f1-a4b0-0e8d61c6159d.aspx).</span></span>
