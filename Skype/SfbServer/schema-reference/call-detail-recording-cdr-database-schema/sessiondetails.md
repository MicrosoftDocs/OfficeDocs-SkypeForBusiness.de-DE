...
|**User1Id** <br/> |int  <br/> |Fremdschlüssel  <br/> |Die ID eines Benutzers in der Sitzung. Finden Sie in der [Tabelle Benutzer](users.md) Weitere Informationen. <br/> |
|**User2Id** <br/> |int  <br/> |Fremdschlüssel  <br/> |ID des Benutzers in der Sitzung. Finden Sie in der [Tabelle Benutzer](users.md) Weitere Informationen. <br/> |
...
|**TargetUserId** <br/> |int  <br/> |Fremdschlüssel  <br/> |Die ursprüngliche an Benutzer-URI in der SIP-Anforderung. finden Sie in der [Tabelle Benutzer](users.md) Weitere Informationen. <br/> |
|**SessionStartedById** <br/> |int  <br/> |Fremdschlüssel  <br/> |ID des Benutzers, der die Sitzung gestartet hat. Finden Sie in der [Tabelle Benutzer](users.md) Weitere Informationen. <br/> |
...
|**User1ClientVerId** <br/> |int  <br/> |Fremdschlüssel  <br/> |Clientversion von User1 verwendet. [ClientVersions-Tabelle in Skype für Business Server 2015](clientversions.md) Weitere Informationen finden Sie. <br/> |
|**User2ClientVerId** <br/> |int  <br/> |Fremdschlüssel  <br/> |Clientversion von Benutzer2 verwendet. [ClientVersions-Tabelle in Skype für Business Server 2015](clientversions.md) Weitere Informationen finden Sie. <br/> |
|**User1EdgeServerid** <br/> |int  <br/> |Fremdschlüssel  <br/> |Edge-Server von User1 verwendet. [EdgeServers-Tabelle in Skype für Business Server 2015](edgeservers.md) Weitere Informationen finden Sie. <br/> |
|**User2EdgeServerid** <br/> |int  <br/> |Fremdschlüssel  <br/> |Edge-Server von Benutzer2 verwendet. [EdgeServers-Tabelle in Skype für Business Server 2015](edgeservers.md) Weitere Informationen finden Sie. <br/> |
...
|**CallPriority** <br/> |int  <br/> |Fremdschlüssel  <br/> |Rufen Sie die Priorität. [CallPriorities-Tabelle in Skype für Business Server 2015](callpriorities.md) Weitere Informationen finden Sie. <br/> |
