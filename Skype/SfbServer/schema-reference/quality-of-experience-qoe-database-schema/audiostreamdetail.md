...
|CallerCPUProcessorSpeed  <br/> |Ganzzahl  <br/> |CPU-Prozessorgeschwindigkeit des Endpunkts des Anrufers.  <br/> |
|CalleeCPUProcessorSpeed  <br/> |Ganzzahl  <br/> |CPU-Prozessorgeschwindigkeit des Endpunkts des Angerufenen.  <br/> |
...
|CalleePort  <br/> |Ganzzahl  <br/> |Vom Angerufenen verwendeter Port.  <br/> |
...
|CallerRelayPort  <br/> |Ganzzahl  <br/> |Der durch den A/V-Edgedienst des Anrufers verwendete Port.  <br/> |
...
|CalleeRelayPort  <br/> |Ganzzahl  <br/> |Der durch den A/V-Edgedienst des Angerufenen verwendete Port.  <br/> |
...
|BurstDuration  <br/> |Ganzzahl  <br/> |Durchschnittliche Dauer an Paketverlusten bei Bursts von Verlusten während des Anrufs.  <br/> |
...
|BurstGapDuration  <br/> |Ganzzahl  <br/> |Durchschnittliche Dauer der Lücken zwischen Bursts von Paketverlusten.  <br/> |
|PacketUtilization  <br/> |Ganzzahl  <br/> |Paketwert für den Audiostream.  <br/> |
|BandwidthEst  <br/> |Ganzzahl  <br/> |Bandbreitenschätzwerte für den Audiostream.  <br/> |
...
|PayloadDescription  <br/> |Ganzzahl  <br/> |Der für den Anruf verwendete Audiocodec, auf den in der [PayloadDescription-Tabelle](payloaddescription.md)verwiesen wird.  <br/> |
|AudioSampleRate  <br/> |Ganzzahl  <br/> |Samplingrate für den Audiostream.  <br/> |
|CallerSendSignalLevel  <br/> |Ganzzahl  <br/> |Stärke des Audiosignals der postanalogen Verstärkung für das vom Anrufer gesendete Audio. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität sind mindestens 30 dBmo erforderlich. Diese Metrik wird nicht vom A/V-Konferenzserver oder IP-Telefonen berichtet.  <br/> |
|CallerRecvSignalLevel  <br/> |Ganzzahl  <br/> |Stärke des Audiosignals für das vom Anrufer empfangene Audio. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität sind mindestens 30 dBmo erforderlich. Diese Metrik wird nicht vom A/V-Konferenzserver oder IP-Telefonen berichtet.  <br/> |
|CallerSendNoiseLevel  <br/> |Ganzzahl  <br/> |Stärke des Audiogeräusches der postanalogen Verstärkung für das vom Anrufer gesendete Audio. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität muss der Wert unter 35 dBmo liegen. Diese Metrik wird nicht vom A/V-Konferenzserver oder von IP-Telefonen berichtet.  <br/> |
|CallerRecvNoiseLevel  <br/> |Ganzzahl  <br/> |Stärke des Audiogeräuschs der postanalogen Verstärkung für das vom Anrufer empfangene Audio. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität muss der Wert unter 35 dBmo liegen. Diese Metrik wird nicht vom A/V-Konferenzserver oder IP-Telefonen berichtet.  <br/> |
|CallerEchoReturn  <br/> |Ganzzahl  <br/> |Echodämpfungsverbesserung für den Anrufer. Die Einheit für diese Metrik ist dB. Niedrigere Werte bedeuten weniger Echo. Diese Metrik wird nicht vom A/V-Konferenzserver oder von IP-Telefonen berichtet.  <br/> |
|CallerSpeakerGlitchRate  <br/> |Ganzzahl  <br/> |Durchschnittliche Störungen pro fünf Minuten für das Rendern des Anrufers. Um eine gute Qualität zu erzielen, sollte höchstens eine Verzögerung pro fünf Minuten auftreten. Wird nicht von A/V-Konferenzservern, Vermittlungsservern oder IP-Telefonen berichtet.  <br/> |
|CallerMicGlitchRate  <br/> |Ganzzahl  <br/> |Durchschnittliche Störungen pro fünf Minuten für die Mikrofonaufnahme des Anrufers. Um eine gute Qualität zu erzielen, sollte höchstens eine Verzögerung pro fünf Minuten auftreten. Wird nicht von A/V-Konferenzservern, Vermittlungsservern oder IP-Telefonen berichtet.  <br/> |
...
|CallerRxAGCSignalLevel  <br/> |Ganzzahl  <br/> |Empfangene Signalstufe auf dem Vermittlungsserver vom Gateway für die Audiodaten des Anrufers; dies gilt nur für den Vermittlungsserver. Die Einheit dieser Metrik ist dBoV. Zum Erzielen einer guten Qualität sollte der akzeptable Bereich zwischen [-30 und -18] dBoV liegen.  <br/> |
|CallerRxAGCNoiseLevel  <br/> |Ganzzahl  <br/> |Empfangene Signalstufe auf dem Vermittlungsserver vom Gateway für die Audiodaten des Anrufers. Dies betrifft nur den Vermittlungsserver. Die Einheit dieser Metrik ist dBoV. Zum Erzielen einer guten Qualität sollte der akzeptable Bereich unter -50 dBoV liegen.  <br/> |
|CallerRxAGCGain  <br/> |Ganzzahl  <br/> |Automatische Verstärkungssteuerung (Automatic Gain Control, AGC) auf der Seite des Vermittlungsservers, die auf die Audiodaten des Anrufers angewendet wird.  <br/> |
...
|CalleeSendSignalLevel  <br/> |Ganzzahl  <br/> |Stellt die Stärke des Audiosignals der postanalogen Verstärkung für das vom Angerufenen gesendete Audio dar. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität sind mindestens 30 dBmo erforderlich. Diese Metrik wird nicht vom A/V-Konferenzserver oder von IP-Telefonen berichtet.  <br/> |
|CalleeRecvSignalLevel  <br/> |Ganzzahl  <br/> |Stärke des Audiosignals für das vom Angerufenen empfangene Audio. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität sind mindestens 30 dBmo erforderlich. Diese Metrik wird nicht vom A/V-Konferenzserver oder von IP-Telefonen berichtet.  <br/> |
|CalleeSendNoiseLevel  <br/> |Ganzzahl  <br/> |Stärke des Audiogeräuschs der postanalogen Verstärkung für das vom Angerufenen gesendete Audio. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität muss der Wert unter 35 dBmo liegen. Diese Metrik wird nicht vom A/V-Konferenzserver oder von IP-Telefonen berichtet.  <br/> |
|CalleeRecvNoiseLevel  <br/> |Ganzzahl  <br/> |Stärke des Audiogeräuschs der postanalogen Verstärkung für das vom Angerufenen empfangene Audio. Die Einheit für diese Metrik ist dBmo. Zum Erzielen einer akzeptablen Qualität muss der Wert unter 35 dBmo liegen. Diese Metrik wird nicht vom A/V-Konferenzserver oder von IP-Telefonen berichtet.  <br/> |
|CalleeEchoReturn  <br/> |Ganzzahl  <br/> |Echodämpfungsverbesserung für den Angerufenen. Die Einheit für diese Metrik ist dB. Niedrigere Werte bedeuten weniger Echo. Diese Metrik wird nicht vom A/V-Konferenzserver oder von IP-Telefonen berichtet.  <br/> |
|CalleeSpeakerGlitchRate  <br/> |Ganzzahl  <br/> |Durchschnittliche Störungen pro fünf Minuten für das rendern des Angerufenen. Um eine gute Qualität zu erzielen, sollte höchstens eine Verzögerung pro fünf Minuten auftreten. Wird nicht von A/V-Konferenzservern, Vermittlungsservern oder IP-Telefonen berichtet.  <br/> |
|CalleeMicGlitchRate  <br/> |Ganzzahl  <br/> |Durchschnittliche Störungen pro fünf Minuten für die Mikrofonaufnahme des Angerufenen. Um eine gute Qualität zu erzielen, sollte höchstens eine Verzögerung pro fünf Minuten auftreten. Wird nicht von A/V-Konferenzservern, Vermittlungsservern oder IP-Telefonen berichtet.  <br/> |
...
|CalleeRxAGCSignalLevel  <br/> |Ganzzahl  <br/> |Empfangene Signalstufe auf dem Vermittlungsserver vom Gateway für die Audiodaten des Angerufenen; dies gilt nur für den Vermittlungsserver. Die Einheit dieser Metrik ist dBoV. Zum Erzielen einer guten Qualität sollte der akzeptable Bereich zwischen [-30 und -18] dBoV liegen.  <br/> |
|CalleeRxAGCNoiseLevel  <br/> |Ganzzahl  <br/> |Empfangene Signalstufe auf dem Vermittlungsserver vom Gateway für die Audiodaten des Angerufenen. Dies betrifft nur den Vermittlungsserver. Die Einheit dieser Metrik ist dBoV. Zum Erzielen einer guten Qualität sollte der akzeptable Bereich unter -50 dBoV liegen.  <br/> |
|CalleeRxAGCGain  <br/> |Ganzzahl  <br/> |Automatische Verstärkungssteuerung (Automatic Gain Control, AGC) auf der Seite des Vermittlungsservers, die auf die Audiodaten des Angerufenen angewendet wird.  <br/> |
...
|Roundtrip  <br/> |Ganzzahl  <br/> |Roundtripzeit aus RTCP-Statistik.  <br/> |
|RoundTripMax  <br/> |Ganzzahl  <br/> |Maximale Roundtripzeit für den Audiostream.  <br/> |
