...
|**RelativeOneWayBurstDensity** <br/> |Ganzzahl  <br/> ||Undirektionale Burstdichte insgesamt. Eine "stürmige" Übertragung ist eine Übertragung, bei der Daten in unvorhersehbare Brüche anstatt in einen beständigen Datenstrom fließen. Diese Metrik misst den Datenfluss zwischen dem Client und dem Server.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
...
|**VideoAllocateBWAvg** <br/> |Ganzzahl  <br/> ||Durchschnittliche für Video reservierte Bandbreite.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
...
|**SendResolutionWidth** <br/> |Ganzzahl  <br/> ||Vom Absender verwendete Auflösungsbreite.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**SendResolutionHeight** <br/> |Ganzzahl  <br/> ||Vom Absender verwendete Auflösungshöhe.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
...
|**SendBitRateMaximum** <br/> |Ganzzahl  <br/> ||Maximale Bitrate für den Absender.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**SendBitRateAverage** <br/> |Ganzzahl  <br/> ||Durchschnittliche Bitrate für den Absender.  <br/> |
|**SendVideoStreamsMax** <br/> |Ganzzahl  <br/> ||Maximale Anzahl von Videostreams, die vom Absender verwendet werden.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
...
|**RecvResolutionWidth** <br/> |Ganzzahl  <br/> ||Vom Empfänger verwendete Auflösungsbreite.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**RecvResolutionHeight** <br/> |Ganzzahl  <br/> ||Vom Empfänger verwendete Auflösungshöhe.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
...
|**RecvBitRateMaximum** <br/> |Ganzzahl  <br/> ||Maximale Bitrate für den Empfänger.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**RecvBitRateAverage** <br/> |Ganzzahl  <br/> ||Durchschnittliche Bitrate für den Empfänger.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**RecvVideoStreamsMax** <br/> |Ganzzahl  <br/> ||Maximale Videodatenströme für den Empfänger.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**RecvVideoStreamsMin** <br/> |Ganzzahl  <br/> ||Minimale Videodatenströme für den Empfänger.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**RecvVideoStreamsMode** <br/> |Ganzzahl  <br/> ||Videomodus (z. B. Katalog oder einzelner Datenstrom) für den Empfänger.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
