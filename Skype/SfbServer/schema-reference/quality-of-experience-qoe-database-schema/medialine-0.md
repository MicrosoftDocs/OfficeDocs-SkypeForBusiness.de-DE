...
|**MediaLineLabel** <br/> |tinyint  <br/> |Primary  <br/> |Haupt-Audiodateien "0" ist, 1 Hauptvideo, und 2 ist panoramavideo, 3 Anwendung/Desktop freigeben. Diese Bezeichnung muss innerhalb einer einzelnen Sitzung eindeutig sein.  <br/> |
...
|**CallerIPAddr** <br/> |int  <br/> |Fremdschlüssel  <br/> |IP-Adresse des Anrufers. [IPAddress-Tabelle](ipaddress.md) Weitere Informationen finden Sie. <br/> |
|**CallerPort** <br/> |int  <br/> | <br/> | Vom Anrufer verwendeter Port. <br/> |
|**CallerSubnet** <br/> |int  <br/> | Fremdschlüssel <br/> |Das Subnetz des Anrufers. [IPAddress-Tabelle](ipaddress.md) Weitere Informationen finden Sie. <br/> |
...
|**CallerMacAddress** <br/> |int  <br/> |Fremdschlüssel  <br/> |Des Anrufers Mac-Adresse von der [MacAddress Table](macaddress.md)referenziert.  <br/> |
|**CallerRelayIPAddr** <br/> |int  <br/> |Fremdschlüssel  <br/> |IP-Adresse des A / V-edgedienst vom Anrufer verwendeten. [IPAddress-Tabelle](ipaddress.md) Weitere Informationen finden Sie. <br/> |
|**CallerRelayPort** <br/> |int  <br/> | <br/> |Port verwendet, auf dem A / V-edgedienst vom Anrufer.  <br/> |
|**CallerCaptureDev** <br/> |int  <br/> |Fremdschlüssel  <br/> |Aufnahmegerät des Anrufers. Verweis von der [Device-Tabelle](device.md).  <br/> |
|**CallerRenderDev** <br/> |int  <br/> |Fremdschlüssel  <br/> |Rendern von Anrufer verwendeten Gerät. Verweis von der [Device-Tabelle](device.md).  <br/> |
|**CallerCaptureDevDriver** <br/> |int  <br/> |Fremdschlüssel  <br/> |Treiber für das Aufnahmegerät des Anrufers, verwiesen von [DeviceDriver Table](devicedriver.md).  <br/> |
|**CallerRenderDevDriver** <br/> |int  <br/> |Fremdschlüssel  <br/> |Treiber für das darstellungsgerät des Anrufers, verwiesen von [DeviceDriver Table](devicedriver.md).  <br/> |
|**CallerNetworkConnectionType** <br/> |tinyint  <br/> |Fremdschlüssel  <br/> |Gibt an, wie der Aufrufer mit dem Netzwerk verbunden. Werte werden von der [NetworkConnectionDetail-Tabelle](networkconnectiondetail.md)abgerufen. Typische Werte sind 0 für eine drahtgebundene Verbindung ' 1 für ein WLAN-Verbindung und 3 für eine Ethernet-Verbindung.  <br/> |
|**CallerBssid** <br/> |int  <br/> |Fremdschlüssel  <br/> |BSSID des Anrufers, wenn Wireless verwendet wird. Verwiesen von der [MacAddress Table](macaddress.md).  <br/> |
...
|**CalleeIPAddr** <br/> |int  <br/> |Fremdschlüssel  <br/> |IP-Adresse des anrufempfängers. [IPAddress-Tabelle](ipaddress.md) Weitere Informationen finden Sie. <br/> |
|**CalleePort** <br/> |bit  <br/> ||Vom anrufempfänger verwendete Port.  <br/> |
|**CalleeSubnet** <br/> |int  <br/> |Fremdschlüssel  <br/> |Subnetz des angerufenen. [IPAddress-Tabelle](ipaddress.md) Weitere Informationen finden Sie. <br/> |
...
|**CalleeMacAddress** <br/> |int  <br/> |Fremdschlüssel  <br/> |Mac-Adresse des angerufenen. Verweis von der [MacAddress-Tabelle](macaddress.md).  <br/> |
|**CalleeRelayIPAddr** <br/> |int  <br/> |Fremdschlüssel  <br/> |IP-Adresse des A / V-edgedienst verwendete durch den Empfänger des Anrufs. [IPAddress-Tabelle](ipaddress.md) Weitere Informationen finden Sie. <br/> |
|**CalleeRelayPort** <br/> |int  <br/> | <br/> |Port verwendet, auf dem A / V-Edgedienst durch den Empfänger des Anrufs.  <br/> |
|**CalleeCaptureDev** <br/> |int  <br/> |Fremdschlüssel  <br/> |Aufnahmegerät verwendet, die für den Empfänger des Anrufs. Verweis von der [Device-Tabelle](device.md).  <br/> |
|**CalleeRenderDev** <br/> |int  <br/> |Fremdschlüssel  <br/> |Das Gerät, durch den Empfänger des Anrufs zu rendern. Verweis von der [Device-Tabelle](device.md).  <br/> |
|**CalleeCaptureDevDriver** <br/> |int  <br/> |Fremdschlüssel  <br/> |Treiber für das Aufnahmegerät des anrufempfängers. Verwiesen von [DeviceDriver Table](devicedriver.md).  <br/> |
|**CalleeRenderDevDriver** <br/> |varchar(256)-Wert  <br/> |Fremdschlüssel  <br/> |Treiber für das darstellungsgerät des anrufempfängers. Verwiesen von [DeviceDriver Table](devicedriver.md).  <br/> |
|**CalleeNetworkConnectionType** <br/> |tinyint  <br/> |Fremdschlüssel  <br/> |Gibt an, wie der aufgerufene mit dem Netzwerk verbunden. Werte werden von der [NetworkConnectionDetail-Tabelle](networkconnectiondetail.md)abgerufen. Typische Werte sind 0 für eine drahtgebundene Verbindung ' 1 für ein WLAN-Verbindung und 3 für eine Ethernet-Verbindung.  <br/> |
|**CalleeBssid** <br/> |int  <br/> |Fremdschlüssel  <br/> |BSSID des angerufenen, wenn Wireless verwendet wird. Verwiesen von der [MacAddress Table](macaddress.md).  <br/> |
...
|**CallerReflexiveLocalIPAddr** <br/> |int  <br/> |Fremdschlüssel  <br/> |Reflexive IP-Adresse des Benutzers, der den Anruf ausgeführt hat. In Organisationen, die NAT (Network Address Translation) verwenden, ist die reflexive IP-Adresse die IP-Adresse des Proxyservers.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**CallerWiFiDriverDevicesDesc** <br/> |int  <br/> |Fremdschlüssel  <br/> |Beschreibung des WLAN-Treibers des Benutzers, der den Anruf ausgeführt hat.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**CallerWiFiDriverVersion** <br/> |int  <br/> |Fremdschlüssel  <br/> |Versionsnummer des WLAN-Treibers des Benutzers, der den Anruf ausgeführt hat.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**CalleReflexiveLocalIPAddr** <br/> |int  <br/> |Fremdschlüssel  <br/> |Reflexive IP-Adresse des Benutzers, der den Anruf empfangen hat. In Organisationen, die NAT (Network Address Translation) verwenden, ist die reflexive IP-Adresse die IP-Adresse des Proxyservers.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**CalleeWiFiDriverDevicesDesc** <br/> |int  <br/> |Fremdschlüssel  <br/> |Beschreibung des WLAN-Treibers des Benutzers, der den Anruf empfangen hat.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
|**CalleeWiFiDriverVersion** <br/> |int  <br/> |Fremdschlüssel  <br/> |Versionsnummer des WLAN-Treibers des Benutzers, der den Anruf empfangen hat.  <br/> Diese Spalte wurde in Microsoft Lync Server 2013 eingeführt.  <br/> |
