...
|Transport  <br/> |Ganzzahl  <br/> |Transporttyp: 0 ist UDP, 1 ist TCP.  <br/> |
...
|CallerRelayPort  <br/> |Ganzzahl  <br/> |Port auf dem vom Anrufer verwendeten A/V-Edgedienst.  <br/> |
...
|CalleeRelayPort  <br/> |Ganzzahl  <br/> |Port auf dem vom Angerufenen verwendeten A/V-Edgedienst.  <br/> |
...
|PacketUtilization  <br/> |Ganzzahl  <br/> |Paketwert für den Videostream (Real Time Transport Protocol, RTP).  <br/> |
|BandwidthEst  <br/> |Ganzzahl  <br/> |Bandbreitenschätzungen für den Audiostream.  <br/> |
|PayloadDescription  <br/> |Ganzzahl  <br/> |Für den Anruf verwendeter Audiocodec, auf den in der [PayloadDescription-Tabelle](payloaddescription.md)verwiesen wird.  <br/> |
|VideoResolution  <br/> |char(9)  <br/> |Auflösung des Videos in Pixel Breite x Höhe. Gemeldet als Zeichenfolge.  <br/> |
|VideoBitRateAvg  <br/> |Ganzzahl  <br/> |Durchschnittliche Bitrate des Videostreams.  <br/> |
...
|ViideoBitRateMax  <br/> |Ganzzahl  <br/> |Maximale Videobitrate während der Videositzung.  <br/> |
...
|VideoAllocateBWAvg  <br/> |Ganzzahl  <br/> |Durchschnittliche für Video reservierte Bandbreite.  <br/> |
