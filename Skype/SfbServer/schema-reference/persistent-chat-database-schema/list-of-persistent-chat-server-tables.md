...
|[tblScopePrincipal](tblscopeprincipal.md) <br/> |Enthält Bereiche, die Knoten zugewiesen.  <br/> |
...
|[tblEnumAttribute](tblenumattribute.md) <br/> |Enthält nur die hartcodierten "Visibility" und "Behavior" Attribute, die in der TblNode-Tabelle verwendet werden.  <br/> |
...
|[tblLastChatId](tbllastchatid.md) <br/> |Enthält die letzte Chat-ID, die generierte (und in der TblChat-Tabelle verwendete) für jeden Benutzer.  <br/> |
