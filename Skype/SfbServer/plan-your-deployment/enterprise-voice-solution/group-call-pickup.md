...
Einstellungen für gleichzeitiges Klingeln funktionieren für Benutzer, die gruppenanrufannahme haben. Das heißt, ein Anruf an einen Benutzer, der über die Gruppenanrufannahme verfügt, klingelt für alle konfigurierten Ziele, und ein anderer Benutzer kann den Anruf annehmen. Die Ausnahme von dieser Regel ist, wenn der Benutzer das gleichzeitige Klingeln so konfiguriert, dass alle Teammitglieder aufgerufen werden.
...
- Videoteil von Audio-/Videoanrufen 
    ...
    > [!NOTE]
    > Wenn ein Benutzer einen Audio-/Videoanruf entgegennimmt, empfängt er nur die Audiodaten. Entweder die Anrufer oder die Person, die den Anruf entgegennimmt, kann den Anruf eskalieren, um ein Video hinzuzufügen. 
...
> [!NOTE]
> Sie können die empfohlene Anzahl von Benutzern pro Gruppe und die Anzahl der Gruppen erhöhen oder verringern, solange Sie die maximale Anzahl von Benutzern pro Pool nicht überschreiten. Beispielsweise kann Ihr Standard Edition Server 120 Gruppen mit 25 Benutzern pro Gruppe haben, da die Anzahl der Benutzer, die für die Gruppenanrufannahme aktiviert sind, weiterhin innerhalb des Maximalwerts des Benutzermodells liegt (das heißt, 120 Gruppen mal 25 Benutzer sind 3.000 Benutzer für die Gruppenanrufannahme aktiviert). 
