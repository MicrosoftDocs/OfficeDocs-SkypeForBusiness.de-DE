...
New-CsServerApplication-Identity Service: Registrar:<Pool FQDN>/LBRouting-Priorität <Application Priority> -aktiviert $true-kritische $true - Uri http://www.microsoft.com/LCS/LBRoutingFor Beispiel:
  
New-CsServerApplication-Identity Service:Registrar:LS2013CU2LBRPool.contoso.com/LBRouting-Priorität 3 - aktivierten $true-kritische $true - Uri http://www.microsoft.com/LCS/LBRoutingAfter mit diesem Cmdlet alle Front-End-Server im Pool oder Standard Edition-Server neu starten, auf dem die Speicherortbasierte Routing für Konferenzen, die Anwendung aktiviert wurde.
