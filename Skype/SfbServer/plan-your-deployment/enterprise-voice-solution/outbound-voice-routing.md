...
**Skype for Business Server Einstellungen für die Weiterleitung ausgehender Anrufe**
...
> [!NOTE]
> Die in der vorherigen Tabelle aufgeführten Normalisierungsregelnnamen enthalten keine Leerzeichen, aber dies ist eine Frage der Wahl. Der erste Name in der Tabelle könnte beispielsweise "5-stellige Durchwahl" oder "5-stellige Durchwahl" geschrieben worden sein und dennoch gültig sein. 
  
## <a name="voice-policies"></a>VoIP-Richtlinien

Skype for Business Server VoIP-Richtlinien definieren Für jeden Benutzer, Standort oder jede Organisation, denen die Richtlinie zugewiesen ist, Folgendes:
...
- **Die Nachverfolgung bösartiger Anrufe** ermöglicht Es Benutzern, schädliche Anrufe mithilfe des Skype for Business-Clients zu melden und diese Anrufe dann in den Anrufdetaildatensätzen zu kennzeichnen. Diese ist standardmäßig deaktiviert.
