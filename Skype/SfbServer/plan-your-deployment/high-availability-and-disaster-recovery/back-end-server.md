...
Die asynchrone Datenbankspiegelung wird für hohe Verfügbarkeit von Back-End-Servern in Skype for Business Server nicht unterstützt. Im restlichen Teil dieses Dokuments bedeutet die Datenbankspiegelung eine synchrone Datenbankspiegelung, sofern nicht anders angegeben. 
...
- Die Version der SQL Server des primären Servers muss SQL Spiegelung unterstützen.
...
SQL bewährte Methoden in Bezug darauf, welche SQL Versionen für eine Zeugenrolle unterstützt werden, finden Sie unter ["Datenbankspiegelungszeugen"](/sql/database-engine/database-mirroring/database-mirroring-witness) in der MSDN Library.
