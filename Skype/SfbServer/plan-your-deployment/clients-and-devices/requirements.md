...
Die Bereitstellung planungslösung Kontenerstellung gemäß der Beschreibung unter [Bereitstellen von Microsoft Teams Chatrooms](../../deploy/deploy-clients/room-systems-v2.md) und Einrichten von einem Meeting-Konsole wie beschrieben unter [Konfigurieren einer Microsoft-Teams Räume-Konsole](../../deploy/deploy-clients/console.md). 
...
> [!NOTE]
> Microsoft-Teams Chatrooms ist für die Verwendung mit Skype für Business Server 2019, Skype für Business Server 2015, Microsoft-Teams oder Skype für Business Online vorgesehen. <br><br>Frühere Plattformen wie Lync Server 2013 sind nicht entwickelt Microsoft Teams Chatrooms erwartet.
...
Um Ihr eigenes Bild Microsoft Teams Chatrooms erstellen, befolgen Sie die Anweisungen unter [Konfigurieren einer Microsoft-Teams Räume-Konsole](../../deploy/deploy-clients/console.md). Diese Anleitung führt Sie durch alle erforderliche Software für den Installationsvorgang herunterladen. 
...
[Bereitstellen von Microsoft-Teams, Räume](../../deploy/deploy-clients/room-systems-v2.md)
