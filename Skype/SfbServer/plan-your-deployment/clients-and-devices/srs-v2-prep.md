...
11. Wählen Sie auf der Anmeldeseite den Benutzer **Skype** aus. Wenn die oben beschriebenen Schritte erfolgreich waren, der Skype Raum Systemen v2 Gerät wird erfolgreich anmelden.
...
### <a name="skype-room-systems-local-user-account"></a>Skype-Raum Systeme lokales Benutzerkonto
