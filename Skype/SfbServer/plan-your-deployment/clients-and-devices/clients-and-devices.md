...
Der [Skype for Business auf dem Mac-Client](https://www.microsoft.com/download/details.aspx?id=54108) steht zum Download zur Verfügung. Informationen zum Überprüfen der Voraussetzungen finden Sie unter Skype for Business für [Mac-Clientanforderungen.](mac-requirements.md)
...
Microsoft Teams-Räume ist die neueste Konferenzlösung von Microsoft, die eine vertraute Benutzeroberfläche verwendet und einfach bereitgestellt und verwaltet werden kann. Dabei werden vorhandene Geräte wie BEISPIELSWEISE DIE VON-Panels verwendet, um die Installation zu vereinfachen. Microsoft Teams-Räume verwendet eine speziell erstellte UWP-App, die auf einem Surface Pro 4 oder Surface Pro in einem Konsolenmodus ausgeführt wird (nachdem die UWP-App bereitgestellt wurde, ist die einzige App, die auf dem Gerät ausgeführt wird) und erfordert ein eigenes Gerätekonto für Ihre Implementierung. Die Software wird sowohl über Windows Store als auch über Windows Update aktualisiert. https://aka.ms/MTRDocsWeitere Informationen zur Verwendung dieser Raumkonsolen in Ihrer Bereitstellung finden Sie unter. 
...
Sowohl die Basisversion als auch die vollständige Clientversion (mit einer Auswahl von 32- und 64-Bit-Versionen) sind über ein Klick-und-Los-Installationsprogramm verfügbar. Ihre Benutzer können sie unter [Download Skype for Business auf allen Ihren Geräten](https://products.office.com/skype-for-business/download-app?tab=tabs-3)herunterladen.
