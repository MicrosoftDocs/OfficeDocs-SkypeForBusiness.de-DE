...
---
# <a name="plan-for-monitoring-in-skype-for-business-server-2015"></a>Planen der Überwachung in Skype for Business Server 2015
 
**Zusammenfassung:** Überprüfen Sie beim Planen des Überwachungsdienst in Skype für Business Server 2015 in diesem Thema.
  
Der Überwachungsdienst in Skype für Business Server 2015 bietet eine Möglichkeit für Administratoren, Verwendung und QoE-Daten für die kommunikationssitzungen zu erfassen, die in ihrer Organisation, d. h., sie stattfinden um Trends und Probleme zu identifizieren. Fortlaufende Überwachung Ihrer Bereitstellung können Sie Probleme früh catch und stellen den Benutzern Ihrer Organisation erfüllt. 
...
Es gibt immer noch einige wichtige Punkte, die berücksichtigt werden sollten, bevor Sie beginnen, installieren und Konfigurieren der Überwachung mit Skype für Business Server 2015:
  
 **Wenn möchten Sie monitoring installieren?** Überwachung kann installiert und konfiguriert gleichzeitig installieren und Skype für Business Server 2015 konfiguriert werden; die Skype für Business Server 2015 Bereitstellungs-Assistenten wird die Möglichkeit, eine Überwachungsdatenbank, die während des Setups die Front-End-Pools zuordnen bereitgestellt werden. Alternativ können Sie die Überwachung nach der Installation von Skype für Business Server 2015 selbst installieren. Dies kann mithilfe des Topologie-Generators eine Überwachungsdatenbank, die Ihre Front-End-Pools und Server zugeordnet, und klicken Sie dann Veröffentlichen der überarbeiteten Topologie erfolgen.
...
Die einheitlichen Datenerfassungs-Agents werden bei der Aktivierung der Überwachung automatisch auf allen Front-End-Servern installiert und aktiviert. Sie müssen eine der folgenden Datenbanken installieren und konfigurieren, die als Back-End-Datenspeicher für Ihre Überwachungsdaten dient:
  
- Microsoft SQL Server 2008 R2 Enterprise Edition (64-Bit-Version)
    
- Microsoft SQL Server 2008 R2 Standard Edition (64-Bit-Version)
    
- Microsoft SQL Server 2012 Enterprise Edition (64-Bit-Version)
    
- Microsoft SQL Server 2012 Standard Edition (64-Bit-Version)
    
- Microsoft SQL Server 2014 Enterprise Edition (64-Bit-Version)
    
- Microsoft SQL Server 2014 Standard Edition (64-Bit-Version)
    
32-Bit-Versionen von SQL Server können nicht als Back-End-Speicher verwendet werden. Skype für Business Server 2015 unterstützt nicht die Express-Editionen von SQL Server 2008 oder SQL Server 2012. Weitere Informationen zu datenbankanforderungen für Skype für Business Server 2015 finden Sie unter [Unterstützte Datenbanksoftware](http://technet.microsoft.com/library/e05d0032-bbea-4e61-987d-d07b1c045fd5.aspx).
