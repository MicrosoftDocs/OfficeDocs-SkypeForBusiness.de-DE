...
Wenn Sie eine neue Implementierung wie unter Erstellen von [DNS-Einträgen für Skype for Business Server](../../deploy/install/create-dns-records.md) beschrieben installieren und Ihre Topologie für Skype for Business Server erstellen, wissen wir, dass Sie die in Windows Server 2016 oder ein DNS-Paket eines Drittanbieters integrierten DNS-Funktionen verwenden können. Daher werden wir die Diskussionen in diesem Artikel nicht spezifisch, sondern allgemein behandeln. Wir beschreiben, was erforderlich ist, und wie Sie diese Anforderung erfüllen, ist Ihre Entscheidung.
