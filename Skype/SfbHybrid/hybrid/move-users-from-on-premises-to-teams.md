...
Wenn ein Benutzer von der lokalen Umgebung in Teams Only verschoben wird, wird die Skype for Business-Startseite des Benutzers von lokal in online verschoben, und dem Benutzer wird TeamsUpgradePolicy mit mode=TeamsOnly zugewiesen.  Nachdem ein Benutzer aus der lokalen Umgebung in den TeamsOnly-Modus verschoben wurde:

- Alle eingehenden Anrufe und Chats von anderen Benutzern (ob von Skype for Business oder Teams gesendet) werden im Teams Client des Benutzers landen.
...
- Neue, von diesem Benutzer geplante Besprechungen sind Teams Besprechungen.
...
> [!NOTE]
> Unified Contact Store sollte für das lokale SfB-Konto deaktiviert sein, damit der Kontakt zu Teams verschoben werden kann.
