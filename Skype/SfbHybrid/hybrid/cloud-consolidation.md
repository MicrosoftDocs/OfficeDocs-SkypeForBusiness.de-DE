...
9.  In der Hybridbereitstellung (OriginalCompany. <span> com) zu starten, [um Benutzer von Skype for Business lokal in die Cloud zu verschieben](move-users-between-on-premises-and-cloud.md) (ob nur Teams oder nicht), damit der Benutzer Teams Only ist. Jetzt sieht die Organisation wie **[in Abbildung B](#figure-b)** aus. Die wichtigsten Änderungen in Abbildung A sind:
...
10. Sobald alle Benutzer in die Cloud verschoben wurden, [deaktivieren Sie die Hybridbereitstellung mit der Skype for Business lokalen Bereitstellung](cloud-consolidation-disabling-hybrid.md) für OriginalCompany. <span> com von Microsoft 365:  
    - Deaktivieren Sie geteilte Domäne in der Microsoft 365 Organisation.
    - Deaktivieren Sie die Möglichkeit, mit Microsoft 365 in OriginalCompany zu kommunizieren. <span> com lokal.
    - Aktualisieren sie DNS-Einträge für OriginalCompany. <span> com, um auf Microsoft 365 zu verweisen.
...
- Einige Benutzer in der Hybridorganisation wurden in die Cloud verschoben und sind Teams Only (Benutzer A, wie durch lila Schattierung angegeben). Diese Benutzer Teams Nur Benutzer verfügen über vollständige Interoperabilitäts- und Verbundunterstützung mit anderen Skype for Business Benutzern.<br><br>
