...
> [!Important]
> Skype for Business Online wurde am 31. Juli 2021 eingestellt. Benutzer können in ihrem Exchange Postfach nicht mehr über den Skype for Business Online-Client auf Voicemail zugreifen.
...
3. Der Dienst sendet dann die Voicemail im Exchange Postfach des Benutzers ein, unabhängig davon, ob das Postfach lokal oder online ist.  
...
- Wenn Sie Exchange lokalen UM verwenden oder eine Mischung aus Benutzern haben, die Exchange UM online und lokal verwenden, müssen Sie sowohl Ihre gehostete Voicemailrichtlinie als auch den Hostinganbieter ändern.  Weitere Informationen finden Sie unter [Konfigurieren Cloud-Voicemail Diensts](configure-cloud-voicemail.md).
...
- Wenn Sie ein Upgrade auf Skype for Business Server 2019 durchführen und Skype for Business Server 2015 für Voicemail mit Exchange Online UM konfiguriert haben, wird die Voicemail der Benutzer automatisch von Exchange Online UM zu Cloud-Voicemail, wenn das Konto in Skype for Business Server 2019 verschoben wird. 
