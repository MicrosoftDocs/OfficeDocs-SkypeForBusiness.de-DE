...
- Dial internationalen Rufnummern anfallenden ist in einem Abonnement **in- und International aufrufen planen** enthalten.
...
Es wird empfohlen, dass Sie der PSTN-Dienst Verwendungsoptionen sorgfältig, um die beste Setup für Communications haben zu verstehen. Sie können weitere Informationen zu PSTN-Services sehen, Beitrag [Was sind in Office 365-Pläne aufrufen?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md) und [Audiokonferenzen häufig gestellte Fragen](../audio-conferencing-in-office-365/Audio-Conferencing-common-questions.md).
...
> [!NOTE]
> Sie können sich die Pläne und Preise ansehen, indem Sie sich [beim Office 365 Admin Center anmelden](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) und zu **Abrechnung** > **Abonnements** > **Abonnements hinzufügen** navigieren. 
  
In der **Office 365 Administrationscenter** > **Abrechnung** > **Abonnements**, Sie können Credit manuell hinzufügen zu einem beliebigen Zeitpunkt. Sie können auch die Option **Automatische Ladeleuchte** aktivieren die automatische Auffüllung ermöglicht, wenn sich das Gleichgewicht den Schwellenwert unterschreitet, die Sie festlegen. Wenn Sie angeben, dass Ihre Kommunikation haben einen Lastenausgleich mit einem einmaligen Betrag Finanzierung, und klicken Sie dann das Gleichgewicht auf 0 (null greift), werden die oben genannten zusätzlichen aufrufenden Szenarien einschließlich gebührenfreien Telefonnummern nicht mehr funktionsfähig. Daher wird empfohlen, dass Sie die Einstellung für **Automatische Ladeleuchte** verwenden, um eine Unterbrechung des Dienstes zu vermeiden Ihre Kommunikation haben Balance erreichen kann 0 (null). Sie werden versendet eine e-Mail bei Ladeleuchte Transaktionen erfolgreich ausgeführt werden kann, Ladeleuchte Transaktionen ein Fehler auftritt (beispielsweise eine Abgelaufene Kreditkarte), und oder Ihre Kommunikation haben einen Lastenausgleich erreicht 0 (null).
  
## <a name="communications-credits"></a>Guthaben für Kommunikationen

In jeder Organisation sind unterschiedliche Nutzungsmuster für das Anrufplanvolumen und unterschiedliche Tarife zu berücksichtigen. Diese Nutzungsdaten müssen Sie bei Ihrem aktuellen Dienstanbieter erfragen. Organisationen, die bereits Skype for Business als Dienstanbieter verwenden, können die Nutzungsdaten unter **Office 365 Admin Center** > **Berichte** oder **Skype for Business Admin Center** > **Berichte** > **PSTN-Nutzungsdetails** abrufen.
...
Sie können sich die Preisinformationen auch ansehen, indem Sie sich [beim Office 365 Admin Center anmelden](https://portal.office.com/adminportal/home?add=sub&amp;adminportal=1#/catalog) und zu **Abrechnung** > **Abonnements** > **Abonnements hinzufügen** navigieren.
