...
4. Informationen zum Anzeigen der zugewiesenen Telefonnummern finden Sie in der Spalte **Zahl** .
    
5. Sie können die Dropdownliste verwenden, um Ihre Ansicht nach folgenden Kriterien zu filtern:
    
   - **Alle** Telefonnummern einschließlich Servicetelefonnummern
    
   - Ein von Ihnen festgelegter Telefon **Nummernbereich** .
    
   - Telefonnummern, die **dem Benutzer zugewiesen**sind.
    
   - Telefonnummern, die der Konferenz für Einwahlkonferenzen **zugewiesen** sind.
    
   - Telefonnummern, die nicht **zugewiesen**sind.
    
   - Die **Position** der Telefonnummern.
...
4. Sie können Ihre Ansicht nach Telefonnummern filtern, die Benutzern oder Telefonnummern zugewiesen sind, die Sie einem Benutzer zuweisen können. Sie können nach folgenden Kriterien filtern:
...
4. Sie können die Dropdownliste verwenden, um Ihre Ansicht für aktive Benutzer zu filtern, unabhängig davon, ob der Benutzer online oder lokal ist, oder den Status und die Art der Lizenzierung für einen Benutzer. Sie können nach folgenden Kriterien filtern:
