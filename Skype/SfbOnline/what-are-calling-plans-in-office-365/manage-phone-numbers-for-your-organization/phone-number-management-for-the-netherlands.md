...
|:-----|:-----|
|Neue Telefonnummern für Benutzer anfordern  <br/> | Laden Sie das Formular zur [Anforderung neuer Telefonnummern für die Niederlande (ortsgebundene Nummern) (v.3.0) (nl-nl)](../../downloads/new-number-request-forms/new-phone-number-request-for-the-netherlands-(geographic-numbers)-(v.3.0)-(nl-nl).pdf) herunter. <br/>  <br/>  Füllen Sie das Formular aus, und [senden Sie es an uns](mailto:ptneu@microsoft.com).  <br/> |
