...
|Rufen Sie Telefonnummern für den neuen Dienst, die nicht aufgelistet werden in der Skype für Business Administrationscenter. <br/> |Laden Sie dieses Formular [neue Nummer Telefon-Anforderung für Spanien (Service Zahlen) (v.1.2) (es-es)](../../downloads/new-number-request-forms/new-phone-number-request-for-spain-(service-numbers)-(v.1.2)-(es-es).pdf).<br/> Füllen Sie das Formular aus, und [senden Sie es an uns](mailto:ptneu@microsoft.com).
