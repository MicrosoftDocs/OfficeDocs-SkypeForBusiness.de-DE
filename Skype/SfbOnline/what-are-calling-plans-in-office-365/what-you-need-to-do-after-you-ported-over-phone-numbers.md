...
Nachdem Sie Ihre Bestellung Port gesendet haben, wir wenden Sie sich an Ihren Netzbetreiber und Details mit ihnen arbeiten. Wenn das Datum der letzten Übertragung festgelegt wurde, werden wir Sie per e-Mail benachrichtigt. Beim Warten auf Ihrem Netzbetreiber für das Akzeptieren von der Reihenfolge, fahren fort und Erstellen der erforderlichen Notfall Adressen werden Sie jedoch mit diesen Nummern verwenden.
  
- Erfahren Sie mehr über [Was notfallstandorten, Adressen und Anrufrouting sind?](/microsoftteams/what-are-emergency-locations-addresses-and-call-routing).
    
- [Hinzufügen oder entfernen, die einem Notfall Webadresse für Ihre Organisation](add-or-remove-an-emergency-address-for-your-organization.md) können bei Bedarf.
