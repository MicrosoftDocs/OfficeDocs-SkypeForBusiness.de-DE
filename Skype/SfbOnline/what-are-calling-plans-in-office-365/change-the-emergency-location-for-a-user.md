...
---
# <a name="change-the-emergency-location-for-a-user"></a>Change the emergency location for a user

Jede aktive Telefonnummer benötigen eine Notfall-Adresse (zugeordnet sind, wenn Sie eine Telefonnummer in Office 365 oder wenn Sie eine Telefonnummer weiterleiten abrufen) Wenn die Rufnummer ein, die dem Benutzer zugewiesen ist. Wenn Sie die Nummer mit einem Notfall Adresse zuordnen, können Sie auch einen Notfall Speicherort zum Bereitstellen einer genauen Position in einem physischen Standort hinzufügen. Ein Notfallstandort kann ein Stockwerk, ein Gebäudeflügel oder die Nummer eines Büros sein, in dem sich der Benutzer befindet. Sie können eine unbegrenzte Anzahl von Speicherorten für eine bestimmte Notfall Adresse haben, und Sie können den Notruf Speicherort ändern, wenn der Benutzer auf eine andere Office oder Erstellen von verschoben wird – beispielsweise, wenn der Benutzer von verschiebt floor 34 bis Floor 35.
...
8. Wählen Sie den Notruf Speicherort aus der Liste aus, und klicken Sie dann auf **Speichern**.
    ...
    Wenn Sie einen neuen Speicherort Notfall hinzufügen möchten, finden Sie unter [Hinzufügen, ändern oder Entfernen von einem Notfall Speicherort für Ihre Organisation](add-change-or-remove-an-emergency-location-for-your-organization.md).
