...
> [!NOTE]
> Um eine Rufnummer für ein Konferenzbrücke zuweisen/aufheben können, muss die Rufnummer eine *Servicenummer*sein.  Sie können zu **VoIP** > **Telefonnummern** navigieren und in der Spalte **Nummerntyp** nachsehen, um welchen Nummerntyp es sich handelt. Office 365 Communications haben muss zuerst eingerichtet werden, damit Benutzer in eine gebührenfreie Telefonnummer-Brücke einwählen können.
...
Bei den Standardtelefonnummern für Benutzer handelt es sich um die Nummern, die in ihren Besprechungseinladungen enthalten sind, wenn sie eine Besprechung planen. Weitere Informationen finden Sie unter [Einrichten der in Einladungen enthaltenen Telefonnummern](set-the-phone-numbers-included-on-invites.md).
...
Für die nächsten beiden Schritte müssen Sie Windows PowerShell starten.
...
Für die drei ersten Schritte müssen Sie Windows PowerShell starten. Wie Sie dazu vorgehen müssen, erfahren Sie unter [Möchten Sie wissen, wie Sie die Verwaltung mit Windows PowerShell organisieren?](change-the-phone-numbers-on-your-audio-conferencing-bridge.md#bkPowerShell)
...
```
 ...
 Weitere Informationen finden Sie unter [Einrichten der in Einladungen enthaltenen Telefonnummern](set-the-phone-numbers-included-on-invites.md).
...
### <a name="to-verify-that-windows-powershell-is-ready-to-go"></a>So überprüfen Sie, ob Windows PowerShell bereit ist
 ...
 Mit diesen Schritten überprüfen Sie, ob Sie Windows PowerShell Version 3.0 oder höher ausführen.
...
### <a name="save-time-and-automate"></a>Sparen Sie Zeit durch Automatisierungen

Um Zeit zu sparen bzw. den Vorgang zu automatisieren, können Sie das Cmdlet [Set-CsOnlineDialInConferencingUser](https://go.microsoft.com/fwlink/?LinkId=617688) oder **Set-CsOnlineDialInConferencingUserDefaultNumber** nutzen.
