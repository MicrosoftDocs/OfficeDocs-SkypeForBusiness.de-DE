...
3. |||UNTRANSLATED_CONTENT_START|||In the left navigation, go to **Audio conferencing** > **Users**.|||UNTRANSLATED_CONTENT_END||| Wählen Sie den Benutzer, den Sie für Audio Conferencing aktivieren möchten.
...
|||UNTRANSLATED_CONTENT_START|||See [Set the phone numbers included on invites](set-the-phone-numbers-included-on-invites.md).|||UNTRANSLATED_CONTENT_END|||
...
3. |||UNTRANSLATED_CONTENT_START|||In the **Skype for Business admin center**, in the left navigation, go to **Audio conferencing** > **Microsoft bridge**.|||UNTRANSLATED_CONTENT_END||| Hier können Sie:
