...
- Um einen Zusammenfassungsstatus aller MMS-Migrationen zu erhalten, führen Sie den folgenden Befehl aus, der eine tabellarische Ansicht aller Migrationszustände bietet:
    ...
    Succeeded   131
    ```
- Um alle Details aller Migrationen innerhalb eines bestimmten Zeitraums anzuzeigen, verwenden Sie die Parameter `StartTime` und `EndTime` . Der folgende Befehl gibt beispielsweise vollständige Details zu allen Migrationen zurück, die vom 1. Oktober 2018 bis zum 8. Oktober 2018 durchgeführt wurden.
