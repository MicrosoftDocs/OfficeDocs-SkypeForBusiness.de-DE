...
- **Option 1. Verwenden Sie die kostenlose [Skype-App](https://www.skype.com/)**. Wenn Sie ein sehr kleines Unternehmen haben (zum Beispiel mit ein bis zwei Mitarbeitern), ist die Verwendung der Skype-App die bessere Lösung. Sie ist für Inlands- und Auslandsanrufe kostengünstiger. Sie können weiterhin halten Sie Telefonkonferenzen abhalten von Videokonferenzen und Freigeben des Desktops für Präsentationen. [Checken Sie die Zahlungsoptionen und Sätze](https://secure.skype.com/en/calling-rates?wt.mc_id=legacy&amp;expo365=bundled).
    ...
    **WICHTIG**: Sie müssen eine Einstellung vornehmen, damit Ihre Mitarbeiter mit Skype for Business nach Skype-Benutzern suchen können. Finden Sie unter [Let Skype für Unternehmensbenutzer Skype-Kontakte hinzufügen](../../set-up-skype-for-business-online/let-skype-for-business-users-add-skype-contacts.md).
    
- **Option 2. Aktualisieren Sie Ihren Plan und kaufen Telefonsystem und eine in- oder National und International aufrufen Plan**.

    > [!Important]
    > Zwar Skype für Business Online – Plan 2 enthalten, mit dem Office Business Premium-Abonnement, **Cloud VoIP Anruffunktionen kann nicht hinzugefügt werden**. Daher wird empfohlen, dass Sie ein Plans Enterprise E5 (oder Enterprise E3) auswerten, um festzustellen, ob es kosteneffektiver ist.
    
1. [Wechseln zu einem anderen Office 365 Business-Plan](http://support.office.com/article/73318661-8f33-478b-bcc7-fb8d69dbb22a). Es wird empfohlen, dass Sie einen Plan Enterprise E5 um festzustellen, ob es kosteneffektiver ist ausgewertet werden soll.
    
2. Kaufen Sie das **Telefonsystem**-Add-On.
    
3. Ein [Aufruf von Planen für Office 365](../../skype-for-business-and-microsoft-teams-add-on-licensing/calling-plans-for-office-365.md)kaufen: Sie können nur erwerben, nachdem Sie das **Telefonsystem** Add-on kaufen.
