...
---
# <a name="inbound-pstn-call-blocking-for-calling-plans"></a>Eingehende PSTN-Anruf gewendet Pläne blockieren
...
In diesem Beispiel wird der Identitätsparameter, falls erforderlich (Is?):`Remove-CsInboundBlockedNumberPattern -Identity “<identity>”`
