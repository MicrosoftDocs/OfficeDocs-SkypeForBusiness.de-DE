...
|Werden Telefonnummern für Audiokonferenzen automatisch zugewiesen?  <br/> |Ja, für Santiago (nur verfügbar für Organisationen innerhalb Chile). Wenn Sie dedizierte Telefonnummern wünschen, finden Sie weitere Informationen unter [Anfordern von Servicenummern](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Funktion**|**Details**|
|:-----|:-----|
|Für welche Haupt- oder Großstädte können gebührenpflichtige Telefonnummern bezogen werden?  <br/> |Santiago  <br/> > [!NOTE]> Nur für Organisationen innerhalb von Chile verfügbar.           |
|Sind gebührenpflichtige Telefonnummern verfügbar?  <br/> |Ja  <br/> > [!NOTE]> Nur für Organisationen innerhalb von Chile verfügbar.           |
