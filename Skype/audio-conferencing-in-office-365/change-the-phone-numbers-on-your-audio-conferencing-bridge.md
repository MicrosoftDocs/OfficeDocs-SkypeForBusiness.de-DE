...
4. Klicken Sie auf der Seite **Zuweisen** auf **Speichern**.
    ...
    > [!NOTE]
    > Nachdem Sie eine neue Rufnummer zugewiesen wurde, auch wenn die Anzahl der neuen Standardnummer änderte, ändert nicht die Standardnummer für vorhandene Benutzer. Legen Sie die standardmäßige gebührenpflichtige oder eine gebührenfreie Telefonnummer, die hinzugefügt wird, um Organisator der Besprechung eingeladen werden, finden Sie unter [Einrichten des Telefons, Zahlen auf enthalten lädt](set-the-phone-numbers-included-on-invites.md). 
...
Die Standard-Telefonnummern für den Benutzer sind invites diejenigen aus, die auf ihre Besprechung enthalten sind, wenn sie eine Besprechung planen. Weitere Informationen finden Sie unter [Einrichten des Telefons, Zahlen auf enthalten lädt](set-the-phone-numbers-included-on-invites.md).
  
1. Melden Sie sich bei Office 365 mit Ihrem Firmen- oder Schulkonto an.
    
2. Wechseln Sie zu der **Office 365 Administrationscenter** > **Admin zentriert** > **Skype für Unternehmen** > **Audiokonferenzen** > **Benutzer** und die Benutzer in der Liste auswählen.
...
[Ändern der Einstellungen für eine Audiokonferenz-Brücke](change-the-settings-for-an-audio-conferencing-bridge.md)
