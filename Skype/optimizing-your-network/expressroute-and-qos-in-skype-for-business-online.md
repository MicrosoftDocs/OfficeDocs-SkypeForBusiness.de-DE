...
> [!NOTE]
> Eine neue Version des Bandbreiten-Rechners ist verfügbar: [Skype for Business, Bandbreiten-Rechner ](http://go.microsoft.com/fwlink/?LinkId=715766). Die Anweisungen in diesem Dokument verwenden jedoch den Lync 2010- und 2013-Bandbreiten-Rechner. 
  
## Skype for Business Online und ExpressRoute
...
- [ExpressRoute-Preise](http://go.microsoft.com/fwlink/?LinkId=690284)
    
- [ExpressRoute-Dokumentation](http://go.microsoft.com/fwlink/?LinkId=690285)
    
## Teil 1: Fallstudie - ExpressRoute für Dewey Law, LLC.
...
- Die Netzwerkswitche und -router müssen außerdem eine unterbrechungsfreie Stromversorgung (USV) nutzen, damit sie ihren Betrieb bei einem Stromausfall fortsetzen können.
    ...
    Da das Unternehmen über WLAN-Verbindungen zu seinen LAN-Büros verfügt, wird dringend empfohlen, mit einem zertifizierten Skype for Business-WLAN-Infrastrukturpartner aus [Skype for Business-Lösungen](http://go.microsoft.com/fwlink/?LinkId=690281) zusammenzuarbeiten.
...
> [!TIP]
> Spezifische Details zur QoS-Einrichtung finden Sie in Abschnitt 2.6 von [Network Planning, Monitoring, and Troubleshooting with Lync Server]( http://go.microsoft.com/fwlink/?LinkId=760669) (Netzwerkplanung, -überwachung und -problembehandlung mit Lync Server). Weitere Anforderungen an die Netzwerkplanung finden Sie unter[Planen von Netzwerkanforderungen für Skype for Business 2015](http://go.microsoft.com/fwlink/?LinkId=690287). 
  
### Bestellen von Netzwerkzugriffsdiensten
...
### Festlegen von Bandbreitenanforderungen für Skype for Business-Anwendungen
...
|**Standort**|**Spitzen-SIP/Chatbandbreite**|**Spitzenbandbreite für Audiokonferenzen**|**Spitzenbandbreite für Videokonferenzen**|**Spitzenbandbreite für WAN-Freigaben**|**Spitzen-WAN-Bandbreite für PSTN-Anrufe**|**Gesamtdatenverkehr für ExpressRoute pro Standortklasse (d. h. Gesamtzeit der Standorte)**|
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
## Teil 2: QoS für ExpressRoute für Skype for Business
...
### ExpressRoute als Bestandteil eines VoIP-Netzes der Unternehmensklasse
...
### Falls ExpressRoute keine Option ist
...
### Grundlegende Konzepte für Quality of Service (QoS)/Dienstklassen
...
### Endpunktmarkierung des Datenverkehrs - Differentiated Services Control Point (DSCP)
...
### Layer-2-QoS: IEEE 802.1p/WLAN-Multimedia (IEEE 802.11e)
...
### Grundlegendes zu den Typen von IP-Netzwerkdiensten - einfache IP-Dienste und MPLS
