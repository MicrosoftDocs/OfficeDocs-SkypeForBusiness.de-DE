...
In diesem Szenario wird es unterstützt, Exchange lokale, Exchange Online, eine hybride Exchange-Lösung bereitzustellen oder überhaupt keine Exchange bereitgestellt zu haben. (Das Diagramm zeigt nur Exchange lokal, aber die anderen Exchange Lösungen werden ebenfalls vollständig unterstützt.)
