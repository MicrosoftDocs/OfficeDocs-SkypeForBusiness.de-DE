...
ms.collection: ''
description: Erfahren Sie, wie Sie Skype for Business Server planen und bereitstellen, damit Sie die Anzahl der Benutzer in Ihrer Organisation angemessen planen und die Serverlast planen können, die ihre Aktivitäten generieren.
ms.openlocfilehash: 61c6fc38df65782ce7c11fbeed1c60039a06cf6a
ms.sourcegitcommit: efd56988b22189dface73c156f6f8738f273fa61
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/30/2021
ms.locfileid: "60011889"
---
...
|:-----|:-----|
|Front-End-Pool mit 16 Front-End-Servern und Back-End-Server oder einem Back-End-Serverpaar mit SQL AlwaysOn für hohe Verfügbarkeit.   |106.000 eindeutige Benutzer gleichzeitig angemeldet, plus 50 % mehrfache Anwesenheitspunkte (Multiple Points of Presence, MPOP), die nicht mobile Instanzen darstellen, plus 40 % der Benutzer, die für Mobilität für insgesamt 210.000 Endpunkte aktiviert sind.   |
...
|Ein Edgeserver   |18.000 gleichzeitige Remotebenutzer.   |
|Ein Director   |18.000 gleichzeitige Remotebenutzer.   |
...
|:-----|:-----|:-----|:-----|
|Intel Xeon E5-2673 v3 Dualprozessor, 6-Core, 2,4 GHz oder höher **mit deaktivierter Hyperthreading,mit** 64 GB Arbeitsspeicher und einer Dualport-Netzwerkadapterkarte.   |1500   |64   |49   |
|Intel Xeon E5-2673 v3 Dualprozessor, 6-Core, 2,4 GHz oder höher, mit 64 GB Arbeitsspeicher und einer Dualport-Netzwerkadapterkarte.   |2000   |88   |66   |
...
|:-----|:-----|
|Intel Xeon E5-2673 v3 Dualprozessor, 6-Core, 2,4 GHz oder höher, mit 64 GB Arbeitsspeicher und 2 1 GB Netzwerkadapterkarten.   |200   |
...
|Hardwarekomponente|Empfohlen|
|:-----|:-----|
|CPU   |Intel Xeon E5-2673 v3 Dualprozessor, 6-Core, 2,4 GHz oder höher.   |
