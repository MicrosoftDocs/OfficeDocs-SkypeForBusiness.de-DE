...
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="b9055-103">Authentifizierungsskript für Skype for Business Server 2019 Control Panel</span><span class="sxs-lookup"><span data-stu-id="b9055-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="b9055-104">Dieses Skript sollte nach der Installation von Skype for Business Server 2019 Kumulatives Update 1 im Rahmen der Einrichtung des neuen Control Panels ausgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="b9055-104">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1, as part of the set-up for the new Control Panel.</span></span> <span data-ttu-id="b9055-105">Mit diesem Skript wird eine Azure AD-Anwendung auf Azure erstellt.</span><span class="sxs-lookup"><span data-stu-id="b9055-105">This script will create an Azure AD Application on Azure.</span></span> <span data-ttu-id="b9055-106">Dies hilft bei der Anmeldung bei Office 365 mithilfe von OAuth im neuen Control Panel.</span><span class="sxs-lookup"><span data-stu-id="b9055-106">This will help in signing into Office 365 using OAuth in the new Control Panel.</span></span>
