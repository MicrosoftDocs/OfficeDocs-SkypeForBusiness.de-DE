...
2. Melden Sie sich bei Office 365 Administrationscenter, und geben Sie Ihre Office 365-Benutzer-ID und das Kennwort ein. Nachdem Sie sich angemeldet haben, sehen Sie das Office 365 Administrationscenter:
...
3. [Office 365-URLs und IP-Adressbereiche](https://support.office.com/article/8548a211-3fe7-47cb-abb1-355ea5aa88a2#BKMK_LYO): die meisten kleine Unternehmen müssen diesen Schritt ausführen. **Aber wenn Sie eine Firewall oder der Proxy-Server verwenden beschränkt, die Zugriff auf Teile des Webs**, müssen Sie Regeln, um die Gewährung des Zugriffs für die Skype für Business Online Endpunkte erstellen. Dies ist eine erweiterte Schritt am besten durch einen Benutzer mit der Konfiguration von Firewalls und Proxyserver auftraten ausgeführt. Wenn Sie dies noch nicht getan haben, sollten Sie Einstellen von einem [Microsoft-Partner](https://go.microsoft.com/fwlink/?linkid=391089) Skype für Unternehmen für Sie einrichten.
...
2. [Aktivieren von Skype-Besprechung übertragen](../set-up-your-network-for-skype-meeting-broadcast/enable-skype-meeting-broadcast.md): dieses Feature nicht standardmäßig aktiviert. Nachdem Sie es aktivieren, werden Ihre Benutzer broadcast Besprechungen mit anderen Personen in Ihrer Organisation hosten.
